...
package Medium = IDEAS.Media.Air;
  ...
  IDEAS.Fluid.Sources.Boundary_pT sink2(
     redeclare package Medium = Medium,
     nPorts=2) "Fluid sink"
  ...
  IDEAS.Fluid.Sensors.Temperature senTem3(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false)
  ...
  IDEAS.Fluid.Sensors.Temperature senTem4(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false)
  ...
  IDEAS.Fluid.Sensors.Temperature senTem1(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false)
  ...
  IDEAS.Fluid.Sensors.Temperature senTem2(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false)
