...
protected
  model Humidifier
    ...
    IDEAS.Fluid.Humidifiers.Humidifier_u hum(
    ...
    IDEAS.Fluid.Sensors.TemperatureTwoPort T_a(
      redeclare final package Medium = Medium,
      final m_flow_nominal=m_flow_nominal,
      tau=0) "Temperature at port_a"
      annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
    IDEAS.Fluid.Sensors.TemperatureTwoPort T_b(
      redeclare final package Medium = Medium,
      final m_flow_nominal=m_flow_nominal,
      tau=0) "Temperature at port_a"
    ...
    IDEAS.Fluid.Sensors.MassFractionTwoPort X_a(
      redeclare final package Medium = Medium,
      final m_flow_nominal=m_flow_nominal,
      tau=0,
      final substanceName="water") "Mass fraction at port_a"
      annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
    IDEAS.Fluid.Sensors.MassFractionTwoPort X_b(
      redeclare final package Medium = Medium,
      final m_flow_nominal=m_flow_nominal,
      tau=0,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/Humidifier_u.mos"
        "Simulate and plot"),
