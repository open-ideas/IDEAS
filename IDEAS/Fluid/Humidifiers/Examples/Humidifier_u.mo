within IDEAS.Fluid.Humidifiers.Examples;
model Humidifier_u "Model that demonstrates the ideal humidifier model"
  ...
  IDEAS.Fluid.Humidifiers.Humidifier_u humSte(
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.Humidifiers.Humidifier_u humDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000,
    mWat_flow_nominal=m_flow_nominal*0.005,
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Humidifiers/Examples/Humidifier_u.mos"
        "Simulate and plot"),
