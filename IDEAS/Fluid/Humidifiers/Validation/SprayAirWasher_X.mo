within IDEAS.Fluid.Humidifiers.Validation;
model SprayAirWasher_X
  ...
  replaceable IDEAS.Fluid.Humidifiers.SprayAirWasher_X hum(
    mWatMax_flow=mWat_flow_nominal,
    massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
      constrainedby
    IDEAS.Fluid.HeatExchangers.BaseClasses.PartialPrescribedOutlet(
        redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.Sensors.MassFractionTwoPort senHum(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,
            -100},{200,200}})),
    __Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Humidifiers/Validation/SprayAirWasher_X.mos"
        "Simulate and plot"),
