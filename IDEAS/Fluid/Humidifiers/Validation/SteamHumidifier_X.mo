...
model SteamHumidifier_X
  ...
  extends IDEAS.Fluid.Humidifiers.Validation.SprayAirWasher_X(
    redeclare IDEAS.Fluid.Humidifiers.SteamHumidifier_X hum(
      mWatMax_flow=mWat_flow_nominal));

annotation (
    __Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Humidifiers/Validation/SteamHumidifier_X.mos"
        "Simulate and plot"),
