...
model ScrollWaterToWater_ScalingFactor
  ...
  IDEAS.Fluid.HeatPumps.ScrollWaterToWater heaPum1(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=1000,
    dp2_nominal=1000,
...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ScrollWaterToWater_ScalingFactor.mos"
        "Simulate and plot"),
    experiment(
...
IDEAS.Fluid.HeatPumps.ScrollWaterToWater</a> heat pump model. This
