within IDEAS.Fluid.HeatPumps.Validation;
model ReciprocatingWaterToWater_ScalingFactor
  ...
  IDEAS.Fluid.HeatPumps.ReciprocatingWaterToWater heaPum(
    ...
    per=IDEAS.Fluid.HeatPumps.Data.ReciprocatingWaterToWater.Generic(
        etaEle=0.696,
        PLos=100,
        dTSup=9.82,
        UACon=2210,
  ...
  IDEAS.Fluid.HeatPumps.ReciprocatingWaterToWater heaPum1(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=1000,
    dp2_nominal=1000,
...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ReciprocatingWaterToWater_ScalingFactor.mos"
        "Simulate and plot"),
    experiment(
...
<a href=\"modelica://IDEAS.Fluid.HeatPumps.ReciprocatingWaterToWater\">
IDEAS.Fluid.HeatPumps.ReciprocatingWaterToWater</a> heat pump model. This
