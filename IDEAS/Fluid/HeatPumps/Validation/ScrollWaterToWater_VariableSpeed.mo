...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ScrollWaterToWater_VariableSpeed.mos"
        "Simulate and plot"),
    experiment(
...
IDEAS.Fluid.HeatPumps.ScrollWaterToWater</a> heat pump model.
</p>
<p>
