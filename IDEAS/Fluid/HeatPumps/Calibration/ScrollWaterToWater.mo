within IDEAS.Fluid.HeatPumps.Calibration;
model ScrollWaterToWater
  "Calibration model for scroll water to water heat pump"
  extends Modelica.Icons.Example;
  extends IDEAS.Fluid.HeatPumps.Calibration.BaseClasses.PartialWaterToWater(
    redeclare package Medium1 = IDEAS.Media.Water,
    redeclare package Medium2 = IDEAS.Media.Water,
    redeclare IDEAS.Fluid.HeatPumps.ScrollWaterToWater heaPum(
      datHeaPum(
        etaEle=etaEle,
        PLos=PLos,
        dTSup=dTSup,
    ...
    calDat(tableName="ManufacturerData",
          ...
          "modelica://IDEAS/Resources/src/fluid/heatpumps/calibration/manufacturerData.txt")),
    UACon = 12000.0,
    UAEva = 12000.0,
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-140,-100},
    ...
    preferredView="info",
    __Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatPumps/Calibration/ScrollWaterToWater.mos"
        "Simulate and plot"),
...
found in IDEAS/Resources/src/fluid/heatpumps/calibration/.
...
<code>IDEAS/Resources/src/fluid/heatpumps/calibration/doc/build/html</code>.
</p>
</html>", revisions="<html>
<ul>
<li>
