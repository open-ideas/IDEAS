within IDEAS.Fluid.HeatPumps.Calibration.BaseClasses;
model PartialWaterToWater
  ...
  replaceable IDEAS.Fluid.HeatPumps.BaseClasses.PartialWaterToWater heaPum
    constrainedby IDEAS.Fluid.HeatPumps.BaseClasses.PartialWaterToWater(
