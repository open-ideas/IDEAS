...
model TableData2D "Performance data based on condenser outlet and evaporator inlet temperature"
  extends
    ...
    PEle_nominal=Modelica.Blocks.Tables.Internal.getTable2DValueNoDer2(
        ...
        TEva_nominal) * scaFac);
  extends
    IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses.PartialTableData2D(
  ...
  replaceable parameter IDEAS.Fluid.HeatPumps.ModularReversible.Data.TableData2D.GenericHeatPump datTab
