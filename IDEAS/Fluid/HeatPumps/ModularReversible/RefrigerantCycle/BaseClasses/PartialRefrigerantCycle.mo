within IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses;
partial model PartialRefrigerantCycle
  ...
  replaceable IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.NoFrosting iceFacCal
    constrainedby IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.BaseClasses.PartialIcingFactor(final cpEva=cpEva)
  ...
  "Heat flow rate through condenser" annotation (
      Placement(transformation(
        ...
        rotation=270,
        origin={-80,-130})));
  IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.RefrigerantMachineControlBus sigBus
...
equation
  ...
  <li>
    ...
    Adapted based on IDEAS implementation. Mainly, the iceFac is added directly
