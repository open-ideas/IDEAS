within IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.Validation;
model WetterAfjei1997
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.RefrigerantMachineControlBus
    sigBus1
...
equation
  ...
  annotation (   __Dymola_Commands(file=
     "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/RefrigerantCycle/Frosting/Validation/WetterAfjei1997.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=35,
