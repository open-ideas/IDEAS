...
model Safety "Model including all safety levels"
  ...
  replaceable
    IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.OperationalEnvelope
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.AntiFreeze antFre(final TAntFre=
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.MinimalFlowRate
