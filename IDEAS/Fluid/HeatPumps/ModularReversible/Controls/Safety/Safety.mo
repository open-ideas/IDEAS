within IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety;
model Safety "Model including all safety levels"
  ...
  replaceable parameter IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.Data.Generic
    safCtrPar constrainedby
    IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.Data.Generic
    "Safety control parameters" annotation (choicesAllMatching=true, Placement(
        transformation(extent={{-106,92},{-92,108}})));
  replaceable
    IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.OperationalEnvelope opeEnv
      if safCtrPar.use_opeEnv constrainedby
        IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.BaseClasses.PartialOperationalEnvelope(
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.OnOff onOffCtr(
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.AntiFreeze antFre(
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.MinimalFlowRate minVolFloRatSaf(
...
<ul>
<li><a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.OnOff\">
IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.OnOff</a> </li>
<li><a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.OperationalEnvelope\">
IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.OperationalEnvelope</a> </li>
<li><a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.AntiFreeze\">
IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.AntiFreeze</a> </li>
<li><a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.MinimalFlowRate\">
IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.MinimalFlowRate</a> </li>
</ul>
</html>"));
end Safety;
