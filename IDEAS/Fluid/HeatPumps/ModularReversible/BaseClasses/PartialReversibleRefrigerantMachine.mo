within IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses;
partial model PartialReversibleRefrigerantMachine
  ...
  replaceable model RefrigerantCycleInertia =
     IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Inertias.NoInertia
    constrainedby
  ...
  replaceable parameter
    IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.Data.Wuellhorst2021 safCtrPar
    constrainedby
...
//Advanced
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.EvaporatorCondenserWithCapacity con(
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.EvaporatorCondenserWithCapacity eva(
  ...
  Modelica.Thermal.HeatTransfer.Sources.PrescribedTemperature varTOutCon
    ...
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-50,130})));
  IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.Safety safCtr(
  ...
  IDEAS.Fluid.Sensors.MassFlowRate mEva_flow(redeclare final package Medium =
    ...
    "Mass flow sensor at the evaporator" annotation (Placement(transformation(
        ...
        extent={{10,-10},{-10,10}},
        rotation=0)));
  IDEAS.Fluid.Sensors.MassFlowRate mCon_flow(final allowFlowReversal=
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.CalculateEfficiency
...
equation
  ...
  <li>
    ...
    (see issue <a href=
    \"https://github.com/RWTH-EBC/IDEAS/issues/715\">#715</a>)
  </li>
  <li>
    <i>November 26, 2018</i> by Fabian Wuellhorst:<br/>
    First implementation (see issue <a href=
    \"https://github.com/RWTH-EBC/IDEAS/issues/577\">#577</a>)
  </li>
</ul>
</html>", info="<html>
<p>
...
<p>
  ...
  in <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.Modular\">
  IDEAS.Fluid.HeatPumps.ModularReversible.Modular</a>.
</p>
<p>
