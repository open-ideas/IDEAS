...
model EvaporatorCondenserWithCapacity
  ...
  extends IDEAS.Fluid.Interfaces.TwoPortHeatMassExchanger(
    redeclare final IDEAS.Fluid.MixingVolumes.MixingVolume vol(final V=
...
<p>
  Used in <a href=
  \"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.Modular\">
  IDEAS.Fluid.HeatPumps.ModularReversible.Modular</a> and <a href=
  \"modelica://IDEAS.Fluid.Chillers.ModularReversible.Modular\">
