...
model CarnotWithLosses_OneRoomRadiator
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.CarnotWithLosses heaPum(
...
equation
  ...
  annotation (
   __Dymola_Commands(file=
     "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Examples/CarnotWithLosses_OneRoomRadiator.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=86400,
