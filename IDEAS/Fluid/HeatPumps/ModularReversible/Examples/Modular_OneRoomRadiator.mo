...
model Modular_OneRoomRadiator
  ...
  IDEAS.Fluid.HeatPumps.ModularReversible.Modular heaPum(
    ...
    redeclare model RefrigerantCycleHeatPumpCooling =
      IDEAS.Fluid.Chillers.ModularReversible.RefrigerantCycle.TableData2D(
        ...
        mEva_flow_nominal=heaPum.mEva_flow_nominal,
        datTab=IDEAS.Fluid.Chillers.ModularReversible.Data.TableData2D.EN14511.Vitocal251A08()),
    redeclare IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.Data.Wuellhorst2021 safCtrPar(
      use_TConOutHea=true,
...
<li>
  ...
  \"https://github.com/ibpsa/modelica-ibpsa/issues/1576\">#1576</a>)
   ...
   __Dymola_Commands(file=
     "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Examples/Modular_OneRoomRadiator.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=86400,
