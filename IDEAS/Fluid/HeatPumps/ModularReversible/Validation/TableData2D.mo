within IDEAS.Fluid.HeatPumps.ModularReversible.Validation;
model TableData2D
  extends Modelica.Icons.Example;
  extends
    IDEAS.Fluid.HeatPumps.ModularReversible.Validation.BaseClasses.PartialValidation(
      heaPum(
      ...
      redeclare model RefrigerantCycleHeatPumpHeating =
          IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.TableData2D (
            datTab=
              IDEAS.Fluid.HeatPumps.ModularReversible.Data.TableData2D.GenericHeatPump(
  ...
  annotation (experiment(Tolerance=1e-6, StopTime=14365),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Validation/TableData2D.mos"
            "Simulate and plot"),
