within IDEAS.Fluid.HeatPumps.ModularReversible.Validation.Comparative.BaseClasses;
partial model PartialComparison
  ...
  IDEAS.Fluid.Sources.Boundary_pT sin1(redeclare package Medium = Medium1)
    annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        origin={70,30})));
  IDEAS.Fluid.Sources.Boundary_pT sin2(redeclare package Medium = Medium2)
    annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        origin={-50,-30})));
...
<a href=\"modelica://IDEAS.Fluid.HeatPumps.Examples.Carnot_y\">
IDEAS.Fluid.HeatPumps.Examples.Carnot_y</a>
to validate the modular reversible models by means of
comparison to the <a href=\"modelica://IDEAS.Fluid.HeatPumps.Carnot_y\">
IDEAS.Fluid.HeatPumps.Carnot_y</a> model.
</p>
</html>"));
