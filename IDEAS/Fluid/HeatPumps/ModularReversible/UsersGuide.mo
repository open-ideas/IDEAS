...
<p>
  The packages <a href=\"modelica://IDEAS.Fluid.HeatPumps\">IDEAS.Fluid.HeatPumps</a>
  and <a href=\"modelica://IDEAS.Fluid.Chillers\">IDEAS.Fluid.Chillers</a> contain
...
<p>
  ...
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses.PartialHeatPumpCycle\">
  IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses.PartialHeatPumpCycle</a>.
  This partial model declares all common interfaces, parameters, etc.
</p>

<h5>Heat pump models</h5>
<p>
For heat pumps, the model <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.Modular\">
IDEAS.Fluid.HeatPumps.ModularReversible.Modular</a> extends the partial model and adds
...
the heat pump
<a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.RefrigerantCycle\">
IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.RefrigerantCycle</a>.
...
<a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle\">
IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle</a>
...
<!-- @include_Buildings
<li>
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.TableData2DLoadDep\">
  IDEAS.Fluid.HeatPumps.ModularReversible.TableData2DLoadDep</a>: 
...
-->
<li>
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.LargeScaleWaterToWater\">
  IDEAS.Fluid.HeatPumps.ModularReversible.LargeScaleWaterToWater</a>
</li>
<li>
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.AirToWaterTableData2D\">
  IDEAS.Fluid.HeatPumps.ModularReversible.AirToWaterTableData2D</a>
</li>
<li>
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.CarnotWithLosses\">
  IDEAS.Fluid.HeatPumps.ModularReversible.CarnotWithLosses</a>
</li>
</ul>
...
<p>
For chillers, the model <a href=\"modelica://IDEAS.Fluid.Chillers.ModularReversible.Modular\">
IDEAS.Fluid.Chillers.ModularReversible.Modular</a> extends the partial model and adds
...
Furthermore, the refrigerant cycle is redeclared to use the one for
the chiller
<a href=\"modelica://IDEAS.Fluid.Chillers.ModularReversible.BaseClasses.RefrigerantCycle\">
IDEAS.Fluid.Chillers.ModularReversible.BaseClasses.RefrigerantCycle</a>.
This refrigerant cycle in turn contains replaceable models for the
cooling and heating operation of the chiller.
Available modules can be found in the package:
<a href=\"modelica://IDEAS.Fluid.Chillers.ModularReversible.RefrigerantCycle\">
IDEAS.Fluid.Chillers.ModularReversible.RefrigerantCycle</a>.
For more information on the refrigerant cycle models, refer
to the section <b>Refrigerant cycle models</b>.
</p>
<p>
...
<!-- @include_Buildings
<li>
  <a href=\"modelica://IDEAS.Fluid.Chillers.ModularReversible.TableData2DLoadDep\">
  IDEAS.Fluid.Chillers.ModularReversible.TableData2DLoadDep</a>: 
  This is the recommended model for energy simulation and any use case where detailed 
  modeling of the chiller onboard controls is not required.
</li>
-->
<li>
  <a href=\"modelica://IDEAS.Fluid.Chillers.ModularReversible.LargeScaleWaterToWater\">
  IDEAS.Fluid.Chillers.ModularReversible.LargeScaleWaterToWater</a>
</li>
<li>
  <a href=\"modelica://IDEAS.Fluid.Chillers.ModularReversible.CarnotWithLosses\">
  IDEAS.Fluid.Chillers.ModularReversible.CarnotWithLosses</a>
</li>
</ul>
...
<a href=\"modelica://IDEAS.Fluid.UsersGuide\">IDEAS.Fluid.UsersGuide</a>.
</p>
...
<p>
  ...
  <a href=\"modelica://IDEAS.Fluid.Chillers.ModularReversible.RefrigerantCycle.BaseClasses.PartialChillerCycle\">
  IDEAS.Fluid.Chillers.ModularReversible.RefrigerantCycle.BaseClasses.PartialChillerCycle</a>.
</p>
<p>
  Two basic modules for the refrigerant cycle are available.
  First, the <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness\">
  IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness</a> model
  uses the same equations as the Carnot models, i.e.  <a href=\"modelica://IDEAS.Fluid.HeatPumps.Carnot_y\">
  IDEAS.Fluid.HeatPumps.Carnot_y</a>.
  Second, the <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.TableData2D\">
  IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.TableData2D</a> provides performance data
...
<p>
  ...
  The first approach is similar to <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.TableData2D\">
...
<p>
  ...
  the basic IDEAS concept for nominal conditions, explained in
  detail here:
  <a href=\"modelica://IDEAS.Fluid.UsersGuide\">IDEAS.Fluid.UsersGuide</a>
</p>
<p>
...
<p>
  ...
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.TableData2D\">
  IDEAS.Fluid.HeatPumps.ModularReversible.TableData2D</a>
...
<p>
  ...
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.Safety\">
  IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.Safety</a>
</p>

<p>
  An important safety control with regard to
  system interaction is the operation envelope. Read the documentation of
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.BaseClasses.PartialOperationalEnvelope\">
  IDEAS.Fluid.HeatPumps.ModularReversible.Controls.Safety.BaseClasses.PartialOperationalEnvelope</a>
...
<p>
  The package
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Inertias\">
  IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Inertias</a>
...
<p>
  ...
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Inertias.BaseClasses.PartialInertia\">
  IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Inertias.BaseClasses.PartialInertia
  </a>
...
<p>
  ...
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.BaseClasses.PartialIcingFactor\">
  IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.BaseClasses.PartialIcingFactor</a>
</p>
<p>
...
<p>
  ...
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.EvaporatorCondenserWithCapacity\">
  IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.EvaporatorCondenserWithCapacity</a>
</p>
