within IDEAS.Fluid.HeatPumps.Compressors.BaseClasses.Validation;
model TemperatureProtection
  "Validation of temperature protection model"
  extends Modelica.Icons.Example;

  IDEAS.Fluid.HeatPumps.Compressors.BaseClasses.TemperatureProtection
...
__Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatPumps/Compressors/BaseClasses/Validation/TemperatureProtection.mos"
        "Simulate and plot"),
