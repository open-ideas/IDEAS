...
protected
  ...
  IDEAS.Fluid.PVTCollectors.Validation.PVT_UN.BaseClasses.MyReaderTMY3 weaDat(filNam=
        filNam)
...
equation
  ...
  connect(solTim.u, weaDatBus.solTim)
    annotation (Line(points={{-86.8,2},{-99.95,2},{-99.95,-9.95}},
                                                            color={0,0,127}));
  connect(angZen.u, weaDatBus.solZen) annotation (Line(points={{-86.8,84},{-99.95,
          84},{-99.95,-9.95}},
                          color={0,0,127}));
  connect(HDifHor.u, weaDatBus.HDifHor) annotation (Line(points={{-86.8,98},{-99.95,
          98},{-99.95,-9.95}},
                          color={0,0,127}));
  connect(HGloHor.u, weaDatBus.HGloHor) annotation (Line(points={{-86.8,112},{-99.95,
          112},{-99.95,-9.95}},
                           color={0,0,127}));
  connect(HDirNor.u, weaDatBus.HDirNor) annotation (Line(points={{-86.8,44},{-99.95,
          44},{-99.95,-9.95}},
                          color={0,0,127}));
  connect(solDec.u, weaDatBus.solDec) annotation (Line(points={{-86.8,56},{-99.95,
          56},{-99.95,-9.95}},
                          color={0,0,127}));
  connect(solHouAng.u, weaDatBus.solHouAng) annotation (Line(points={{-86.8,70},
          {-99.95,70},{-99.95,-9.95}},
                                color={0,0,127}));
  connect(TDryBul.u, weaDatBus.TDryBul) annotation (Line(points={{-86.8,30},{-99.95,
          30},{-99.95,-9.95}},
                          color={0,0,127}));
  connect(phiEnv.u, weaDatBus.relHum) annotation (Line(points={{-86.8,16},{-99.95,
          16},{-99.95,-9.95}},
                          color={0,0,127}));
  ...
  connect(winDir.u, weaDatBus.winDir) annotation (Line(points={{-86.8,140},{-99.95,
          140},{-99.95,-9.95}},  color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(winSpe.u, weaDatBus.winSpe) annotation (Line(points={{-86.8,126},{-99.95,
          126},{-99.95,-9.95}},  color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(alt.u, weaDatBus.alt) annotation (Line(points={{-86.8,-18},{-99.95,-18},
          {-99.95,-9.95}},
                       color={0,0,127}), Text(
      string="%second",
      index=1,
