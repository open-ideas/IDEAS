...
model PartialPvtCollector
  ...
  Modelica.Blocks.Math.Add HGloTil "Total irradiation on tilted surface"
...
equation
  ...
  connect(HGloTil.u1, HDirTil.H) annotation (Line(points={{18,90},{-54,90},{-54,
          50},{-59,50}}, color={0,0,127}));
  connect(HGloTil.u2, HDifTilIso.H) annotation (Line(points={{30,90},{30,98},{-54,
