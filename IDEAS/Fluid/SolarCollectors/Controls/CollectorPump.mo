within IDEAS.Fluid.SolarCollectors.Controls;
model CollectorPump
  ...
  IDEAS.BoundaryConditions.WeatherData.Bus weaBus "Weather data input"
    annotation (Placement(transformation(extent={{-110,40},{-90,60}})));

  IDEAS.Fluid.SolarCollectors.Controls.BaseClasses.GCritCalc criSol(
...
equation
  ...
  connect(on, hys.y) annotation (Line(points={{120,0},{81,0}},
        color={255,0,255}));
  annotation (
...
Moved old model to <code>IDEAS.Obsolete</code> package.<br/>
This is for
