within IDEAS.Fluid.SolarCollectors.Controls.BaseClasses.Examples;
model GCritCalc "Example showing the use of GCritCalc"
  extends Modelica.Icons.Example;
  IDEAS.Fluid.SolarCollectors.Controls.BaseClasses.GCritCalc criSol(slope=-3.764,
      y_intercept=0.602)
...
<a href=\"modelica://IDEAS.Fluid.SolarCollectors.Controls.BaseClasses.GCritCalc\">
IDEAS.Fluid.SolarCollectors.Controls.BaseClasses.GCritCalc</a> model.<br/>
</p>
</html>",
revisions="<html>
<ul>
<li>
  ...
  First implementation
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/SolarCollectors/Controls/BaseClasses/Examples/GCritCalc.mos"
        "Simulate and plot"),
