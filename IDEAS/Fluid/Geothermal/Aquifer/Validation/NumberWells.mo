within IDEAS.Fluid.Geothermal.Aquifer.Validation;
model NumberWells
  ...
  model MyWell = MultiWell (
    ...
    TGroCol=273.15,
    TGroHot=303.15,
    aquDat=IDEAS.Fluid.Geothermal.Aquifer.Data.Rock(),
    m_flow_nominal=0.1,
  ...
  IDEAS.Utilities.Diagnostics.CheckEquality cheEqu
...
equation
  ...
  "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Geothermal/Aquifer/Validation/NumberWells.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
Example that verifies the scalability of
<a href=\"modelica://IDEAS.Fluid.Geothermal.Aquifer.MultiWell\">IDEAS.Fluid.Geothermal.Aquifer.MultiWell</a>
