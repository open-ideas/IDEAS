within IDEAS.Fluid.Geothermal.Borefields.Examples;
model RectangularBorefield "Example model of a rectangular borefield"
  ...
  final parameter IDEAS.Fluid.Geothermal.Borefields.Data.Filling.Bentonite filDat
    annotation (Placement(transformation(extent={{20,40},{40,60}})));
  final parameter IDEAS.Fluid.Geothermal.Borefields.Data.Soil.SandStone soiDat
    "Soil data" annotation (Placement(transformation(extent={{50,40},{70,60}})));
  final parameter IDEAS.Fluid.Geothermal.Borefields.Data.Configuration.Template conDat(
    final borCon=IDEAS.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.SingleUTube,
    final use_Rb=false,
  ...
  final parameter IDEAS.Fluid.Geothermal.Borefields.Data.Borefield.Template
    borFieDat(
      final filDat=filDat,
      final soiDat=soiDat,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/Examples/RectangularBorefield.mos"
        "Simulate and plot"),
  experiment(
