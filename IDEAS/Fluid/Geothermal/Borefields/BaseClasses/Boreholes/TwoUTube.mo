within IDEAS.Fluid.Geothermal.Borefields.BaseClasses.Boreholes;
model TwoUTube "Double U-tube borehole heat exchanger"
  extends IDEAS.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.PartialBorehole;
