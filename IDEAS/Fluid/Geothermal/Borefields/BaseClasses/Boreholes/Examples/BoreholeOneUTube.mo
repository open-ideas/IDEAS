...
model BoreholeOneUTube "Test for the single U-tube borehole model"
  ...
  extends
    IDEAS.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.Examples.BaseClasses.PartialBorehole(
      redeclare
  ...
  annotation (
    __Dymola_Commands( file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/Examples/BoreholeOneUTube.mos"
        "Simulate and plot"),
...
<a href=\"modelica://IDEAS.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.OneUTube\">
IDEAS.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.OneUTubes</a>
