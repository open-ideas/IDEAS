...
equation
  t = exp(time) - 1.0;
  for k in 1:5 loop
    G[k] = IDEAS.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.cylindricalHeatSource(
      t = t,
      aSoi = aSoi,
      dis = r[k],
      rBor = rSource);
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/ThermalResponseFactors/Validation/CylindricalHeatSource.mos"
        "Simulate and plot"),
