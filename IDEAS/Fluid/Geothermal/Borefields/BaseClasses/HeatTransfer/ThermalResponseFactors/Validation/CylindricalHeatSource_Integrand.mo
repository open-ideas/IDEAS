...
equation
  u = time;
  for k in 1:4 loop
    y[k] = IDEAS.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.cylindricalHeatSource_Integrand(
      u = u,
      Fo = Fo,
      p = p[k]);
  end for;
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/ThermalResponseFactors/Validation/CylindricalHeatSource_Integrand.mos"
        "Simulate and plot"),
