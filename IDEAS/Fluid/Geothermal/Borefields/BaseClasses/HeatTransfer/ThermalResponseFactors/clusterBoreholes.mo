...
algorithm
  ...
  for i in 1:nBor loop
    ...
    for j in 1:nBor loop
      ...
      TBor[i,1] := TBor[i,1] + IDEAS.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.finiteLineSource_SteadyState(dis, hBor, dBor, hBor, dBor);
    end for;
  end for;
  ...
  (,labels,cluSiz) := IDEAS.Utilities.Clustering.KMeans(
    TBor,
    N,
    nBor,
    1,
...
<a href=\"modelica://IDEAS.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.finiteLineSource_SteadyState\">
IDEAS.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.finiteLineSource_SteadyState</a>).
</p>
