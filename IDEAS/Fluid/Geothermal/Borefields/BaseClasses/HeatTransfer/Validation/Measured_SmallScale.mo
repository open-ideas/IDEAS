...
model Measured_SmallScale
  ...
  parameter IDEAS.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.Validation.BaseClasses.SmallScale_Borefield
  ...
  Modelica.Blocks.Sources.CombiTimeTable meaDat(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://IDEAS/Resources/Data/Fluid/Geothermal/Borefields/HeatTransfer/Validation/Cimmino_Bernier_2015_SmallScale.txt"),
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/Validation/Measured_SmallScale.mos"
        "Simulate and plot"),
