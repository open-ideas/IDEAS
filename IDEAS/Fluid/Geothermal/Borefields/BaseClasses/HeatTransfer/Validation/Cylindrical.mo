...
model Cylindrical
  ...
  parameter IDEAS.Fluid.Geothermal.Borefields.Data.Borefield.Template borFieDat=
    IDEAS.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Borefield()
    annotation (Placement(transformation(extent={{-80,60},{-60,80}})));

  IDEAS.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.Cylindrical soi(
...
equation
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/Validation/Cylindrical.mos"
        "Simulate and plot"),
    experiment(Tolerance=1e-6, StopTime=360000.0),
    Documentation(info="<html>
<p>
This example demonstrates the use of
<a href=\"modelica://IDEAS.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.Cylindrical\">
IDEAS.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.Cylindrical</a>.
</p>
<p>
