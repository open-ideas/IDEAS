...
model MixingBox
 ...
 package Medium = IDEAS.Media.Air
  ...
  IDEAS.Fluid.Actuators.Dampers.MixingBox mixBox(
    mOut_flow_nominal=1,
    mRec_flow_nominal=1,
    mExh_flow_nominal=1,
...
equation
  ...
  connect(bouRet.ports[1], mixBox.port_Ret) annotation (Line(
      ...
      color={0,127,255}));
  annotation (             __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Examples/MixingBox.mos"
        "Simulate and plot"),
