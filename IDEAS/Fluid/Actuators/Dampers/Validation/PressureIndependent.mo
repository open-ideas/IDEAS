within IDEAS.Fluid.Actuators.Dampers.Validation;
model PressureIndependent
  ...
  IDEAS.Fluid.Actuators.Dampers.Exponential damExp(
  ...
  IDEAS.Fluid.Actuators.Dampers.PressureIndependent damPreInd(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
    final dpDamper_nominal=dp_nominal,
    use_inputFilter=false)
...
__Dymola_Commands(
file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Validation/PressureIndependent.mos"
"Simulate and plot"),
