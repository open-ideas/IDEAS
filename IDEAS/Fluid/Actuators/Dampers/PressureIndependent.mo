...
model PressureIndependent
  ...
  extends IDEAS.Fluid.Actuators.BaseClasses.PartialDamperExponential(
...
protected
  ...
  parameter Real[sizeSupSpl] kSupSpl_raw = IDEAS.Fluid.Actuators.BaseClasses.exponentialDamper(
...
algorithm
  ...
  y := IDEAS.Utilities.Math.Functions.smoothLimit(
...
initial equation
  ...
  invSplDer = IDEAS.Utilities.Math.Functions.splineDerivatives(x=kSupSpl_raw, y=ySupSpl_raw);
equation
  ...
  y_actual_smooth = IDEAS.Utilities.Math.Functions.regStep(
    x=y_internal - y_min,
...
IDEAS.Fluid.Actuators.Valves.TwoWayPressureIndependent</a>,
...
<a href=\"modelica://IDEAS.Fluid.Actuators.BaseClasses.exponentialDamper\">
IDEAS.Fluid.Actuators.BaseClasses.exponentialDamper</a>
