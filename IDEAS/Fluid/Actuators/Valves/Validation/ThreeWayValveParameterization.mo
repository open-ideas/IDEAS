...
model ThreeWayValveParameterization
  ...
  IDEAS.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear valOpePoi(
  ...
  IDEAS.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear valKv(
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear valCv(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
  ...
  IDEAS.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear valAv(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    Av=Av,
    use_strokeTime=false,
...
equation
  ...
  experiment(Tolerance=1e-6, StopTime=1.0),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Validation/ThreeWayValveParameterization.mos"
        "Simulate and plot"),
