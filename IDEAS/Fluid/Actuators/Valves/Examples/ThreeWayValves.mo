...
model ThreeWayValves "Three way valves with different opening characteristics"
  ...
  IDEAS.Fluid.Actuators.Valves.ThreeWayTable valTab(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    use_inputFilter=false,
    dpValve_nominal=6000,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    flowCharacteristics1=IDEAS.Fluid.Actuators.Valves.Data.Linear(),
...
Added <a href=\"modelica://IDEAS.Fluid.Actuators.Valves.ThreeWayTable\">IDEAS.Fluid.Actuators.Valves.ThreeWayTable</a>
to example.
</li>
<li>
