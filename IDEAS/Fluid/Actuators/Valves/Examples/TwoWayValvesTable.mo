...
model TwoWayValvesTable "Two way valve with linear opening characteristics"
  ...
  Valves.TwoWayTable valTab(
    ...
    flowCharacteristics=IDEAS.Fluid.Actuators.Valves.Data.Linear(),
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Examples/TwoWayValvesTable.mos"
        "Simulate and plot"),
