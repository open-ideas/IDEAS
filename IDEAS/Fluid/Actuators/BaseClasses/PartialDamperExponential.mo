...
protected
  ...
  parameter Real kL = IDEAS.Fluid.Actuators.BaseClasses.exponentialDamper(
    y=yL, a=a, b=b, cL=cL, cU=cU, yL=yL, yU=yU)^2
    "Loss coefficient at the lower limit of the exponential characteristics";
  parameter Real kU = IDEAS.Fluid.Actuators.BaseClasses.exponentialDamper(
...
equation
  ...
  kDam=sqrt(2*rho)*A/IDEAS.Fluid.Actuators.BaseClasses.exponentialDamper(
    y=y_actual,
    a=a,
    b=b,
    cL=cL,
...
with
<code>IDEAS.Media.PerfectGases.MoistAirUnsaturated</code>.
</li>
<li>
