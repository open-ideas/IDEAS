...
partial model ValveParameters "Model with parameters for valves"
  ...
  parameter Modelica.Units.SI.Area Av(fixed=if CvData == IDEAS.Fluid.Types.CvTypes.Av
         then true else false) "Av (metric) flow coefficient" annotation (
      Dialog(group="Flow Coefficient", enable=(CvData == IDEAS.Fluid.Types.CvTypes.Av)));
  ...
  parameter Modelica.Units.SI.PressureDifference dpValve_nominal(
    ...
    annotation (Dialog(group="Nominal condition", enable=(CvData == IDEAS.Fluid.Types.CvTypes.OpPoint)));
