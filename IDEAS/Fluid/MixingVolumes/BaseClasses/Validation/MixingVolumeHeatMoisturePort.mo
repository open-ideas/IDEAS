within IDEAS.Fluid.MixingVolumes.BaseClasses.Validation;
model MixingVolumeHeatMoisturePort
  ...
  extends IDEAS.Fluid.MixingVolumes.BaseClasses.Validation.MixingVolumeHeatPortWater(
    redeclare package Medium = IDEAS.Media.Air,
    redeclare IDEAS.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatMoisturePort vol);
...
__Dymola_Commands(file=
  "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/BaseClasses/Validation/MixingVolumeHeatMoisturePort.mos"
  "Simulate and plot"));
