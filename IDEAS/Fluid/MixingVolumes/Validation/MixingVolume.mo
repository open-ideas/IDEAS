...
model MixingVolume "Test model for mixing volumes"
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop res11(
    redeclare package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5)
    annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
  IDEAS.Fluid.FixedResistances.PressureDrop res12(
    redeclare package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5)
  ...
  IDEAS.Utilities.Diagnostics.CheckEquality cheEqu1(threShold = 10)
    "Check for equality of results"
    annotation (Placement(transformation(extent={{156,70},{176,90}})));
  IDEAS.Fluid.Sensors.EnthalpyFlowRate entFloRat(
    redeclare package Medium = Medium,
    m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,50},{60,70}})));
  IDEAS.Fluid.Sensors.EnthalpyFlowRate entFloRat1(
    redeclare package Medium = Medium,
    m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,0},{60,20}})));
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop res21(
    redeclare package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5)
    annotation (Placement(transformation(extent={{-40,-92},{-20,-72}})));
  IDEAS.Fluid.FixedResistances.PressureDrop res22(
    redeclare package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5)
    annotation (Placement(transformation(extent={{80,-92},{100,-72}})));
  IDEAS.Utilities.Diagnostics.CheckEquality cheEqu2(threShold = 10)
    "Check for equality of results"
    annotation (Placement(transformation(extent={{156,10},{176,30}})));
  IDEAS.Fluid.Sensors.EnthalpyFlowRate entFloRat2(
    redeclare package Medium = Medium,
    m_flow_nominal=2) "Enthalpy flow rate"
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolume.mos"
        "Simulate and plot"),
