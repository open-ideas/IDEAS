...
model MixingVolumeZeroFlow
  ...
  IDEAS.Fluid.MixingVolumes.MixingVolume volNonLinSys(
    nPorts=2,
  ...
  IDEAS.Fluid.Sources.Boundary_pT sin(nPorts=4, redeclare package Medium =
        Medium) "Sink"
  ...
  IDEAS.Fluid.MixingVolumes.MixingVolume volT(
    nPorts=2,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    V=1,
  ...
  IDEAS.Fluid.MixingVolumes.MixingVolume volLinSys(
    nPorts=2,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    V=1,
  ...
  IDEAS.Fluid.MixingVolumes.MixingVolume volQflow(
    nPorts=2,
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    V=1,
...
increase the chance of the error being produced for this simple example.
    ...
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeZeroFlow.mos"
        "Simulate and plot"));
