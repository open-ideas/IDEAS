...
model MixingVolumeMFactor
  ...
  extends IDEAS.Fluid.MixingVolumes.Validation.MixingVolumeMassFlow(
  sou(X={0.02,0.98},
      T=Medium.T_default),
  vol(mSenFac=10),
    bou(nPorts=3));
  IDEAS.Fluid.MixingVolumes.MixingVolume volMFactor(
  ...
  IDEAS.Fluid.Sources.MassFlowSource_T boundaryMFactor(
    redeclare package Medium = Medium,
    T=300,
    nPorts=1,
    m_flow=1,
...
<p>
See
<a href=\"modelica://IDEAS.Fluid.MixingVolumes.Validation.MixingVolumeMassFlow\">
IDEAS.Fluid.MixingVolumes.Validation.MixingVolumeMassFlow</a>
...
__Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeMFactor.mos"
        "Simulate and plot"));
