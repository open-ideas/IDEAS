...
model MixingVolumeAdiabaticCooling
  ...
  IDEAS.Fluid.Sources.Boundary_pT bou(redeclare package Medium = Medium, nPorts=2)
...
First implementation.
 ...
 __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeAdiabaticCooling.mos"
        "Simulate and plot"),
