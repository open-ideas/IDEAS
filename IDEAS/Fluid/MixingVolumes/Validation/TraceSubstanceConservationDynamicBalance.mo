...
model TraceSubstanceConservationDynamicBalance
  ...
  extends
    IDEAS.Fluid.MixingVolumes.Validation.BaseClasses.TraceSubstanceConservation(
...
to the fluid.
See <a href=\"modelica://IDEAS.Fluid.Interfaces.ConservationEquation\">
...
First implementation.
    ...
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/TraceSubstanceConservationDynamicBalance.mos"
        "Simulate and plot"));
