...
model MSLFlueGasSixComponents
  "Test model with medium for flue gas from the Modelica Standard Library"
    extends IDEAS.Fluid.MixingVolumes.Validation.MSLCombustionAir(
  ...
  experiment(
    Tolerance=1E-6,
    StopTime=1),
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MSLFlueGasSixComponents.mos"
        "Simulate and plot"),
    Documentation(
info = "<html>
<p>
...
<p>
This medium differs from media in the IDEAS library in that it sets <code>reducedX=false</code>.
</p>
</html>",
revisions = "<html>
<ul>
