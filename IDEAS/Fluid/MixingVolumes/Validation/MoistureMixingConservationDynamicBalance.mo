...
model MoistureMixingConservationDynamicBalance
  ...
  extends
    IDEAS.Fluid.MixingVolumes.Validation.BaseClasses.MoistureMixingConservation(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MoistureMixingConservationDynamicBalance.mos"
        "Simulate and plot"));
