...
model MSLCombustionAir
  ...
  IDEAS.Fluid.Sources.MassFlowSource_T masFloSou(
    redeclare package Medium = Medium,
...
equation
  ...
  experiment(
    Tolerance=1E-6,
    StopTime=1),
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MSLCombustionAir.mos"
        "Simulate and plot"),
    Documentation(
info = "<html>
<p>
...
<p>
This medium differs from media in the IDEAS library in that it has no substance <code>water</code>
