...
model CoupledVolumesSpecializedWaterConstantProperties_pT
  ...
  extends IDEAS.Fluid.MixingVolumes.Validation.CoupledVolumesWater(
    redeclare package Medium =
        IDEAS.Media.Specialized.Water.ConstantProperties_pT);
...
<a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/910\">IDEAS, issue 910</a>.
</li>
</ul>
</html>"),
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/CoupledVolumesSpecializedWaterConstantProperties_pT.mos"
           "Simulate and plot"));
