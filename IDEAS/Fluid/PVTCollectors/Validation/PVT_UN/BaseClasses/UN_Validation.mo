...
record UN_Validation =
  IDEAS.Fluid.PVTCollectors.Data.Generic            (
    ...
    final IAMDiff=0.93,
    final eta0=0.535/(0.85+0.15*0.93),
    final a1=10.74+3*1.0997,
    final a2=0.0,
    final a3=0.0, // Put to 0.0 for validation purposes
    final a4=0.0, // Put to 0.0 for validation purposes
    final a6=0.0, // Put to 0.0 for validation purposes
    final a7=0.0, // Put to 0.0 for validation purposes
    final a8=0.0, // Put to 0.0 for validation purposes
    final P_nominal=300,
    final gamma=-0.00375,
    final etaEl=0.183)
