...
model ElectricalPV
  ...
  Modelica.Blocks.Sources.RealExpression solarPower(y=n*P_STC*G/G_STC*(1+beta*T_diff)*(1-eleLosFac))
    "Power generated by the photovoltaic installation" annotation (Placement(transformation(extent={{9,-50},
            {-11,-30}})));
...
public
  ...
  Modelica.Blocks.Sources.RealExpression Gtil(y=meaDat.y[4]) "[W/m2]"
    annotation (Placement(transformation(extent={{-79.5,40},{-60.5,56}})));
  outer Modelica.Blocks.Sources.CombiTimeTable meaDat(
    tableOnFile=true,
    tableName="data",
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://IDEAS/Resources/Data/Fluid/PvtCollectors/Validation/PVT_UN/PVT_UN_measurements_week1.txt"),
    columns=1:25) annotation (Placement(transformation(extent={{80,60},{60,80}})));
equation
  ...
  connect(solarPower.y, P) annotation (Line(points={{-12,-40},{-96,-40},{-96,0},
          {-110,0}}, color={0,0,127}));
    annotation (Dialog(group="Characteristics of the photovoltaic installation"),
