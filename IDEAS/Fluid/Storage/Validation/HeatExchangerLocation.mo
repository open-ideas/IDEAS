...
model HeatExchangerLocation
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTan_aTop(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    tau=0) "Temperature sensor at tank outlet"
    annotation (Placement(transformation(extent={{10,-30},{-10,-10}})));

  IDEAS.Fluid.Sensors.TemperatureTwoPort senTan_bTop(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    tau=0) "Temperature sensor at tank outlet"
...
equation
  ...
  annotation (
  __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Storage/Validation/HeatExchangerLocation.mos"
        "Simulate and plot"),
