...
protected
  ...
  IDEAS.Fluid.HeatExchangers.BaseClasses.HACoilInside hAPipIns[nSeg](
    each m_flow_nominal=m_flow_nominal,
  ...
  IDEAS.Fluid.HeatExchangers.BaseClasses.HANaturalCylinder hANatCyl[nSeg](
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
        ...
        Documentation(info = "<html>
          ...
          <p>
          The model is based on <a href=\"modelica://IDEAS.Fluid.HeatExchangers.BaseClasses.HACoilInside\">
          IDEAS.Fluid.HeatExchangers.BaseClasses.HACoilInside</a> and
          <a href=\"modelica://IDEAS.Fluid.HeatExchangers.BaseClasses.HANaturalCylinder\">
          IDEAS.Fluid.HeatExchangers.BaseClasses.HANaturalCylinder</a>.
          </p>
          <p>
