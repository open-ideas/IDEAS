...
model StratifiedEnhancedInternalHex
  ...
  package MediumTan = IDEAS.Media.Water "Medium in the tank";
  package MediumHex = IDEAS.Media.Water "Medium in the heat exchanger";
  ...
  IDEAS.Fluid.Sources.Boundary_pT bouWat(redeclare package Medium =
    ...
    "Boundary condition for water (used to set pressure)" annotation (Placement(
        ...
        rotation=180,
        origin={72,-78})));
  IDEAS.Fluid.Sources.Boundary_pT solColSup(
  ...
  IDEAS.Fluid.Sources.Boundary_pT toSolCol(
    redeclare package Medium = MediumHex,
    nPorts=3,
    ...
    T=283.15) "Water to solar collector" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        origin={-72,-20})));
  IDEAS.Fluid.Storage.StratifiedEnhancedInternalHex tanSte(
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTemSte(
    redeclare package Medium = MediumHex,
    allowFlowReversal=false,
  ...
  IDEAS.Fluid.Storage.StratifiedEnhancedInternalHex tanDynSol(
    redeclare package Medium = MediumTan,
    m_flow_nominal=0.001,
    VTan=0.151416,
    dIns=0.0762,
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTemDynSol(
    redeclare package Medium = MediumHex,
    allowFlowReversal=false,
    m_flow_nominal=mHex_flow_nominal,
    tau=0)
...
equation
  ...
  annotation ( __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Storage/Examples/StratifiedEnhancedInternalHex.mos"
        "Simulate and plot"),
...
IDEAS.Fluid.Storage.StratifiedEnhancedInternalHex</a> model.
