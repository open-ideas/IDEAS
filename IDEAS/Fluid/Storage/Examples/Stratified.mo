...
model Stratified "Test model for stratified tank"
 ...
 package Medium = IDEAS.Media.Water "Medium model";
  ...
  IDEAS.Fluid.Storage.Stratified tanSim(
  ...
  IDEAS.Fluid.Sensors.EnthalpyFlowRate HOut_flow(redeclare package Medium =
        Medium, m_flow_nominal=0.1) "Enthalpy flow rate"
          ...
          extent={{4,-16},{20,0}})));
  IDEAS.Fluid.Sensors.EnthalpyFlowRate HOut_flow1(redeclare package Medium =
        Medium, m_flow_nominal=0.1) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{20,-88},{36,-72}})));
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Storage/Examples/Stratified.mos"
        "Simulate and plot"),
