...
model StratifiedUnloadAtMinimumTemperature
  ...
  IDEAS.Fluid.Sources.Boundary_pT loa(redeclare package Medium = Medium,
      nPorts=1)
  ...
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear valMid(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dpValve_nominal=3000,
  ...
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear valBot(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dpValve_nominal=3000,
...
equation
  ...
  annotation (Diagram(
       ...
       __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Storage/Examples/StratifiedUnloadAtMinimumTemperature.mos"
        "Simulate and plot"),
    experiment(
      StopTime=21600,
      Tolerance=1e-06),
