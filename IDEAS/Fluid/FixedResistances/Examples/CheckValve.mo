...
model CheckValve "Example model for check valve"
  ...
  IDEAS.Fluid.Sources.Boundary_pT sin(
    ...
    annotation (Placement(transformation(
          extent={{50,-10},{30,10}})));
  IDEAS.Fluid.FixedResistances.CheckValve checkValve(
    redeclare package Medium = IDEAS.Media.Water,
    m_flow_nominal=2,
    dpValve_nominal=3600)
    "Check valve"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  IDEAS.Fluid.FixedResistances.CheckValve checkValveDpFix(
  ...
  IDEAS.Fluid.FixedResistances.CheckValve checkValve_m_flow(
    redeclare package Medium = Media.Water,
    m_flow_nominal=2,
    dpValve_nominal=3600)
...
equation
  ...
  annotation (experiment(Tolerance=1e-06, StopTime=1),
      __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/CheckValve.mos"
        "Simulate and plot"),
