...
model PlugFlowPipeDiscretized "Simple example of discretized plug flow pipe"
  ...
  IDEAS.Fluid.FixedResistances.PlugFlowPipeDiscretized pip(
    redeclare package Medium = Medium,
    nSeg=nSeg,
    dh=0.1,
    totLen=100,
...
equation
  ...
  annotation (
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/PlugFlowPipeDiscretized.mos"
        "Simulate and Plot"),
