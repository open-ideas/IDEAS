within IDEAS.Fluid.FixedResistances.BaseClasses.Validation;
model PlugFlowCore "Simple example of plug flow pipe core"
  extends Modelica.Icons.Example;
  replaceable package Medium = IDEAS.Media.Water "Medium in pipes"
                                            annotation (
  ...
  IDEAS.Fluid.FixedResistances.BaseClasses.PlugFlowCore pip(
    redeclare package Medium = Medium,
    from_dp=true,
    dh=0.1,
    length=100,
