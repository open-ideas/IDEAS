...
model FlowJunctionSteadyState
 ...
 package Medium = IDEAS.Media.Air "Medium model";
  ...
  IDEAS.Fluid.Sources.Boundary_pT bou3(
    redeclare package Medium = Medium,
    T=273.15 + 30,
    use_p_in=true,
    nPorts=1)
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/FlowJunctionSteadyState.mos"
        "Simulate and plot"),
