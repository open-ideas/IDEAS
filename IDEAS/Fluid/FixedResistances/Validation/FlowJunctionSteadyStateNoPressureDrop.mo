...
model FlowJunctionSteadyStateNoPressureDrop
 ...
 package Medium = IDEAS.Media.Air "Medium model";
  ...
  IDEAS.Fluid.Sources.MassFlowSource_T bou3(
    redeclare package Medium = Medium,
    T=273.15 + 30,
    nPorts=1,
    use_m_flow_in=true) "Mass flow boundary condition"
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/FlowJunctionSteadyStateNoPressureDrop.mos"
        "Simulate and plot"),
