within IDEAS.Fluid.FixedResistances.Validation;
model PressureDropsParallel
  ...
  IDEAS.Fluid.Sensors.MassFlowRate masFlo3(redeclare package Medium = Medium)
  ...
  IDEAS.Fluid.FixedResistances.HydraulicDiameter noRes(
    redeclare package Medium = Medium,
    m_flow_nominal=5,
    linearized=false,
    from_dp=true,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PressureDropsParallel.mos" "Simulate and plot"),
