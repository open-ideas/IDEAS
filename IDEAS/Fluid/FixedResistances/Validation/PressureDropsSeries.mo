...
model PressureDropsSeries "Test of multiple resistances in series"
 ...
 package Medium = IDEAS.Media.Air "Medium model";
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop[nRes] res(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PressureDropsSeries.mos"
        "Simulate and plot"),
