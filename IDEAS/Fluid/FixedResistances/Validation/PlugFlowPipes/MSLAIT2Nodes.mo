...
model MSLAIT2Nodes
  ...
  IDEAS.Fluid.Sources.Boundary_pT ExcludedBranch(redeclare package Medium = Medium,
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/MSLAIT2Nodes.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>The example contains
<a href=\"modelica://IDEAS.Fluid.FixedResistances.Validation.PlugFlowPipes.Data.PipeDataAIT151218\">
experimental data</a> from a real district heating network.
This data is used to validate this library's
<a href=\"modelica://IDEAS.Fluid.FixedResistances.PlugFlowPipe\">plug flow pipe model</a>
in <a href=\"modelica://IDEAS.Fluid.FixedResistances.Validation.PlugFlowPipes.PlugFlowAIT\">
IDEAS.Fluid.FixedResistances.Validation.PlugFlowPipes.PlugFlowAIT</a>.
</p>
<p>
...
<li>
The model
<a href=\"modelica://IDEAS.Fluid.FixedResistances.Validation.PlugFlowPipes.MSLAIT\">
IDEAS.Fluid.FixedResistances.Validation.PlugFlowPipes.MSLAIT</a>
uses the pipe model from the Modelica Standard Library, with a fine discretization.
See the parameter <code>nNodes</code>.
</li>
<li>
The model
<a href=\"modelica://IDEAS.Fluid.FixedResistances.Validation.PlugFlowPipes.MSLAIT2Nodes\">
IDEAS.Fluid.FixedResistances.Validation.PlugFlowPipes.MSLAIT2Nodes</a>
uses the same model as above, but sets <code>nNodes=2</code>.
</li>
<li>
The model
<a href=\"modelica://IDEAS.Fluid.FixedResistances.Validation.PlugFlowPipes.PlugFlowAIT\">
IDEAS.Fluid.FixedResistances.Validation.PlugFlowPipes.PlugFlowAIT</a>
uses the plug flow model
<a href=\"modelica://IDEAS.Fluid.FixedResistances.PlugFlowPipe\">
IDEAS.Fluid.FixedResistances.PlugFlowPipe</a>.
</li>
</ul>
<p>
...
<p><img alt=\"Schematic of test district heating network\" src=\"modelica://IDEAS/Resources/Images/Fluid/FixedResistances/Validation/PlugFlowPipes/AITTestBench.png\"/> </p>
<h4>Calibration</h4>
<p>
