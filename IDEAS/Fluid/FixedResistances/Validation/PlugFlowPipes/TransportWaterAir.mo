...
model TransportWaterAir
  ...
  package MediumW = IDEAS.Media.Water "Medium in the pipe";
  package MediumA = IDEAS.Media.Air(extraPropertiesNames={"CO2"})
   "Medium in the duct";
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTemOutW(
    redeclare package Medium = MediumW,
    m_flow_nominal=1,
    tau=0,
...
equation
  ...
  connect(Tin.y, sou1.T_in) annotation (Line(points={{-71,30},{-68,30},{-68,-66},
          {-64,-66}}, color={0,0,127}));
  annotation (
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/TransportWaterAir.mos"
        "Simulate and Plot"),
