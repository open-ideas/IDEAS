...
model PlugFlowAIT
  ...
  IDEAS.Fluid.FixedResistances.Junction splPip1(
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.FixedResistances.Junction splPip2(
    redeclare package Medium = Medium,
...
equation
  ...
  annotation (
    experiment(
      ...
      Interval=900,
      Tolerance=1e-006),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/PlugFlowAIT.mos"
        "Simulate and plot"),
...
src=\"modelica://IDEAS/Resources/Images/Fluid/FixedResistances/Validation/PlugFlowPipes/AITTestBench.png\"/>
</p>
<h4>Calibration</h4>
