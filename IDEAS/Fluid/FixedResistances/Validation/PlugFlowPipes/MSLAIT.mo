...
equation
  ...
  annotation (
    ...
    experiment(
      StopTime=603900,
      Tolerance=1e-006),
       __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/MSLAIT.mos"
        "Simulate and plot"),
...
IDEAS.Fluid.FixedResistances.PlugFlowPipe</a> in
