...
model LargeScaleWaterToWater "Large scale water to water chiller"
  extends Modular(
    ...
    redeclare replaceable package MediumEva = IDEAS.Media.Water,
    final GEvaIns=0,
    final GEvaOut=0,
    final CEva=0,
    ...
    redeclare model RefrigerantCycleChillerHeating =
        IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses.NoHeating,
    redeclare model RefrigerantCycleChillerCooling =
        IDEAS.Fluid.Chillers.ModularReversible.RefrigerantCycle.TableData2D (
        redeclare
  ...
  extends IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.LargeScaleWaterToWaterDeclarations(
  ...
  replaceable parameter
    IDEAS.Fluid.Chillers.ModularReversible.Data.TableData2D.Generic
...
<p>
  ...
  IDEAS.Fluid.Chillers.ModularReversible.Modular</a> approach.
</p>
<p>
  Contrary to the standard sizing approach for the <a href=\"modelica://IDEAS.Fluid.Chillers.ModularReversible.Modular\">
  IDEAS.Fluid.Chillers.ModularReversible.Modular</a> models,
  the parameters are based on an automatic estimation as described in
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.LargeScaleWaterToWaterDeclarations\">
  IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.LargeScaleWaterToWaterDeclarations</a>.
</p>
<p>
