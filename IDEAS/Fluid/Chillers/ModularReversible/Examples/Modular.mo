...
model Modular
  ...
  package MediumCon = IDEAS.Media.Air "Medium model for condenser";
  package MediumEva = IDEAS.Media.Water "Medium model for evaporator";

  IDEAS.Fluid.Chillers.ModularReversible.Modular chi(
    ...
    redeclare model RefrigerantCycleChillerHeating =
        IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.TableData2D (
          redeclare
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Chillers/ModularReversible/Examples/Modular.mos"
        "Simulate and plot"),
...
<p>
  ...
  IDEAS.Fluid.Chillers.ModularReversible.Modular</a>.
</p>
</html>"));
end Modular;
