within IDEAS.Fluid.Chillers.ModularReversible.Examples;
model LargeScaleWaterToWater
  "Example for large scale water to water chiller"
  extends Modelica.Icons.Example;
  package MediumCon = IDEAS.Media.Water "Medium model for condenser";
  package MediumEva = IDEAS.Media.Water "Medium model for evaporator";

  IDEAS.Fluid.Chillers.ModularReversible.LargeScaleWaterToWater chi(
    redeclare
  ...
  IDEAS.Fluid.Sources.MassFlowSource_T souCon(
    nPorts=1,
  ...
  IDEAS.Fluid.Sources.MassFlowSource_T souEva(
    nPorts=1,
  ...
  IDEAS.Fluid.Sources.Boundary_pT sinCon(nPorts=1, redeclare package Medium =
        MediumCon) "Condenser sink" annotation (Placement(transformation(extent={{
            10,-10},{-10,10}}, origin={70,40})));
  IDEAS.Fluid.Sources.Boundary_pT sinEva(nPorts=1, redeclare package Medium =
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Chillers/ModularReversible/Examples/LargeScaleWaterToWater.mos"
        "Simulate and plot"),
