...
model Carnot_y "Example using the Carnot model approach"
  extends IDEAS.Fluid.HeatPumps.ModularReversible.Validation.Comparative.BaseClasses.PartialComparison(
  ...
  IDEAS.Fluid.Chillers.Carnot_y chi(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Chillers/ModularReversible/Validation/Carnot_y.mos"
        "Simulate and plot"),
...
<p>
Validation case for <a href=\"modelica://IDEAS.Fluid.Chillers.Carnot_y\">
IDEAS.Fluid.Chillers.Carnot_y</a>, duplicate of the example
<a href=\"modelica://IDEAS.Fluid.Chillers.Examples.Carnot_y\">
IDEAS.Fluid.Chillers.Examples.Carnot_y</a>.
</p>
</html>"));
end Carnot_y;
