within IDEAS.Fluid.Chillers.ModularReversible.RefrigerantCycle;
model TableData2D
  ...
  replaceable parameter IDEAS.Fluid.Chillers.ModularReversible.Data.TableData2D.Generic datTab
