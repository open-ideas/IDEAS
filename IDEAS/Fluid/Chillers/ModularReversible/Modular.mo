...
model Modular
  ...
  extends
    IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.PartialReversibleRefrigerantMachine(
    ...
    safCtr(redeclare
        IDEAS.Fluid.Chillers.ModularReversible.Controls.Safety.OperationalEnvelope
        opeEnv),
    ...
    use_rev=false,
    redeclare final IDEAS.Fluid.Chillers.ModularReversible.BaseClasses.RefrigerantCycle refCyc(
  ...
  replaceable model RefrigerantCycleChillerCooling =
      IDEAS.Fluid.Chillers.ModularReversible.RefrigerantCycle.BaseClasses.PartialChillerCycle
      (PEle_nominal=0)
    constrainedby
    IDEAS.Fluid.Chillers.ModularReversible.RefrigerantCycle.BaseClasses.PartialChillerCycle(
       final useInChi=true,
  ...
  replaceable model RefrigerantCycleChillerHeating =
      ...
      (PEle_nominal=PEle_nominal)
       constrainedby
    IDEAS.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.BaseClasses.PartialHeatPumpCycle(
...
<p>
  ...
  <a href=\"modelica://IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.PartialReversibleRefrigerantMachine\">
  IDEAS.Fluid.HeatPumps.ModularReversible.BaseClasses.PartialReversibleRefrigerantMachine</a>),
