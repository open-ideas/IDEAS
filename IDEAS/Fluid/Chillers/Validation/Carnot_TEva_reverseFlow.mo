within IDEAS.Fluid.Chillers.Validation;
model Carnot_TEva_reverseFlow
 ...
 package Medium2 = IDEAS.Media.Water "Medium model";
  ...
  IDEAS.Fluid.Chillers.Carnot_TEva chi(
  ...
  IDEAS.Fluid.Sources.MassFlowSource_T sou1(nPorts=1,
  ...
  IDEAS.Fluid.Sources.MassFlowSource_T sou2(nPorts=1,
  ...
  IDEAS.Fluid.Sources.Boundary_pT sin1(
    ...
    annotation (Placement(
        ...
        extent={{10,-10},{-10,10}},
        origin={80,30})));
  IDEAS.Fluid.Sources.Boundary_pT sin2(nPorts=1,
    redeclare package Medium = Medium2)
    annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTEvaLvg(
    redeclare final package Medium = Medium2,
    final m_flow_nominal=m2_flow_nominal,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Chillers/Validation/Carnot_TEva_reverseFlow.mos"
        "Simulate and plot"),
    Documentation(
info="<html>
<p>
