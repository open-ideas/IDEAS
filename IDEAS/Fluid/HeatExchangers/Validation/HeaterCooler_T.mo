...
model HeaterCooler_T
  ...
  IDEAS.Fluid.HeatExchangers.HeaterCooler_T heaHigPow(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000,
    Q_flow_maxHeat=1e4) "Steady-state model of the heater with high capacity"
    annotation (Placement(transformation(extent={{40,110},{60,130}})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort heaHigPowOut(redeclare package Medium
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort cooLimPowOut(redeclare package Medium
      =        Medium, m_flow_nominal=m_flow_nominal) "Temperature sensor"
    annotation (Placement(transformation(extent={{80,24},{100,44}})));
  IDEAS.Fluid.HeatExchangers.HeaterCooler_T cooLimPow(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000,
    Q_flow_maxCool=-1000)
  ...
  IDEAS.Fluid.HeatExchangers.HeaterCooler_T heaCooUnl(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000)
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort heaCooUnlOut(redeclare package Medium
      =        Medium, m_flow_nominal=m_flow_nominal) "Temperature sensor"
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort heaHigPowIn(redeclare package Medium
      = Medium, m_flow_nominal=m_flow_nominal) "Temperature sensor"
    annotation (Placement(transformation(extent={{-8,110},{12,130}})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort cooLimPowIn(redeclare package Medium
      = Medium, m_flow_nominal=m_flow_nominal) "Temperature sensor"
    annotation (Placement(transformation(extent={{-6,24},{14,44}})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort heaCooUnlIn(redeclare package Medium
      = Medium, m_flow_nominal=m_flow_nominal) "Temperature sensor"
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,
    ...
    __Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/HeaterCooler_T.mos"
        "Simulate and plot"),
