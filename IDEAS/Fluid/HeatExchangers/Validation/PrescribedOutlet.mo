...
model PrescribedOutlet
  ...
  IDEAS.Fluid.HeatExchangers.PrescribedOutlet heaHigPow(
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort heaHigPowOut(
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort cooLimPowOut(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal) "Temperature sensor"
    annotation (Placement(transformation(extent={{80,24},{100,44}})));
  IDEAS.Fluid.HeatExchangers.PrescribedOutlet cooLimPow(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000,
    QMin_flow=-1000,
  ...
  IDEAS.Fluid.HeatExchangers.PrescribedOutlet heaCooUnl(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000,
    use_X_wSet=false)
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort heaCooUnlOut(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal) "Temperature sensor"
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort heaHigPowIn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal) "Temperature sensor"
    annotation (Placement(transformation(extent={{-8,110},{12,130}})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort cooLimPowIn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal) "Temperature sensor"
    annotation (Placement(transformation(extent={{-6,24},{14,44}})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort heaCooUnlIn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal) "Temperature sensor"
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,
    ...
    __Dymola_Commands(file= "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/PrescribedOutlet.mos"
        "Simulate and plot"),
