 ...
 package Medium2 = IDEAS.Media.Air;
  ...
  IDEAS.Fluid.Sources.Boundary_pT sou_1(
    ...
    "Boundary condition" annotation (Placement(transformation(extent={{-62,40},
            {-42,60}})));
  IDEAS.Fluid.HeatExchangers.DryCoilEffectivenessNTU hexPar(
    ...
    configuration=IDEAS.Fluid.Types.HeatExchangerConfiguration.ParallelFlow,
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15)
    "Heat exchanger"
  ...
  IDEAS.Fluid.HeatExchangers.DryCoilEffectivenessNTU hexCou(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=500,
    dp2_nominal=10,
  ...
  IDEAS.Fluid.HeatExchangers.DryCoilEffectivenessNTU hexCroC1Mix(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=500,
    dp2_nominal=10,
    ...
    m2_flow_nominal=m2_flow,
    Q_flow_nominal=m2_flow*cp2*(24 - 20),
    configuration=IDEAS.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1MixedStream2Unmixed,
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15)
    "Heat exchanger"
    annotation (Placement(transformation(extent={{-10,-28},{10,-8}})));
  IDEAS.Fluid.HeatExchangers.DryCoilEffectivenessNTU hexCroC1Unm(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=500,
    dp2_nominal=10,
  ...
  IDEAS.Fluid.HeatExchangers.DryCoilEffectivenessNTU hexCroUnm(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=500,
    dp2_nominal=10,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/DryCoilEffectivenessNTU.mos"
        "Simulate and plot"),
