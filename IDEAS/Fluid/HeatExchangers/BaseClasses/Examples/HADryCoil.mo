within IDEAS.Fluid.HeatExchangers.BaseClasses.Examples;
model HADryCoil "Test model for dry coil convection coefficient"
  extends Modelica.Icons.Example;
  IDEAS.Fluid.HeatExchangers.BaseClasses.HADryCoil  hADryCoi(
  ...
  IDEAS.Fluid.HeatExchangers.BaseClasses.HADryCoil hADryCoiAir(
    m_flow_nominal_w=0.1,
    UA_nominal=10000,
  ...
  IDEAS.Fluid.HeatExchangers.BaseClasses.HADryCoil hADryCoiWat(
    m_flow_nominal_w=0.1,
    UA_nominal=10000,
    m_flow_nominal_a=2.5,
...
equation
  ...
  annotation ( __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/BaseClasses/Examples/HADryCoil.mos"
        "Simulate and plot"),
  experiment(StopTime=80.0,
             Tolerance=1E-6),
  Documentation(info="<html>
<p>
Test model for <a href=\"modelica://IDEAS.Fluid.HeatExchangers.BaseClasses.HADryCoil\">
IDEAS.Fluid.HeatExchangers.BaseClasses.HADryCoil</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
