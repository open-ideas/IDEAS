...
model HACoilInside "Test model for HACoilInside"
  ...
  IDEAS.Fluid.HeatExchangers.BaseClasses.HACoilInside hASin(
...
equation
  ...
  annotation ( __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/BaseClasses/Examples/HACoilInside.mos"
        "Simulate and plot"),
        experiment(Tolerance=1e-6, StopTime=15),
        Documentation(info="<html>
        <p>
        Test model for <a href=\"modelica://IDEAS.Fluid.HeatExchangers.BaseClasses.HACoilInside\">
        IDEAS.Fluid.HeatExchanger.BaseClassess.HACoilInside</a>.
        </p>
        </html>", revisions="<html>
<ul>
<li>
