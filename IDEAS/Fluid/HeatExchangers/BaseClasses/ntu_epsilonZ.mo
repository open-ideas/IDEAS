...
algorithm
  if (flowRegime == Integer(IDEAS.Fluid.Types.HeatExchangerFlowRegime.ParallelFlow)) then // parallel flow
    a := Z+1;
    assert(eps < 1/a,
  ...
  elseif (flowRegime == Integer(IDEAS.Fluid.Types.HeatExchangerFlowRegime.CounterFlow)) then// counter flow
  ...
  elseif (flowRegime == Integer(IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowUnmixed)) then
    a := 0;
    ...
    NTU :=Modelica.Math.Nonlinear.solveOneNonlinearEquation(
      ...
      u_min=1.5*1e-10,
      u_max=1e6);
  elseif (flowRegime == Integer(IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinUnmixedCMaxMixed)) then
  ...
  elseif (flowRegime == Integer(IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinMixedCMaxUnmixed)) then
  ...
  elseif (flowRegime == Integer(IDEAS.Fluid.Types.HeatExchangerFlowRegime.ConstantTemperaturePhaseChange)) then
    ...
    a := 0;
    NTU := 0;
    assert(Integer(IDEAS.Fluid.Types.HeatExchangerFlowRegime.ParallelFlow) <= flowRegime and
           flowRegime <= Integer(IDEAS.Fluid.Types.HeatExchangerFlowRegime.ConstantTemperaturePhaseChange),
