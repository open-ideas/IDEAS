...
model PartialEffectivenessNTU
  ...
  parameter IDEAS.Fluid.Types.HeatExchangerConfiguration configuration "Heat exchanger configuration"
...
initial equation
  ...
  if (configuration == IDEAS.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1MixedStream2Unmixed) then
    flowRegime_nominal = if (C1_flow_nominal < C2_flow_nominal) then IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinMixedCMaxUnmixed
       else IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinUnmixedCMaxMixed;
  elseif (configuration == IDEAS.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1UnmixedStream2Mixed) then
    flowRegime_nominal = if (C1_flow_nominal < C2_flow_nominal) then IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinUnmixedCMaxMixed
       else IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinMixedCMaxUnmixed;
  ...
  elseif (configuration == IDEAS.Fluid.Types.HeatExchangerConfiguration.CrossFlowUnmixed) then
    ...
    flowRegime_nominal = IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowUnmixed;
    assert(configuration >= IDEAS.Fluid.Types.HeatExchangerConfiguration.ParallelFlow and configuration <= IDEAS.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1UnmixedStream2Mixed,
...
equation
  ...
  if use_dynamicFlowRegime then
    if (configuration == IDEAS.Fluid.Types.HeatExchangerConfiguration.ParallelFlow) then
      flowRegime = if (C1_flow*C2_flow >= 0) then IDEAS.Fluid.Types.HeatExchangerFlowRegime.ParallelFlow else IDEAS.Fluid.Types.HeatExchangerFlowRegime.CounterFlow;
    elseif (configuration == IDEAS.Fluid.Types.HeatExchangerConfiguration.CounterFlow) then
      flowRegime = if (C1_flow*C2_flow >= 0) then IDEAS.Fluid.Types.HeatExchangerFlowRegime.CounterFlow else IDEAS.Fluid.Types.HeatExchangerFlowRegime.ParallelFlow;
    elseif (configuration == IDEAS.Fluid.Types.HeatExchangerConfiguration.CrossFlowUnmixed) then
    ...
    elseif (configuration == IDEAS.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1MixedStream2Unmixed) then
      flowRegime = if (C1_flow < C2_flow) then IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinMixedCMaxUnmixed
         else IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinUnmixedCMaxMixed;
    else
      // have ( configuration == IDEAS.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1UnmixedStream2Mixed)
      flowRegime = if (C1_flow < C2_flow) then IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinUnmixedCMaxMixed
         else IDEAS.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinMixedCMaxUnmixed;
    end if;
  else
...
defined in
<a href=\"modelica://IDEAS.Fluid.Types.HeatExchangerConfiguration\">
IDEAS.Fluid.Types.HeatExchangerConfiguration</a>
are supported.
</p>
<p>
