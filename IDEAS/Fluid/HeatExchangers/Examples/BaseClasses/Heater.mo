...
partial model Heater "Base class for example model for the heater and cooler"
  ...
  IDEAS.Fluid.Movers.FlowControlled_m_flow mov(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
...
<a href=\"modelica://IDEAS.Fluid.HeatExchangers.Examples.AirHeater_T\">
IDEAS.Fluid.HeatExchangers.Examples.AirHeater_T</a>
and
<a href=\"modelica://IDEAS.Fluid.HeatExchangers.Examples.AirHeater_u\">
IDEAS.Fluid.HeatExchangers.Examples.AirHeater_u</a> and
the similar models
<a href=\"modelica://IDEAS.Fluid.HeatExchangers.Examples.WaterHeater_T\">
IDEAS.Fluid.HeatExchangers.Examples.WaterHeater_T</a>
and
<a href=\"modelica://IDEAS.Fluid.HeatExchangers.Examples.WaterHeater_u\">
IDEAS.Fluid.HeatExchangers.Examples.WaterHeater_u</a>.
