...
model DryCoilEffectivenessNTUMassFlow
  ...
  extends
    IDEAS.Fluid.HeatExchangers.Examples.BaseClasses.EffectivenessNTUMassFlow(
    sou_1(nPorts=1),
    sin_1(nPorts=1),
    sou_2(nPorts=1),
    sin_2(nPorts=1));
  ...
  IDEAS.Fluid.Sensors.RelativeHumidityTwoPort senRelHum(
...
__Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/DryCoilEffectivenessNTUMassFlow.mos"
        "Simulate and plot"),
