...
model DryCoilEffectivenessNTUPControl
 ...
 package Medium1 = IDEAS.Media.Water "Medium model for water";
 package Medium2 = IDEAS.Media.Air "Medium model for air";
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort temSen(
    redeclare package Medium = Medium2,
  ...
  IDEAS.Controls.Continuous.LimPID P(
    Ti=30,
    k=0.1,
    Td=1)
    "Controller"
...
__Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/DryCoilEffectivenessNTUPControl.mos"
        "Simulate and plot"),
