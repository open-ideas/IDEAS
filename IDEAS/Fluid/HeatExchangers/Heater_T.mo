...
model Heater_T "Heater with prescribed outlet temperature"
  extends IDEAS.Fluid.HeatExchangers.BaseClasses.PartialPrescribedOutlet(
    outCon(
      final QMin_flow = 0,
...
<a href=\"modelica://IDEAS.Fluid.HeatExchangers.SensibleCooler_T\">
IDEAS.Fluid.HeatExchangers.SensibleCooler_T</a>.
...
IDEAS.Fluid.HeatExchangers.HeaterCooler_u</a>
...
the examples
<a href=\"modelica://IDEAS.Fluid.HeatExchangers.Validation.PrescribedOutlet\">
IDEAS.Fluid.HeatExchangers.Validation.PrescribedOutlet</a>
and
<a href=\"modelica://IDEAS.Fluid.HeatExchangers.Validation.PrescribedOutlet_dynamic\">
IDEAS.Fluid.HeatExchangers.Validation.PrescribedOutlet_dynamic</a>.
</p>
</html>",
revisions="<html>
<ul>
