...
model Convector
  ...
  IDEAS.Fluid.HeatExchangers.ActiveBeams.BaseClasses.Convector con(
    redeclare package Medium = Medium,
    nBeams=1,
...
equation
  ...
  annotation (experiment(Tolerance=1e-6, StopTime=10),__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/BaseClasses/Examples/Convector.mos"
        "Simulate and plot"),
