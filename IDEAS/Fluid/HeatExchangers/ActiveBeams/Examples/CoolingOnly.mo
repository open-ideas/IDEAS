...
model CoolingOnly
  ...
  IDEAS.Fluid.HeatExchangers.ActiveBeams.Cooling beaCoo(
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            ...
            __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Examples/CoolingOnly.mos"
        "Simulate and plot"),
