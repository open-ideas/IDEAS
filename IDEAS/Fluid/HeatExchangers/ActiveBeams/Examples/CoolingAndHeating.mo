within IDEAS.Fluid.HeatExchangers.ActiveBeams.Examples;
model CoolingAndHeating
  ...
  IDEAS.Controls.Continuous.LimPID conHea(
    yMax=0.094,
    Td=0,
    Ti=100,
    k=0.1)
  ...
  IDEAS.Controls.Continuous.LimPID conCoo(
    yMax=0.094,
    reverseActing=false,
    Td=0,
    k=0.5,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            -120},{120,120}})),experiment(Tolerance=1e-6, StopTime=172800),__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Examples/CoolingAndHeating.mos"
        "Simulate and plot"),
