...
model ResistanceVolumeFlowReversal
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTem[nRes.k](
...
equation
  ...
  annotation (experiment(
      Tolerance=1e-6, StopTime=10000),
       __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Examples/ResistanceVolumeFlowReversal.mos"
        "Simulate and plot"),
