...
model Basic "Example implementation of flow system"
  ...
  IDEAS.Fluid.Movers.FlowControlled_dp pmpSouth(
    redeclare package Medium = Medium,
    redeclare replaceable
      IDEAS.Fluid.Movers.Data.Pumps.Wilo.Stratos80slash1to12 per,
    dp_nominal=12*9810,
    ...
    "Pump to south of building" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-60,-20})));
  IDEAS.Fluid.FixedResistances.PressureDrop pipSouth1(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-80,18})));
  IDEAS.Fluid.FixedResistances.PressureDrop pipSouth2(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    m_flow_nominal=3) "Pipe 2 to south of building" annotation (Placement(
        ...
        rotation=90,
        origin={-40,18})));
  IDEAS.Fluid.Movers.FlowControlled_dp pmpNorth(
    redeclare package Medium = Medium,
    redeclare replaceable
      IDEAS.Fluid.Movers.Data.Pumps.Wilo.Stratos80slash1to12 per,
    dp_nominal=12*9810,
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
     "Pump to north of building" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={60,-20})));
  IDEAS.Fluid.FixedResistances.PressureDrop pipNorth2(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    m_flow_nominal=5) "Pipe 2 to north of building" annotation (Placement(
        ...
        rotation=90,
        origin={80,18})));
  IDEAS.Fluid.FixedResistances.PressureDrop pipNorth1(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={40,18})));
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear[4] valSouth1(
    each dpFixed_nominal=0,
    each CvData=IDEAS.Fluid.Types.CvTypes.OpPoint,
    ...
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-80,60})));
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear[8] valSouth2(
    each dpFixed_nominal=0,
    each CvData=IDEAS.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
    ...
    annotation (Placement(transformation(extent={{10,10},{-10,-10}},
        rotation=270,
        origin={-40,60})));
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear[4] valNorth1(
    each dpFixed_nominal=0,
    each CvData=IDEAS.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
    ...
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={40,60})));
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear[8] valNorth2(
    each dpFixed_nominal=0,
    each CvData=IDEAS.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
  ...
  IDEAS.Fluid.Actuators.Valves.ThreeWayLinear valSouth(
    redeclare package Medium = Medium,
    m_flow_nominal=5,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-60,-50})));
  IDEAS.Fluid.Actuators.Valves.ThreeWayLinear valNorth(
    redeclare package Medium = Medium,
    m_flow_nominal=5,
    dpFixed_nominal={20000,0},
    from_dp=true,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={60,-50})));
  IDEAS.Fluid.HeatExchangers.PrescribedOutlet heater(
    m_flow_nominal=10,
    dp_nominal=100,
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.Movers.FlowControlled_m_flow pumpHea(
    m_flow_nominal=10,
    redeclare IDEAS.Fluid.Movers.Data.Pumps.Wilo.VeroLine80slash115dash2comma2slash2 per,
    redeclare package Medium = Medium,
    inputType=IDEAS.Fluid.Types.InputType.Stages,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
  ...
  IDEAS.Fluid.FixedResistances.Junction spl3(
    ...
    "Splitter"
    annotation (Placement(transformation(extent={{20,-120},{40,-140}})));
  IDEAS.Fluid.Movers.FlowControlled_m_flow pumpCoo(
    m_flow_nominal=10,
    redeclare IDEAS.Fluid.Movers.Data.Pumps.Wilo.VeroLine80slash115dash2comma2slash2 per,
    redeclare package Medium = Medium,
    inputType=IDEAS.Fluid.Types.InputType.Stages,
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop tabsSouth1[4](
    redeclare each package Medium = Medium,
    ...
    "Pressure drop of southern tabs sections on collector 1" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-80,90})));
  IDEAS.Fluid.FixedResistances.PressureDrop tabsSouth2[8](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
    ...
    "Pressure drop of southern tabs sections on collector 2" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-40,90})));
  IDEAS.Fluid.FixedResistances.PressureDrop tabsNorth1[4](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
    ...
    "Pressure drop of northern tabs sections on collector 1" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={40,90})));
  IDEAS.Fluid.FixedResistances.PressureDrop tabsNorth2[8](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
...
<a href=\"modelica://IDEAS.Fluid.Examples.FlowSystem.Simplified1\">
IDEAS.Fluid.Examples.FlowSystem.Simplified1</a>,
<a href=\"modelica://IDEAS.Fluid.Examples.FlowSystem.Simplified2\">
IDEAS.Fluid.Examples.FlowSystem.Simplified2</a>,
<a href=\"modelica://IDEAS.Fluid.Examples.FlowSystem.Simplified3\">
IDEAS.Fluid.Examples.FlowSystem.Simplified3</a>.
...
First implementation.
    ...
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Examples/FlowSystem/Basic.mos"
        "Simulate and plot"));
end Basic;
