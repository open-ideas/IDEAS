within IDEAS.Fluid.Examples.Performance;
model Example1v1 "Example 1 model without mixing volume"
  extends IDEAS.Fluid.Examples.Performance.BaseClasses.Example1(
...
simulateModel(\"IDEAS.Fluid.Examples.Performance.Example1v1(allowFlowReversal.k=true, from_dp.k=false)\", stopTime=10000, numberOfIntervals=10, method=\"dassl\", resultFile=\"Example1v1\");<br/>
simulateModel(\"IDEAS.Fluid.Examples.Performance.Example1v2(from_dp.k=true, allowFlowReversal.k=true)\", stopTime=10000, numberOfIntervals=10, method=\"dassl\", resultFile=\"Example1v2\");<br/>
simulateModel(\"IDEAS.Fluid.Examples.Performance.Example1v1(allowFlowReversal.k=false, from_dp.k=false)\", stopTime=10000, numberOfIntervals=10, method=\"dassl\", resultFile=\"Example1v1\");<br/>
simulateModel(\"IDEAS.Fluid.Examples.Performance.Example1v1(allowFlowReversal.k=false, from_dp.k=true)\", stopTime=10000, numberOfIntervals=10, method=\"dassl\", resultFile=\"Example1v1\");<br/>
...
First implementation.
    ...
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Examples/Performance/Example1v1.mos"
        "Simulate and plot"));
end Example1v1;
