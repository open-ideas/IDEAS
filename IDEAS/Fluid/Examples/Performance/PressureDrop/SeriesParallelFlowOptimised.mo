...
</html>"), experiment(Tolerance=1e-6, StopTime=1), __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Examples/Performance/PressureDrop/SeriesParallelFlowOptimised.mos"
        "Simulate and plot"));
