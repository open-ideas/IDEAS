...
model Example4 "Example 4 model of simple condensing heat exchanger"
  ...
  IDEAS.Utilities.Psychrometrics.X_pTphi xSat(use_p_in=false)
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Examples/Performance/Example4.mos"
        "Simulate and plot"));
end Example4;
