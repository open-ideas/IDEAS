...
<tr>
  <td>
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers\">
  IDEAS.Fluid.FMI.ExportContainers</a>
  </td>
  <td>
  <p>
  ...
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.ReplaceableTwoPort\">
  IDEAS.Fluid.FMI.ExportContainers.ReplaceableTwoPort</a>
  ...
  See
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.Fan\">
  IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.Fan</a>
  and
  ...
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.HVACZone\">
  IDEAS.Fluid.FMI.ExportContainers.HVACZone</a>
  and add the HVAC system.<br/>
  See
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZone\">
  IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZone</a>.
  </p>
  <p>
  To export an HVAC system that serves multiple thermal zones, extend from
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.HVACZones\">
  IDEAS.Fluid.FMI.ExportContainers.HVACZones</a>
  and add the HVAC system.<br/>
  See
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZones\">
  IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZones</a>.
  </p>
  <p>
  To export a single thermal zone, extend from
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.ThermalZone\">
  IDEAS.Fluid.FMI.ExportContainers.ThermalZone</a>
  and add the thermal zone.<br/>
  See
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZone\">
  IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZone</a>.
  </p>
  <p>
  To export multiple thermal zones, extend from
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.ThermalZones\">
  IDEAS.Fluid.FMI.ExportContainers.ThermalZones</a>
  and add the thermal zone models.<br/>
  See
  <a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZones\">
  IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.ThermalZones</a>.
  </p>
  </td>
</tr>
<tr>
  <td>
  <a href=\"modelica://IDEAS.Fluid.FMI.Adaptors\">
  IDEAS.Fluid.FMI.Adaptors</a>
  </td>
  <td>
  <p>
...
<td>
  <p>
  <a href=\"modelica://IDEAS.Fluid.FMI.Conversion\">
  IDEAS.Fluid.FMI.Conversion</a>
  </p>
</td>
<td>
  <p>
  Package with blocks that convert between the signal connectors of
  <a href=\"modelica://IDEAS.Fluid.FMI.Interfaces\">
  IDEAS.Fluid.FMI.Interfaces</a>
...
<p>
The package
<a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs\">
IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs</a>
...
<p>
In the
<a href=\"modelica://IDEAS.Fluid\">IDEAS.Fluid</a> package,
...
<a href=\"modelica://IDEAS.Fluid.FMI\">IDEAS.Fluid.FMI</a> package.
...
flow rate, such as
<a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.IdealSource_m_flow\">
IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.IdealSource_m_flow</a>.
</p>
<h4>Notes</h4>
<p>
...
<p>
For <a href=\"modelica://IDEAS.Media.Water\">
IDEAS.Media.Water</a>, this setting is not needed
...
<a href=\"modelica://IDEAS.Fluid.FMI.Interfaces.Inlet\">
IDEAS.Fluid.FMI.Interfaces.Inlet</a>
...
do so by using
<a href=\"modelica://IDEAS.Fluid.FMI.Source_T\">
IDEAS.Fluid.FMI.Source_T</a>,
...
<a href=\"modelica://IDEAS/Resources/Images/Fluid/FMI/UsersGuide/2015-WetterFuchsNouidui.pdf\">
