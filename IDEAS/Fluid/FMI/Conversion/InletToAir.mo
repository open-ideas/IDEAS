...
block InletToAir
  "Conversion from real signals for a fluid to a IDEAS.Fluid.FMI.Interfaces.Inlet connector"
  ...
  IDEAS.Fluid.FMI.Interfaces.Inlet inlet(
...
IDEAS.Fluid.FMI.Interfaces.Inlet
</a>
and converts
