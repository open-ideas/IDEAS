...
model ThermalZoneHVACNoExhaust
  ...
  IDEAS.Fluid.FMI.Adaptors.HVAC hvacAda(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FMI/Adaptors/Examples/ThermalZoneHVACNoExhaust.mos"
        "Simulate and plot"),
