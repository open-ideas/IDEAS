within IDEAS.Fluid.FMI.Adaptors;
model HVAC
  ...
  // otherwise, in IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.HVACZones
...
protected
  ...
  IDEAS.Fluid.FMI.Conversion.AirToOutlet con[nPorts](
      redeclare each final package Medium = Medium,
      each final allowFlowReversal=true)
  ...
  IDEAS.Fluid.FMI.BaseClasses.X_w_toX x_w_toX(
    redeclare final package Medium = Medium)
    ...
    Icon(coordinateSystem(
        ...
        Polygon(
          ...
          fillPattern=FillPattern.Solid),
            ...
            "modelica://IDEAS/Resources/Images/Fluid/FMI/FMI_icon.png"),
            Bitmap(extent={{-96,52},{-24,108}},fileName=
            "modelica://IDEAS/Resources/Images/Fluid/FMI/modelica_icon.png")}),
