...
model ThermalZones
  ...
  extends IDEAS.Fluid.FMI.ExportContainers.ThermalZones(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/ThermalZones.mos"
        "Export FMU"));
end ThermalZones;
