...
model ThermalZone
  ...
  extends IDEAS.Fluid.FMI.ExportContainers.ThermalZone(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/ThermalZone.mos"
        "Export FMU"));
end ThermalZone;
