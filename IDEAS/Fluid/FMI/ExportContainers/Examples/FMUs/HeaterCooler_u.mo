...
block HeaterCooler_u
  "Declaration of an FMU that exports an ideal heater or cooler with prescribed heat flow rate"
   extends IDEAS.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final IDEAS.Fluid.HeatExchangers.HeaterCooler_u com(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/HeaterCooler_u.mos"
        "Export FMU"),
    Icon(graphics={
        Polygon(
