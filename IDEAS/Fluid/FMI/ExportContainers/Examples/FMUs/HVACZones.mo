...
block HVACZones
  ...
  extends IDEAS.Fluid.FMI.ExportContainers.HVACZones(
    redeclare final package Medium = MediumA,
    nZon = 2,
    nPorts = 3);

  replaceable package MediumA = IDEAS.Media.Air "Medium for air";
  replaceable package MediumW = IDEAS.Media.Water "Medium for water";
 ...
 // parameter Modelica.Units.SI.Volume V=6*10*3 "Room volume";
  ...
  replaceable IDEAS.Fluid.HeatExchangers.ConstantEffectiveness cooCoi(
    dp1_nominal=6000,
    dp2_nominal=200,
    show_T=true,
    allowFlowReversal1=allowFlowReversal,
    allowFlowReversal2=allowFlowReversal) constrainedby
    IDEAS.Fluid.Interfaces.PartialFourPortInterface(
  ...
  IDEAS.Fluid.Sources.Boundary_pT sinWat(
  ...
  BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    TDryBulSou=IDEAS.BoundaryConditions.Types.DataSource.File,
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop resSup1(
    redeclare package Medium = MediumA,
    linearized=true,
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop resSup2(
    redeclare package Medium = MediumA,
    linearized=true,
    m_flow_nominal=0.5*mA_flow_nominal,
    dp_nominal=10) "Fixed resistance for supply air inlet"
    annotation (Placement(transformation(extent={{70,76},{90,96}})));
  IDEAS.Fluid.FixedResistances.PressureDrop resRet1(
    redeclare package Medium = MediumA,
    dp_nominal=200,
    linearized=true,
    m_flow_nominal=0.5*mA_flow_nominal) "Fixed resistance for return air duct"
    annotation (Placement(transformation(extent={{40,50},{20,70}})));
  IDEAS.Fluid.FixedResistances.PressureDrop resRet2(
    redeclare package Medium = MediumA,
    dp_nominal=200,
    linearized=true,
    m_flow_nominal=0.5*mA_flow_nominal) "Fixed resistance for return air duct"
...
IDEAS.Fluid.FMI.ExportContainers.HVACZones
</a>
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/HVACZones.mos"
        "Export FMU"));
end HVACZones;
