...
block Humidifier_u
  "Declaration of an FMU that exports an ideal humidifier"
   extends IDEAS.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final IDEAS.Fluid.Humidifiers.Humidifier_u com(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/Humidifier_u.mos"
        "Export FMU"),
    Icon(graphics={
        Polygon(
