within IDEAS.Fluid.FMI.ExportContainers;
block ReplaceableTwoPort
  "Container to export thermofluid flow models with two ports as an FMU"
  extends IDEAS.Fluid.FMI.ExportContainers.PartialTwoPort;
  replaceable IDEAS.Fluid.Interfaces.PartialTwoPort com
    constrainedby IDEAS.Fluid.Interfaces.PartialTwoPort(
...
protected
  IDEAS.Fluid.FMI.Adaptors.Inlet bouIn(
    redeclare final package Medium=Medium,
    final allowFlowReversal=allowFlowReversal,
    final use_p_in=use_p_in) "Boundary model for inlet"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));

  IDEAS.Fluid.FMI.Adaptors.Outlet bouOut(
    redeclare final package Medium=Medium,
    final allowFlowReversal=allowFlowReversal,
...
<p>
See for example
<a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.PressureDrop\">
IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.PressureDrop</a>
or
<a href=\"modelica://IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.HeaterCooler_u\">
IDEAS.Fluid.FMI.ExportContainers.Examples.FMUs.HeaterCooler_u</a>
