...
model WetFluid
  ...
  extends
    IDEAS.Fluid.CHPs.OrganicRankine.BaseClasses.Validation.DryFluid(
      TEva = 350,
      redeclare parameter
        IDEAS.Fluid.CHPs.OrganicRankine.Data.WorkingFluids.R134a pro);
annotation (experiment(StopTime=1, Tolerance=1e-6),
  __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/CHPs/OrganicRankine/BaseClasses/Validation/WetFluid.mos"
  "Simulate and plot"),
  Documentation(info="<html>
<p>
This model is largely the same as
<a href=\"Modelica://IDEAS.Fluid.CHPs.OrganicRankine.BaseClasses.Validation.DryFluid\">
IDEAS.Fluid.CHPs.OrganicRankine.BaseClasses.Validation.DryFluid</a>,
