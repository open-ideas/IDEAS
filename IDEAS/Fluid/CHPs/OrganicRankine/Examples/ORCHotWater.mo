within IDEAS.Fluid.CHPs.OrganicRankine.Examples;
model ORCHotWater "ORC that outputs hot water at a fixed temperature"
  extends Modelica.Icons.Example;

  package MediumHot = IDEAS.Media.Air "Evaporator hot fluid";
  package MediumCol = IDEAS.Media.Water "Condenser cold fluid";
  ...
  IDEAS.Fluid.CHPs.OrganicRankine.ConstantEvaporation orc(
    redeclare final package Medium1 = MediumHot,
    redeclare final package Medium2 = MediumCol,
    T2_start=TCol_start,
    redeclare IDEAS.Fluid.CHPs.OrganicRankine.Data.WorkingFluids.R123 pro,
  ...
  IDEAS.Fluid.Sources.Boundary_pT colBou(
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTWatSup(
    redeclare final package Medium = MediumCol,
    ...
    "Water supply temperature" annotation (Placement(transformation(
        ...
        rotation=0,
        origin={70,-80})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTWatRet(
    redeclare final package Medium = MediumCol,
    m_flow_nominal=mCol_flow_nominal,
    T_start=TCol_start)
  ...
  IDEAS.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear val(
    redeclare final package Medium = MediumCol,
    ...
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={40,-40})));
  IDEAS.Fluid.Movers.Preconfigured.FlowControlled_m_flow pum(
    redeclare final package Medium = MediumCol,
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTColOut(
    redeclare final package Medium = MediumCol,
    m_flow_nominal=mCol_flow_nominal,
...
annotation(experiment(StopTime=900,Tolerance=1E-6),
  __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/CHPs/OrganicRankine/Examples/ORCHotWater.mos"
  "Simulate and plot"),
