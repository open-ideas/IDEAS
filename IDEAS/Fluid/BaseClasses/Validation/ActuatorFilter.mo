within IDEAS.Fluid.BaseClasses.Validation;
model ActuatorFilter "Validation model for the actuator filter"
  ...
  IDEAS.Fluid.BaseClasses.ActuatorFilter act_1(f=fCut, initType=Modelica.Blocks.Types.Init.InitialState)
    "Filter with u_nominal not set"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  IDEAS.Fluid.BaseClasses.ActuatorFilter act_2(f=fCut, initType=Modelica.Blocks.Types.Init.InitialState)
  ...
  IDEAS.Fluid.BaseClasses.ActuatorFilter act_y_start05(
    f=fCut,
    initType=Modelica.Blocks.Types.Init.InitialOutput,
    y_start=0.5) "Filter with initial start value for output"
    annotation (Placement(transformation(extent={{20,60},{40,80}})));
  IDEAS.Fluid.BaseClasses.ActuatorFilter act_y_start1(
    f=fCut,
    initType=Modelica.Blocks.Types.Init.InitialOutput,
...
equation
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/BaseClasses/Validation/ActuatorFilter.mos"
        "Simulate and plot"),
    experiment(
      StopTime=20,
      Tolerance=1e-06),
...
<a href=\"modelica://IDEAS.Fluid.BaseClasses.ActuatorFilter\">
IDEAS.Fluid.BaseClasses.ActuatorFilter</a>.
...
<a href=\"https://https://github.com/ibpsa/modelica-ibpsa/issues/1498\">IDEAS, #1498</a>
</li>
</ul>
</html>"));
end ActuatorFilter;
