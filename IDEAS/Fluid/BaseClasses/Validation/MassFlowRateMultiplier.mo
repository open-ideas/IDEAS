...
model MassFlowRateMultiplier "Example use of MassFlowRateMultiplier"
  ...
  IDEAS.Fluid.BaseClasses.MassFlowRateMultiplier
...
equation
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/BaseClasses/Validation/MassFlowRateMultiplier.mos"
        "Simulate and plot"),
    experiment(Tolerance=1e-6, StartTime=0.0, StopTime=10.0),
    Documentation(info="<html>
<p>
This example demonstrates the use of
<a href=\"modelica://IDEAS.Fluid.BaseClasses.MassFlowRateMultiplier\">
IDEAS.Fluid.BaseClasses.MassFlowRateMultiplier</a>,
