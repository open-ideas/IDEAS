...
equation
  ...
  connect(bou1.ports[2], senTem2.port_a) annotation (Line(points={{-40,-1},{-28,
          -1},{-28,-20},{-20,-20}}, color={0,127,255}));
  connect(senTem1.port_b, tap1.port_a)
    annotation (Line(points={{0,20},{20,20}}, color={0,127,255}));
  connect(senTem2.port_b, tap2.port_a)
    annotation (Line(points={{0,-20},{20,-20}}, color={0,127,255}));
  connect(tap1.port_b, bou2.ports[1]) annotation (Line(points={{40,20},{60,20},
          {60,1},{70,1}}, color={0,127,255}));
  connect(tap2.port_b, bou2.ports[2]) annotation (Line(points={{40,-20},{60,-20},
          {60,-1},{70,-1}}, color={0,127,255}));
