...
equation
  der(x)=1;
  etaApp = IDEAS.Fluid.Movers.BaseClasses.Euler.correlation(x);
  etaOri = correlation(x);

  annotation (experiment(Tolerance=1e-6, StopTime=10.0),
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/EulerCurve.mos"
 "Simulate and plot"),
 Documentation(
info="<html>
<p>
