...
model HydraulicEfficiencyMethods
  ...
  IDEAS.Fluid.Movers.Data.Generic per(
    ...
    final etaMotMet=IDEAS.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.NotProvided)
    "Performance record";
  ...
  IDEAS.Fluid.Movers.BaseClasses.FlowMachineInterface eff1(
    per(
      ...
      etaHydMet=IDEAS.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.NotProvided),
    rho_default=rhoFlu,
    nOri=2,
  ...
  IDEAS.Fluid.Movers.BaseClasses.FlowMachineInterface eff3(
    per(
      ...
      pressure=per.pressure,
      etaMotMet=per.etaMotMet,
      etaHydMet=IDEAS.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.Power_VolumeFlowRate,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/HydraulicEfficiencyMethods.mos"
        "Simulate and plot"));
