...
model PowerInterface "Simple model to validate PowerInterface"
  ...
  IDEAS.Fluid.Movers.BaseClasses.PowerInterface powCoo(
  ...
  IDEAS.Fluid.Movers.BaseClasses.PowerInterface powNonCoo(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/PowerInterface.mos"
        "Simulate and plot"));
end PowerInterface;
