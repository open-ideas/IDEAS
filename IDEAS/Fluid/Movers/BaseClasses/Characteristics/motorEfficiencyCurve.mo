within IDEAS.Fluid.Movers.BaseClasses.Characteristics;
function motorEfficiencyCurve
  ...
  output IDEAS.Fluid.Movers.BaseClasses.Characteristics.efficiencyParameters_yMot
...
algorithm
  if P_nominal>1E-6 then
    for j in 1:nPoi loop
      motorEfficiency_yMot.eta[j]:=eta_max * IDEAS.Utilities.Math.Functions.smoothInterpolation(
        x=P_nominal,
        xSup=u2,
        ySup=tab[j, :],
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IDEAS/Resources/Images/Fluid/Movers/BaseClasses/Characteristics/MotorEfficiencyCurves.png\"
width=\"500\"/>
</p>
<h4>References</h4>
<p>
