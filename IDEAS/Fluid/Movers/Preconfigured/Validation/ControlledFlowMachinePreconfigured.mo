within IDEAS.Fluid.Movers.Preconfigured.Validation;
model ControlledFlowMachinePreconfigured
  "Preconfigured fans with different control signals"
  extends Modelica.Icons.Example;
  extends IDEAS.Fluid.Movers.Validation.BaseClasses.ControlledFlowMachine(
    redeclare IDEAS.Fluid.Movers.Preconfigured.SpeedControlled_y fan1(
      redeclare package Medium = Medium,
      m_flow_nominal=m_flow_nominal,
      dp_nominal=dp_nominal),
    redeclare IDEAS.Fluid.Movers.Preconfigured.FlowControlled_m_flow fan2(
      redeclare package Medium = Medium,
      m_flow_nominal=m_flow_nominal,
      dp_nominal=dp_nominal),
    redeclare IDEAS.Fluid.Movers.Preconfigured.FlowControlled_dp fan3(
      redeclare package Medium = Medium,
      m_flow_nominal=m_flow_nominal,
      dp_nominal=dp_nominal),
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/Preconfigured/Validation/ControlledFlowMachinePreconfigured.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model validates the preconfigured mover models.
It is based on
<a href=\"Modelica://IDEAS.Fluid.Movers.Validation.ControlledFlowMachineDynamic\">
IDEAS.Fluid.Movers.Validation.ControlledFlowMachineDynamic</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
