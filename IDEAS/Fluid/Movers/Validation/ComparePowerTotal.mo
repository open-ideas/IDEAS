...
model ComparePowerTotal
  ...
  extends IDEAS.Fluid.Movers.Validation.ComparePowerHydraulic(
    redeclare IDEAS.Fluid.Movers.Data.Pumps.Wilo.Stratos40slash1to12 per);
annotation(experiment(Tolerance=1e-6, StopTime=200),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/Validation/ComparePowerTotal.mos"
        "Simulate and plot"),
