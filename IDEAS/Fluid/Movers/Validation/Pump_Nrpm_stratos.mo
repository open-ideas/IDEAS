within IDEAS.Fluid.Movers.Validation;
model Pump_Nrpm_stratos "Model validation using a Wilo Stratos 80/1-12 pump"
  ...
  IDEAS.Fluid.Movers.SpeedControlled_Nrpm pump1(
    y_start=1,
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    per=per) "Wilo Stratos pump"
    annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
  IDEAS.Fluid.Movers.SpeedControlled_Nrpm pump2(
    y_start=1,
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    per=per) "Wilo Stratos pump"
    annotation (Placement(transformation(extent={{-60,10},{-40,30}})));
  IDEAS.Fluid.Movers.SpeedControlled_Nrpm pump3(
    y_start=1,
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    per=per) "Wilo Stratos pump"
    annotation (Placement(transformation(extent={{-60,-36},{-40,-16}})));
  IDEAS.Fluid.Movers.SpeedControlled_Nrpm pump4(
    y_start=1,
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    per=per) "Wilo Stratos pump"
    annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  IDEAS.Fluid.Movers.SpeedControlled_Nrpm pump5(
    y_start=1,
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    per=per) "Wilo Stratos pump"
  ...
  IDEAS.Fluid.Movers.FlowControlled_m_flow forcedPump1(redeclare package Medium
      =        Medium, m_flow_nominal=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Pump for forcing a certain mass flow rate"
    annotation (Placement(transformation(extent={{38,60},{58,80}})));
  IDEAS.Fluid.Movers.FlowControlled_m_flow forcedPump2(redeclare package Medium
      =        Medium, m_flow_nominal=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Pump for forcing a certain mass flow rate"
    annotation (Placement(transformation(extent={{38,10},{58,30}})));
  IDEAS.Fluid.Movers.FlowControlled_m_flow forcedPump3(redeclare package Medium
      =        Medium, m_flow_nominal=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Pump for forcing a certain mass flow rate"
    annotation (Placement(transformation(extent={{38,-36},{58,-16}})));
  IDEAS.Fluid.Movers.FlowControlled_m_flow forcedPump4(redeclare package Medium
      =        Medium, m_flow_nominal=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Pump for forcing a certain mass flow rate"
    annotation (Placement(transformation(extent={{38,-80},{58,-60}})));
  IDEAS.Fluid.Movers.FlowControlled_m_flow forcedPump5(redeclare package Medium
      =        Medium, m_flow_nominal=3,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Pump for forcing a certain mass flow rate"
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/Validation/Pump_Nrpm_stratos.mos"
        "Simulate and plot"),
...
<p>Pump heads:</p>
<p><img src=\"modelica://IDEAS/Resources/Images/Fluid/Movers/Examples/PumpValidationHead.png\"
alt=\"Pump head.\"/>
</p>
<p>Pump electrical power:</p>
<p><img src=\"modelica://IDEAS/Resources/Images/Fluid/Movers/Examples/PumpValidationPower.png\"
alt=\"Pump power.\"/></p>
