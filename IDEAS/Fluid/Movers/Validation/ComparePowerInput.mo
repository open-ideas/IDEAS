...
model ComparePowerInput
  ...
  extends IDEAS.Fluid.Movers.Validation.BaseClasses.ComparePower(
    redeclare IDEAS.Fluid.Movers.Data.Fans.Greenheck.BIDW15 per(
    ...
    redeclare IDEAS.Fluid.Movers.SpeedControlled_y mov1(
      redeclare final package Medium = Medium,
      per=per,
      energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
      addPowerToMedium=false,
      use_inputFilter=false),
    redeclare IDEAS.Fluid.Movers.FlowControlled_dp mov2(
      redeclare final package Medium = Medium,
      energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
      per=per,
      addPowerToMedium=false,
    ...
    redeclare IDEAS.Fluid.Movers.FlowControlled_m_flow mov3(
      redeclare final package Medium = Medium,
      energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
      per=per,
      addPowerToMedium=false,
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=200),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/Validation/ComparePowerInput.mos"
        "Simulate and plot"),
