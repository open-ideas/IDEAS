within IDEAS.Fluid.Movers.Validation.BaseClasses;
model ControlledFlowMachine
  ...
  IDEAS.Fluid.Sensors.MassFlowRate masFloRat1(redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{60,50},{80,70}})));
  IDEAS.Fluid.Sensors.RelativePressure relPre(redeclare package Medium =
        Medium) annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        origin={-10,32})));
  replaceable
  IDEAS.Fluid.Movers.SpeedControlled_y fan1(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare IDEAS.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
    constrainedby IDEAS.Fluid.Movers.SpeedControlled_y
    "Fan with normalized control input between 0 and 1"
    annotation (Placement(transformation(extent={{-20,50},{0,70}})));
  IDEAS.Fluid.FixedResistances.PressureDrop dp1(
    redeclare package Medium = Medium,
    from_dp=true,
    m_flow_nominal=0.006,
    dp_nominal=50000) "Pressure drop"
    annotation (Placement(transformation(extent={{16,50},{36,70}})));
  IDEAS.Fluid.FixedResistances.PressureDrop dp2(
    redeclare package Medium = Medium,
    from_dp=true,
    m_flow_nominal=0.006,
    dp_nominal=50000) "Pressure drop"
    annotation (Placement(transformation(extent={{16,-30},{36,-10}})));
  IDEAS.Fluid.Sensors.MassFlowRate masFloRat2(
    redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{60,-30},{80,-10}})));
  IDEAS.Fluid.FixedResistances.PressureDrop dp3(
    redeclare package Medium = Medium,
    from_dp=true,
    m_flow_nominal=0.006,
    dp_nominal=50000) "Pressure drop"
    annotation (Placement(transformation(extent={{16,-70},{36,-50}})));
  IDEAS.Fluid.Sensors.MassFlowRate masFloRat3(
    redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{60,-70},{80,-50}})));
  replaceable
  IDEAS.Fluid.Movers.FlowControlled_dp fan3(
    redeclare package Medium = Medium,
    m_flow_nominal=6000/3600*1.2,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare IDEAS.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
    constrainedby IDEAS.Fluid.Movers.FlowControlled_dp
  ...
  IDEAS.Fluid.Movers.FlowControlled_m_flow fan2(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare IDEAS.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
    constrainedby IDEAS.Fluid.Movers.FlowControlled_m_flow
    "Fan with mass flow rate as input"
    annotation (Placement(transformation(extent={{-20,-30},{0,-10}})));
  IDEAS.Fluid.FixedResistances.PressureDrop dp5(
    m_flow_nominal=6000/3600*1.2,
    redeclare package Medium = Medium,
    dp_nominal=300,
    from_dp=true) "Pressure drop"
    annotation (Placement(transformation(extent={{-52,50},{-32,70}})));
  IDEAS.Fluid.FixedResistances.PressureDrop dp6(
    m_flow_nominal=6000/3600*1.2,
    redeclare package Medium = Medium,
    dp_nominal=300,
    from_dp=true) "Pressure drop"
    annotation (Placement(transformation(extent={{-52,-30},{-32,-10}})));
  IDEAS.Fluid.FixedResistances.PressureDrop dp7(
    m_flow_nominal=6000/3600*1.2,
    redeclare package Medium = Medium,
    dp_nominal=300,
    from_dp=true) "Pressure drop"
