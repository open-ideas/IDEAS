...
model ComparePower
  ...
  replaceable IDEAS.Fluid.Movers.BaseClasses.PartialFlowMachine mov1
    constrainedby IDEAS.Fluid.Movers.BaseClasses.PartialFlowMachine
    "Mover (fan or pump)"
    annotation (Placement(transformation(extent={{-40,30},{-20,50}})));
  replaceable IDEAS.Fluid.Movers.BaseClasses.PartialFlowMachine mov2
    constrainedby IDEAS.Fluid.Movers.BaseClasses.PartialFlowMachine
    "Mover (fan or pump)"
    annotation (Placement(transformation(extent={{-40,-30},{-20,-10}})));
  replaceable IDEAS.Fluid.Movers.BaseClasses.PartialFlowMachine mov3
    constrainedby IDEAS.Fluid.Movers.BaseClasses.PartialFlowMachine
    "Mover (fan or pump)"
    annotation (Placement(transformation(extent={{-40,-80},{-20,-60}})));

  IDEAS.Fluid.Actuators.Dampers.Exponential damExp1(
  ...
  IDEAS.Fluid.Actuators.Dampers.Exponential damExp2(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
    use_strokeTime=false,
    final dpDamper_nominal=dp_nominal/2,
  ...
  IDEAS.Fluid.Actuators.Dampers.Exponential damExp3(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
    use_strokeTime=false,
    final dpDamper_nominal=dp_nominal/2,
