...
model PowerSimplified
  ...
  IDEAS.Fluid.Movers.SpeedControlled_Nrpm pump_Nrpm(
  ...
  IDEAS.Fluid.Movers.FlowControlled_dp pump_dp(
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.Movers.FlowControlled_m_flow pump_m_flow(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    redeclare Data.Pumps.Wilo.Stratos30slash1to8 per(
      pressure(V_flow={0,0}, dp={0,0}),
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop[3] res(
...
equation
  ...
  annotation (    experiment(Tolerance=1e-6, StopTime=200),
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/Validation/PowerSimplified.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IDEAS/Resources/Images/Fluid/Movers/Validation/PowerSimplified.png\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
...
<a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/1533\">IDEAS, #1533</a>.
</li>
<li>
...
<code>expected subtype of record IDEAS.Fluid.Movers.Data.Generic</code>.
</li>
<li>
