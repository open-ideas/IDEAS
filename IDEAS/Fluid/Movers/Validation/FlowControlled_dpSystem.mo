...
model FlowControlled_dpSystem
  ...
  IDEAS.Fluid.Movers.FlowControlled_dp floConDp(
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.Movers.FlowControlled_dp floConDpSystem(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    allowFlowReversal=false,
    nominalValuesDefineDefaultPressureCurve=true,
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop heaCoi2(
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop heaCoi1(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=dp_nominal/2) "Heating coil pressure drop"
  ...
  IDEAS.Fluid.FixedResistances.PressureDrop duct3(
    redeclare package Medium = Medium,
    dp_nominal=dp_nominal/2,
    m_flow_nominal=m_flow_nominal/2) "Duct pressure drop"
    annotation (Placement(transformation(extent={{0,-70},{20,-50}})));
  IDEAS.Fluid.FixedResistances.PressureDrop duct4(
    redeclare package Medium = Medium,
    dp_nominal=dp_nominal/2,
    m_flow_nominal=m_flow_nominal/2) "Duct pressure drop"
    annotation (Placement(transformation(extent={{0,-110},{20,-90}})));
  IDEAS.Fluid.FixedResistances.PressureDrop duct1(
    redeclare package Medium = Medium,
    dp_nominal=dp_nominal/2,
    m_flow_nominal=m_flow_nominal/2) "Duct pressure drop"
    annotation (Placement(transformation(extent={{0,70},{20,90}})));
  IDEAS.Fluid.FixedResistances.PressureDrop duct2(
    redeclare package Medium = Medium,
    dp_nominal=dp_nominal/2,
    m_flow_nominal=m_flow_nominal/2) "Duct pressure drop"
    annotation (Placement(transformation(extent={{0,30},{20,50}})));
...
__Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/Validation/FlowControlled_dpSystem.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example demonstrates and tests the use of
<a href=\"modelica://IDEAS.Fluid.Movers.Validation.FlowControlled_dp\">
IDEAS.Fluid.Movers.Validation.FlowControlled_dp</a>
