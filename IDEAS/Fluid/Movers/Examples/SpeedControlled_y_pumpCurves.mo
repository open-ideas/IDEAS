...
model SpeedControlled_y_pumpCurves
  ...
  constant Modelica.Units.SI.PressureDifference dp_nominal=10000
   ...
   model pumpModel = IDEAS.Fluid.Movers.SpeedControlled_y (
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/Examples/SpeedControlled_y_pumpCurves.mos"
        "Simulate and plot"),
