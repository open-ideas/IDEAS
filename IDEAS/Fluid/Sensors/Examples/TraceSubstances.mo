...
model TraceSubstances "Test model for the extra property sensor"
 ...
 parameter Modelica.SIunits.MassFlowRate m_flow_nominal = 15*1.2/3600
  ...
  IDEAS.Fluid.Sources.Boundary_pT mSin(
  ...
  IDEAS.Fluid.Sensors.TraceSubstancesTwoPort senTraSubNoFlorRev(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
  ...
  IDEAS.Fluid.Sensors.PPM senPPM(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false)
    "PPM sensor"
