...
model Velocity "Test model for the flow velocity sensor"
  ...
  IDEAS.Fluid.Sensors.Velocity senDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=10,
    A=A) "Sensor configured to use a dynamic model for the density"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  IDEAS.Fluid.Sensors.Velocity senSteSta(
    redeclare package Medium = Medium,
    m_flow_nominal=10,
    tau=0,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Sensors/Examples/Velocity.mos"
        "Simulate and plot"),
