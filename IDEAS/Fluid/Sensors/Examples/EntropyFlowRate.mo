...
model EntropyFlowRate "Test model for the entropy flow rate sensors"
  ...
  IDEAS.Fluid.Sensors.EntropyFlowRate  senS_flow(
  ...
  IDEAS.Fluid.Sensors.SpecificEntropyTwoPort  senS(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Sensors/Examples/EntropyFlowRate.mos"
