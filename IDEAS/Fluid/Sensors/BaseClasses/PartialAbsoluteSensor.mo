...
partial model PartialAbsoluteSensor
  ...
  parameter Boolean warnAboutOnePortConnection = true
   "Set to false to suppress warning about potential numerical issues, see IDEAS.Fluid.Sensors.UsersGuide for more information"
...
initial equation
  ...
  Only connect it to a vectorized fluid port, such as used in 'IDEAS.Fluid.MixingVolumes`.
  See IDEAS.Fluid.Sensors.UsersGuide for more information.
...
Icon(
  graphics={
    Bitmap(
      ...
      extent={{-96,-82},{-64,-50}},
      fileName="modelica://IDEAS/Resources/Images/Fluid/Sensors/warningIcon.png")}));
