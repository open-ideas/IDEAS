...
<a href=\"modelica://IDEAS.Fluid.MassExchangers.ConstantEffectiveness\">ConstantEffectiveness</a>
works correctly at zero flow if one stream is zero.
</p>
</html>"), experiment(Tolerance=1e-06, StopTime=1),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/MassExchangers/Validation/ConstantEffectivenessZeroFlow.mos"
        "Simulate and plot"));
