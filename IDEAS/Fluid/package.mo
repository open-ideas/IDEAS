...
<tr>
  ...
  <td>Specific enthalpy <i>h</i> of the outflowing fluid, i.e.,
      ...
      <a href=\"modelica://IDEAS.Fluid.Sensors.SpecificEnthalpyTwoPort\">
      IDEAS.Fluid.Sensors.SpecificEnthalpyTwoPort</a>.</td>
</tr>
<tr>
  ...
  <td>Independent mixture mass fractions
      ...
      direction can do so using the sensor
      <a href=\"modelica://IDEAS.Fluid.Sensors.MassFractionTwoPort\">
      IDEAS.Fluid.Sensors.MassFractionTwoPort</a>.
...
<tr>
  ...
  <td>Trace substances <i>c<sub>i</sub>/m</i> close to the connection point, i.e.,
      ...
      See for example
      <a href=\"modelica://IDEAS.Fluid.Sensors.Examples.TraceSubstances\">
      IDEAS.Fluid.Sensors.Examples.TraceSubstances</a>.</td>
</tr>
</table>
