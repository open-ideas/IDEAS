...
model Outside_CpData_Angles
  ...
  IDEAS.Fluid.Sources.Outside_CpData symNor(
  ...
  IDEAS.Fluid.Sources.Outside_CpData asyNor(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=CpAsy,
    azi=IDEAS.Types.Azimuth.N)
  ...
  IDEAS.Fluid.Sources.Outside_CpData asyWes(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=CpAsy,
  ...
  IDEAS.Fluid.Sources.Outside_CpData symWes(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=CpSym,
    azi=IDEAS.Types.Azimuth.W)
...
equation
  ...
  connect(symWes.weaBus, weaDat.weaBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  annotation (__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Sources/Examples/Outside_CpData_Angles.mos"
        "Simulate and plot"),
