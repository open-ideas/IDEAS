...
model PropertySource_T "Model that illustrates the use of PropertySource_T"
  ...
  IDEAS.Fluid.Sources.PropertySource_T proSouXi(
    redeclare package Medium = Medium,
    use_Xi_in=true)
    "Property source that prescribes Xi"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  IDEAS.Fluid.Sources.MassFlowSource_T bouXi(
    redeclare package Medium = Medium,
    nPorts=1,
    use_m_flow_in=true)
  ...
  IDEAS.Fluid.Sources.PropertySource_T proSouT(
    redeclare package Medium = Medium,
    use_T_in=true)
    "Property source that prescribes the temperature"
    annotation (Placement(transformation(extent={{-10,30},{10,50}})));
  IDEAS.Fluid.Sources.PropertySource_T proSouC(
    redeclare package Medium = Medium,
    use_C_in=true)
    "Property source that prescribes C"
    annotation (Placement(transformation(extent={{-10,-50},{10,-30}})));
  IDEAS.Fluid.Sources.MassFlowSource_T bouT(
    redeclare package Medium = Medium,
    nPorts=1,
    use_m_flow_in=true)
    "Boundary for temperature test"
    annotation (Placement(transformation(extent={{-60,30},{-40,50}})));
  IDEAS.Fluid.Sources.MassFlowSource_T bouC(
    redeclare package Medium = Medium,
    nPorts=1,
    use_m_flow_in=true)
    "Boundary for C test"
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTemT(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    tau=0)
    "Temperature sensor for when using temperature input"
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTemXi(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    tau=0)
    "Temperature sensor for when using Xi input"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort senTemC(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    tau=0)
...
the <a href=\"modelica://IDEAS.Fluid.Sources.PropertySource_T\">
IDEAS.Fluid.Sources.PropertySource_T</a> model.
</p>
</html>", revisions="<html>
<ul>
<li>
...
See <a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/881\">#881</a>.
    ...
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Sources/Examples/PropertySource_T.mos"
        "Simulate and plot"),
    experiment(
      StopTime=1,
      Tolerance=1e-06));
