...
model Outside_CpData
  ...
  parameter Real Cp[:] = {0.4, 0.1, -0.3, -0.35, -0.2, -0.35, -0.3, 0.1}
    "Cp values";
  IDEAS.Fluid.Sources.Outside_CpData west(
...
equation
  ...
  connect(weaDat.weaBus, east.weaBus) annotation (Line(
      ...
      thickness=0.5,
      smooth=Smooth.None));
  annotation (__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Sources/Examples/Outside_CpData.mos"
        "Simulate and plot"),
