...
model MassFlowSource_WeatherData
  ...
  extends IDEAS.Fluid.Sources.BaseClasses.PartialAirSource(final verifyInputs=true);
  ...
  IDEAS.BoundaryConditions.WeatherData.Bus weaBus "Bus with weather data"
...
protected
  ...
  IDEAS.Utilities.Psychrometrics.X_pTphi x_pTphi if (not singleSubstance)
...
<p>The <a href=\"modelica://IDEAS.Utilities.Psychrometrics.X_pTphi\">
IDEAS.Utilities.Psychrometrics.X_pTphi</a> block is used with the input data
...
Changed to extend <a href=\"modelica://IDEAS.Fluid.Sources.BaseClasses.PartialSource\">
IDEAS.Fluid.Sources.BaseClasses.PartialSource</a>. This is for
