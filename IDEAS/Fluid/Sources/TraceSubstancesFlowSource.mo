...
model TraceSubstancesFlowSource
  ...
  replaceable package Medium =
    IDEAS.Media.Air(extraPropertiesNames={"CO2"}) "Medium in the component"
      annotation (choices(
        choice(redeclare package Medium = IDEAS.Media.Air "Moist air"),
        choice(redeclare package Medium = IDEAS.Media.Air(extraPropertiesNames={"CO2"}) "Moist air with CO2")));
