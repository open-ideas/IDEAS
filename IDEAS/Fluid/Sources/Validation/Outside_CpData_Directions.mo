...
model Outside_CpData_Directions
  ...
  IDEAS.Fluid.Sources.Outside_CpData eas(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=Cp,
  ...
  IDEAS.Fluid.Sources.Outside_CpData sou(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=Cp,
  ...
  IDEAS.Fluid.Sources.Outside_CpData wes(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=Cp,
...
equation
  ...
  connect(weaDat.weaBus, wes.weaBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  annotation (__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Sources/Validation/Outside_CpData_Directions.mos"
        "Simulate and plot"),
