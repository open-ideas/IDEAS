...
<a href=\"modelica://IDEAS.Media.Water\">IDEAS.Media.Water</a> with regard to its
...
<pre>
  package Medium = IDEAS.Media.Specialized.Water.ConstantProperties_pT(
