within IDEAS.Media.Specialized.Air;
...
function saturationPressureLiquid
  ...
  // IDEAS.Fluid.Sensors.Examples.MassFraction
algorithm
  psat := 611.657*Modelica.Math.exp(17.2799 - 4102.99/(Tsat - 35.719));
  annotation (
    smoothOrder=5,
    Inline=true,
    derivative=IDEAS.Media.Specialized.Air.PerfectGas.saturationPressureLiquid_der,
    Documentation(info="<html>
...
<a href=\"modelica://IDEAS.Media.Specialized.Air.PerfectGas.saturationPressureLiquid\">
IDEAS.Media.Specialized.Air.PerfectGas.saturationPressureLiquid</a>
</html>"));
...
First implementation.
  ...
  constant GasProperties dryair(
    ...
    cv=IDEAS.Utilities.Psychrometrics.Constants.cpAir - Modelica.Media.IdealGases.Common.SingleGasesData.Air.R_s)
    "Dry air properties";
  constant GasProperties steam(
    ...
    cv=IDEAS.Utilities.Psychrometrics.Constants.cpSte - Modelica.Media.IdealGases.Common.SingleGasesData.H2O.R_s)
    "Steam properties";

  constant Real k_mair =  steam.MM/dryair.MM "Ratio of molar weights";

  constant Modelica.Units.SI.SpecificEnergy h_fg=IDEAS.Utilities.Psychrometrics.Constants.h_fg
    "Latent heat of evaporation of water";

  constant Modelica.Units.SI.SpecificHeatCapacity cpWatLiq=IDEAS.Utilities.Psychrometrics.Constants.cpWatLiq
...
<a href=\"modelica://IDEAS.Media.Air\">IDEAS.Media.Air</a>
