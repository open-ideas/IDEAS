within IDEAS.Media.Antifreeze.Validation;
model EthyleneGlycolWater
  "Model that tests the implementation of ethylene glycol-water properties"
  extends Modelica.Icons.Example;
  extends IDEAS.Media.Antifreeze.Validation.BaseClasses.FluidProperties(
    redeclare package Medium =
        IDEAS.Media.Antifreeze.Validation.BaseClasses.EthyleneGlycolWater (
          property_T=300,
          X_a=0.05),
    nX_a=7,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Media/Antifreeze/Validation/EthyleneGlycolWater.mos"
        "Simulate and plot"),
