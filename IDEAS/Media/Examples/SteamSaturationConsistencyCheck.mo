...
model SteamSaturationConsistencyCheck
  ...
  package MediumSte = IDEAS.Media.Steam "Steam medium model";
  package MediumWat = IDEAS.Media.Water "Liquid water medium model";
...
equation
  ...
  __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Media/Examples/SteamSaturationConsistencyCheck.mos"
        "Simulate and plot"),
