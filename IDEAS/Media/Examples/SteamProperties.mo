...
model SteamProperties
  ...
  extends IDEAS.Media.Examples.BaseClasses.PartialProperties(
    redeclare package Medium = IDEAS.Media.Steam (
      p_default=200000),
    TMin=273.15 + 100,
    TMax=273.15 + 160,
    p=200000);
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Media/Examples/SteamProperties.mos"
        "Simulate and plot"),
