...
model SteamSaturatedProperties
  ...
  package Medium = IDEAS.Media.Steam  "Steam medium model";
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Media/Examples/SteamSaturatedProperties.mos"
        "Simulate and plot"),
...
the <a href=\"modelica://IDEAS.Media.Steam\">
IDEAS.Media.Steam</a> model (vapor phase) and the
<a href=\"modelica://IDEAS.Media.Water\"> IDEAS.Media.Water</a>
model (liquid phase). See <a href=\"modelica://IDEAS.Media.Steam\">
IDEAS.Media.Steam</a> for more information.
</p>
<p>
