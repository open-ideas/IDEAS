...
model PropyleneGlycolWaterDerivativeCheck
  ...
  extends Modelica.Icons.Example;
   ...
   package Medium = IDEAS.Media.Antifreeze.PropyleneGlycolWater (
      X_a=0.60,
      property_T=293.15);
...
equation
   ...
   annotation(experiment(
                 ...
                 Tolerance=1E-8),
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Media/Examples/PropyleneGlycolWaterDerivativeCheck.mos"
        "Simulate and plot"),
