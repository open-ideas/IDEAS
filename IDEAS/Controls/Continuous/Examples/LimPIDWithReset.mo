...
model LimPIDWithReset
  ...
  Controller conWitRes(reset=IDEAS.Types.Reset.Parameter)
  ...
  Controller conNoRes(reset=IDEAS.Types.Reset.Disabled)
...
<p>
Plant model for
<a href=\"modelica://IDEAS.Controls.Continuous.Examples.LimPIDWithReset\">
IDEAS.Controls.Continuous.Examples.LimPIDWithReset</a>.
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/Continuous/Examples/LimPIDWithReset.mos"
        "Simulate and plot"),
    Documentation(
info="<html>
<p>
