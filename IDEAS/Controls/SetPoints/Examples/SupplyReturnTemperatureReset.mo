...
model SupplyReturnTemperatureReset "Test model for the heating curve"
  ...
  IDEAS.Controls.SetPoints.SupplyReturnTemperatureReset heaCur(
    m=1,
    TSup_nominal=333.15,
    TRet_nominal=313.15,
    TOut_nominal=263.15)
  ...
  IDEAS.Controls.SetPoints.SupplyReturnTemperatureReset heaCur1(
    m=1,
    use_TRoo_in=true,
    TSup_nominal=333.15,
    TRet_nominal=313.15,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/SetPoints/Examples/SupplyReturnTemperatureReset.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img src=\"modelica://IDEAS/Resources/Images/Controls/SetPoints/Examples/SupplyReturnTemperatureReset.png\" border=\"1\" alt=\"Supply and return water temperatures.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
