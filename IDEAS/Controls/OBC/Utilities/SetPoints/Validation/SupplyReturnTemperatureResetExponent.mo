...
model SupplyReturnTemperatureResetExponent
  ...
  IDEAS.Controls.OBC.Utilities.SetPoints.SupplyReturnTemperatureReset heaCurM(
    m=1.3,
    TSup_nominal=313.15,
    TRet_nominal=308.15,
    TOut_nominal=263.15)
...
equation
  ...
  annotation (
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/Utilities/SetPoints/Validation/SupplyReturnTemperatureResetExponent.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
