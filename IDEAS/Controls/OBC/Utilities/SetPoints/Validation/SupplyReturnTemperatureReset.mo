within IDEAS.Controls.OBC.Utilities.SetPoints.Validation;
model SupplyReturnTemperatureReset
  "Test model for the heating curve"
  IDEAS.Controls.OBC.Utilities.SetPoints.SupplyReturnTemperatureReset heaCur(
    m=1,
    TSup_nominal=333.15,
    TRet_nominal=313.15,
    TOut_nominal=263.15)
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp TOut(
    height=40,
    duration=1,
    offset=263.15,
    y(unit="K"))
  ...
  IDEAS.Controls.OBC.Utilities.SetPoints.SupplyReturnTemperatureReset heaCur1(
    m=1,
    dTOutHeaBal=15,
    TSup_nominal=333.15,
    TRet_nominal=313.15,
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Pulse TRoo1(
    offset=273.15+20,
    shift=0.5,
    amplitude=-5,
    period=1,
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant TOut1(
    k=273.15-10,
    y(unit="K"))
    "Constant outdoor air temperature"
    annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant TRoo(
    k=273.15+20,
    y(unit="K"))
...
equation
  ...
  annotation (
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/Utilities/SetPoints/Validation/SupplyReturnTemperatureReset.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
...
<p align=\"center\">
<img src=\"modelica://IDEAS/Resources/Images/Controls/OBC/Utilities/SetPoints/SupplyReturnTemperatureReset.png\"
border=\"1\"
