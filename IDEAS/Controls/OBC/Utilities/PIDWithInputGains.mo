within IDEAS.Controls.OBC.Utilities;
block PIDWithInputGains
  "P, PI, PD, and PID controller with output reset and input gains"
  parameter IDEAS.Controls.OBC.CDL.Types.SimpleController controllerType=IDEAS.Controls.OBC.CDL.Types.SimpleController.PI
    "Type of controller";
  parameter Real r(
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput u_s
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput u_m
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput k(
    min=100*IDEAS.Controls.OBC.CDL.Constants.eps)
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput Ti(
    quantity="Time",
    unit="s",
    min=100*IDEAS.Controls.OBC.CDL.Constants.eps)
    if with_I
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput Td(
    quantity="Time",
    unit="s",
    min=100*IDEAS.Controls.OBC.CDL.Constants.eps)
    if with_D
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealOutput y
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.BooleanInput trigger
  ...
  IDEAS.Controls.OBC.CDL.Reals.Subtract controlError
    "Control error (set point - measurement)"
    annotation (Placement(transformation(extent={{-200,-16},{-180,4}})));
  IDEAS.Controls.OBC.CDL.Reals.Multiply P
    "Proportional action"
    annotation (Placement(transformation(extent={{-50,130},{-30,150}})));
  IDEAS.Controls.OBC.CDL.Reals.IntegratorWithReset I(
    final k=1,
    final y_start=xi_start) if with_I
    "Integral term"
    annotation (Placement(transformation(extent={{-50,-10},{-30,10}})));
  IDEAS.Controls.OBC.CDL.Reals.Derivative D(
    final y_start=yd_start) if with_D
    "Derivative term"
    annotation (Placement(transformation(extent={{-50,60},{-30,80}})));
  IDEAS.Controls.OBC.CDL.Reals.Subtract errP
    "P error"
    annotation (Placement(transformation(extent={{-140,130},{-120,150}})));
  IDEAS.Controls.OBC.CDL.Reals.Subtract errD if with_D
    "D error"
    annotation (Placement(transformation(extent={{-140,60},{-120,80}})));
  IDEAS.Controls.OBC.CDL.Reals.Subtract errI1 if with_I
    "I error (before anti-windup compensation)"
    annotation (Placement(transformation(extent={{-140,-4},{-120,16}})));
  IDEAS.Controls.OBC.CDL.Reals.Subtract errI2 if with_I
    "I error (after anti-windup compensation)"
    annotation (Placement(transformation(extent={{-100,-10},{-80,10}})));
  IDEAS.Controls.OBC.CDL.Reals.Limiter lim(
    final uMax=yMax,
    final uMin=yMin)
    "Limiter"
    annotation (Placement(transformation(extent={{120,80},{140,100}})));
  IDEAS.Controls.OBC.CDL.Reals.Divide antWinGai2 if with_I
    "Outputs of anti-windup compensation"
    annotation (Placement(transformation(extent={{100,-30},{80,-10}})));
  IDEAS.Controls.OBC.CDL.Reals.Divide gaiI if with_I "Gain of the integral term"
    annotation (Placement(transformation(extent={{-200,116},{-180,136}})));
  IDEAS.Controls.OBC.CDL.Reals.Multiply errIWithGai if with_I
    "I error (after multiplying with the gain of the integral term)"
    annotation (Placement(transformation(extent={{-84,28},{-64,48}})));
  IDEAS.Controls.OBC.CDL.Reals.Multiply mulkTd if with_D
    "Product of k and Td"
    annotation (Placement(transformation(extent={{-200,150},{-180,170}})));
  IDEAS.Controls.OBC.CDL.Reals.GreaterThreshold greThrkTd(
    t=1E-6,
    h=1E-6/2)
    if with_D
...
protected
  ...
  final parameter Boolean with_I=controllerType == IDEAS.Controls.OBC.CDL.Types.SimpleController.PI or controllerType == IDEAS.Controls.OBC.CDL.Types.SimpleController.PID
    "Boolean flag to enable integral action"
    annotation (Evaluate=true,HideResult=true);
  final parameter Boolean with_D=controllerType == IDEAS.Controls.OBC.CDL.Types.SimpleController.PD or controllerType == IDEAS.Controls.OBC.CDL.Types.SimpleController.PID
    "Boolean flag to enable derivative action"
    annotation (Evaluate=true,HideResult=true);
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant Dzero(
    final k=0) if not with_D
    "Zero input signal"
    annotation (Evaluate=true,HideResult=true,Placement(transformation(extent={{-50,90},
            {-30,110}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant Izero(
    final k=0) if not with_I
    "Zero input signal"
    annotation (Placement(transformation(extent={{-50,20},{-30,40}})));
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter uS_revAct(
    final k=revAct/r) "Set point multiplied by reverse action sign"
    annotation (Placement(transformation(extent={{-200,30},{-180,50}})));
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter uMea_revAct(
    final k=revAct/r)
    "Set point multiplied by reverse action sign"
    annotation (Placement(transformation(extent={{-200,-50},{-180,-30}})));
  IDEAS.Controls.OBC.CDL.Reals.Add addPD
    "Outputs P and D gains added"
    annotation (Placement(transformation(extent={{20,124},{40,144}})));
  IDEAS.Controls.OBC.CDL.Reals.Add addPID
    "Outputs P, I and D gains added"
    annotation (Placement(transformation(extent={{80,80},{100,100}})));
  IDEAS.Controls.OBC.CDL.Reals.Subtract antWinErr if with_I
    "Error for anti-windup compensation"
    annotation (Placement(transformation(extent={{160,50},{180,70}})));
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter antWinGai1(k=1/Ni)
    if with_I "Gain for anti-windup compensation without the proportional gain"
    annotation (Placement(transformation(extent={{180,-30},{160,-10}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant yResSig(
    final k=y_reset) if with_I
    "Signal for y_reset"
    annotation (Placement(transformation(extent={{-140,-84},{-120,-64}})));
  IDEAS.Controls.OBC.CDL.Reals.Subtract addRes if with_I
    "Adder for integrator reset"
    annotation (Placement(transformation(extent={{-100,-90},{-80,-70}})));
  IDEAS.Controls.OBC.CDL.Logical.Sources.Constant cheYMinMax(
    final k=yMin < yMax) "Check for values of yMin and yMax"
    annotation (Placement(transformation(extent={{140,120},{160,140}})));
  IDEAS.Controls.OBC.CDL.Utilities.Assert assMesYMinMax(
  ...
  IDEAS.Controls.OBC.CDL.Utilities.Assert assMeskTd(
  ...
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter gaiT(final k=1/Nd) if with_D
    ...
    Icon(
      ...
      graphics={
        ...
        Rectangle(
          ...
          fillPattern=FillPattern.Solid),
        Text(
          visible=(controllerType == IDEAS.Controls.OBC.CDL.Types.SimpleController.P),
          extent={{-32,-22},{68,-62}},
          textColor={0,0,0},
          textString="P",
          fillPattern=FillPattern.Solid,
        ...
        Text(
          visible=(controllerType == IDEAS.Controls.OBC.CDL.Types.SimpleController.PI),
          extent={{-26,-22},{74,-62}},
          textColor={0,0,0},
          textString="PI",
          fillPattern=FillPattern.Solid,
          fillColor={175,175,175}),
        Text(
          visible=(controllerType == IDEAS.Controls.OBC.CDL.Types.SimpleController.PD),
          extent={{-16,-22},{88,-62}},
          textColor={0,0,0},
          fillPattern=FillPattern.Solid,
          fillColor={175,175,175},
          textString="P D"),
        Text(
          visible=(controllerType == IDEAS.Controls.OBC.CDL.Types.SimpleController.PID),
          extent={{-14,-22},{86,-62}},
          textColor={0,0,0},
          textString="PID",
          fillPattern=FillPattern.Solid,
...
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.PIDWithReset\">
IDEAS.Controls.OBC.CDL.Reals.PIDWithReset</a>,
