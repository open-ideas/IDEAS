...
block OptimalStart
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput TSetZonHea(
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput TZon(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC",
    min=200)
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput TSetZonCoo(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC",
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput tNexOcc(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealOutput tOpt(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.BooleanOutput optOn
  ...
  IDEAS.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation optHea(
  ...
  IDEAS.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation optCoo(
    final tOptMax=tOptMax,
    final thrOptOn=thrOptOn,
    final nDay=nDay,
    final uLow=uLow,
  ...
  IDEAS.Controls.OBC.CDL.Reals.GreaterThreshold hysSta(
    t=60,
    h=60)
...
The base class
<a href=\"modelica://IDEAS.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation\">
IDEAS.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation</a> is used
for the calculation.
</p>
<h4>Algorithm</h4>
<p>
...
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Discrete.TriggeredMovingMean\">
IDEAS.Controls.OBC.CDL.Discrete.TriggeredMovingMean</a> for details about
...
<a href=\"modelica://IDEAS.Controls.OBC.Utilities.Validation\">
IDEAS.Controls.OBC.Utilities.Validation</a>.
</p>
</html>",
      revisions="<html>
<ul>
