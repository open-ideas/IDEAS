...
model OptimalStartHeatingCooling
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant TSetCooOcc(
    k=24+273.15)
    "Zone cooling setpoint during occupancy"
    annotation (Placement(transformation(extent={{-20,60},{0,80}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Sin TOutBase(
    amplitude=5,
    freqHz=1/86400,
    offset=15+273.15,
    startTime(
  ...
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter UA(k=25)
    "Overall heat loss coefficient"
    annotation (Placement(transformation(extent={{-100,0},{-80,20}})));
  IDEAS.Controls.OBC.CDL.Reals.Subtract dT
    "Temperature difference between zone and outdoor"
    annotation (Placement(transformation(extent={{-140,0},{-120,20}})));
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter QCoo(k=-4000)
    "Heat extraction in the zone"
    annotation (Placement(transformation(extent={{-100,-40},{-80,-20}})));
  IDEAS.Controls.OBC.CDL.Conversions.BooleanToReal booToRea1(
    realTrue=-6)
    "Convert Boolean to Real signal"
    annotation (Placement(transformation(extent={{80,0},{100,20}})));
  IDEAS.Controls.OBC.CDL.Reals.Add add1
    "Reset temperature from unoccupied to occupied for optimal start period"
    annotation (Placement(transformation(extent={{140,0},{160,20}})));
  IDEAS.Controls.OBC.CDL.Reals.PID conPID1(
    controllerType=IDEAS.Controls.OBC.CDL.Types.SimpleController.PI,
    Ti=3,
    reverseActing=false)
  ...
  IDEAS.Controls.OBC.CDL.Reals.MultiSum mulSum(
    nin=3)
    "Sum heat gains"
    annotation (Placement(transformation(extent={{-60,0},{-40,20}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant TSetHeaOcc(
    k=21+273.15)
    "Zone heating setpoint during occupancy"
    annotation (Placement(transformation(extent={{-20,100},{0,120}})));
  IDEAS.Controls.OBC.CDL.Conversions.BooleanToReal booToRea2(
    realTrue=6)
    "Convert Boolean to Real signal"
    annotation (Placement(transformation(extent={{80,40},{100,60}})));
  IDEAS.Controls.OBC.CDL.Reals.Add add2
    "Reset temperature from unoccupied to occupied for optimal start period"
    annotation (Placement(transformation(extent={{140,40},{160,60}})));
  IDEAS.Controls.OBC.CDL.Reals.PID conPID(
    controllerType=IDEAS.Controls.OBC.CDL.Types.SimpleController.PI,
    Ti=3)
    "PI control for space heating"
    annotation (Placement(transformation(extent={{180,40},{200,60}})));
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter QHea(k=2000)
    "Heat injection in the zone"
    annotation (Placement(transformation(extent={{-100,-110},{-80,-90}})));
  IDEAS.Controls.OBC.CDL.Reals.Add TOut
    "Outdoor dry bulb temperature"
    annotation (Placement(transformation(extent={{-174,50},{-154,70}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Pulse pul(
    shift(
  ...
  IDEAS.Controls.OBC.CDL.Conversions.BooleanToReal TSetHea(
    realTrue=273.15+21,
    realFalse=273.15+15,
    y(final unit="K",
      displayUnit="degC"))
  ...
  IDEAS.Controls.OBC.CDL.Conversions.BooleanToReal TSetCoo(
    realTrue=273.15+24,
    realFalse=273.15+30,
    y(final unit="K",
      displayUnit="degC"))
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartHeatingCooling.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This models validates both space heating and cooling for the block
<a href=\"modelica://IDEAS.Controls.OBC.Utilities.OptimalStart\">
IDEAS.Controls.OBC.Utilities.OptimalStart</a>.
</p>
<p>
