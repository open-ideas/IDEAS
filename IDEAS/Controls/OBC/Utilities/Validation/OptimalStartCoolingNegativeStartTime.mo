...
model OptimalStartCoolingNegativeStartTime
  ...
  IDEAS.Controls.OBC.Utilities.OptimalStart optStaCoo(
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Sin TOut(
    amplitude=5,
    freqHz=1/86400,
    offset=28+273.15,
    startTime(
  ...
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter UA(k=100)
    "Overall heat loss coefficient"
    annotation (Placement(transformation(extent={{-120,0},{-100,20}})));
  IDEAS.Controls.OBC.CDL.Reals.Subtract dT
    "Temperature difference between zone and outdoor"
    annotation (Placement(transformation(extent={{-160,0},{-140,20}})));
  IDEAS.Controls.OBC.CDL.Reals.Add dTdt
    "Temperature derivative"
    annotation (Placement(transformation(extent={{-80,0},{-60,20}})));
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter QCoo(k=-2000)
    "Heat extraction in the zone"
    annotation (Placement(transformation(extent={{-120,-60},{-100,-40}})));
  IDEAS.Controls.OBC.CDL.Conversions.BooleanToReal booToRea(
    realTrue=-6)
    "Convert Boolean to Real signal"
    annotation (Placement(transformation(extent={{60,0},{80,20}})));
  IDEAS.Controls.OBC.CDL.Reals.Add add
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-07),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartCoolingNegativeStartTime.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This model is to validate the block
<a href=\"modelica://IDEAS.Controls.OBC.Utilities.OptimalStart\">
IDEAS.Controls.OBC.Utilities.OptimalStart</a> for space cooling system with
