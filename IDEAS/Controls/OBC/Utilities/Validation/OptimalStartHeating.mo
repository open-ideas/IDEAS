...
model OptimalStartHeating
  ...
  IDEAS.Controls.OBC.Utilities.OptimalStart optStaHea(
    computeHeating=true,
  ...
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter UA(k=10)
  ...
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter QHea(k=500)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-07),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartHeating.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This model is to validate the block
<a href=\"modelica://IDEAS.Controls.OBC.Utilities.OptimalStart\">
IDEAS.Controls.OBC.Utilities.OptimalStart</a> for space heating system.
</p>
<p>
