...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartNoHeatingNoCooling.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This models validates the block
<a href=\"modelica://IDEAS.Controls.OBC.Utilities.OptimalStart\">
IDEAS.Controls.OBC.Utilities.OptimalStart</a> for the case when the optimal start
