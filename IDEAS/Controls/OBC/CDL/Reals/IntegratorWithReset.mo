...
block IntegratorWithReset
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput y_reset_in
  ...
  annotation (
    ...
    Icon(
      ...
      graphics={
        ...
        Bitmap(
          extent={{-54,-50},{60,50}},
          fileName="modelica://IDEAS/Resources/Images/Controls/OBC/CDL/Reals/int.png"),
        Text(
          extent={{-88,56},{206,92}},
          textColor={0,0,0},
          textString="k=%k",
...
<a href=\"modelica://IDEAS.Utilities.Math.IntegratorWithReset\">
IDEAS.Utilities.Math.IntegratorWithReset</a>.
</li>
</ul>
</html>"));
