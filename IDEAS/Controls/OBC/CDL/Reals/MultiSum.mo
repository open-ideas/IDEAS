...
block MultiSum
  ...
  parameter Real k[nin]=fill(1, nin)
    "Input gains";
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput u[nin]
...
<p>
See
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.Validation.MultiSum\">
IDEAS.Controls.OBC.CDL.Reals.Validation.MultiSum</a>
for an example.
</p>
</html>",
      revisions="<html>
