...
model LessThreshold
  ...
  IDEAS.Controls.OBC.CDL.Reals.LessThreshold les(t=2)
    "Less block, without hysteresis"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));
  IDEAS.Controls.OBC.CDL.Reals.LessThreshold lesHys(t=2, h=1)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/LessThreshold.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.LessThreshold\">
IDEAS.Controls.OBC.CDL.Reals.LessThreshold</a>.
