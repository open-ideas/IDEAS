...
model MultiplyByParameter "Validation model for the Gain block"
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter gain1(k=2.5)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/MultiplyByParameter.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter\">
IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter</a>.
</p>
<p>
