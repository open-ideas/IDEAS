...
model Switch "Validation model for the Switch block"
  ...
  IDEAS.Controls.OBC.CDL.Reals.Switch switch1
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Switch.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.Switch\">
IDEAS.Controls.OBC.CDL.Reals.Switch</a>.
</p>
</html>",
      revisions="<html>
<ul>
