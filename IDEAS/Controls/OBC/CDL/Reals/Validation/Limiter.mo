...
model Limiter
  ...
  IDEAS.Controls.OBC.CDL.Reals.Limiter limiter1(
    uMax=2.5,
    uMin=1.2)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Limiter.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.Limiter\">
IDEAS.Controls.OBC.CDL.Reals.Limiter</a>.
</p>
<p>
