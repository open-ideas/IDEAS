...
model Greater
  ...
  IDEAS.Controls.OBC.CDL.Reals.Greater gre
    "Greater block, without hysteresis"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  IDEAS.Controls.OBC.CDL.Reals.Greater greHys(h=1)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Greater.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.Greater\">
IDEAS.Controls.OBC.CDL.Reals.Greater</a>.
