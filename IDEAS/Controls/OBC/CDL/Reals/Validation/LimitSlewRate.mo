...
model LimitSlewRate "Validation model for the LimitSlewRate block"
  IDEAS.Controls.OBC.CDL.Reals.LimitSlewRate sleRatLim(
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp ramp2(
    offset=0,
    height=-1.5,
    startTime=60,
    duration=20)
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp ramp3(
    offset=0,
    height=-1.5,
    duration=30,
    startTime=120+60)
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp ramp4(
    offset=0,
    height=1.5,
    duration=30,
    startTime=120)
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp ramp5(
    offset=0,
    height=-1.5,
    startTime=240+60,
    duration=40)
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp ramp6(
    offset=0,
    height=1.5,
    startTime=240,
    duration=40)
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp ramp7(
    offset=0,
    height=-1.5,
    duration=50,
    startTime=360+60)
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp ramp8(
    offset=0,
    height=1.5,
    duration=50,
    startTime=360)
  ...
  IDEAS.Controls.OBC.CDL.Reals.Add add3
    "Signal adder"
    annotation (Placement(transformation(extent={{-40,-120},{-20,-100}})));
  IDEAS.Controls.OBC.CDL.Reals.Add add4
    "Signal adder"
    annotation (Placement(transformation(extent={{0,50},{20,70}})));
  IDEAS.Controls.OBC.CDL.Reals.Add add5
    "Signal adder"
    annotation (Placement(transformation(extent={{0,-80},{20,-60}})));
  IDEAS.Controls.OBC.CDL.Reals.Add add6
    "Signal adder"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/LimitSlewRate.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.LimitSlewRate\">
IDEAS.Controls.OBC.CDL.Reals.LimitSlewRate</a>.
</p>
<p>
