...
model MultiMax
  ...
  IDEAS.Controls.OBC.CDL.Reals.MultiMax maxVal(
    nin=sizOfVec)
    "Block that outputs the maximum element of the input vector"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant con[sizOfVec](
    k={1,2,3,4,5})
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/MultiMax.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.MultiMax\">
IDEAS.Controls.OBC.CDL.Reals.MultiMax</a>.
</p>
<p>
