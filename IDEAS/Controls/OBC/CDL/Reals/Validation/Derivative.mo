...
model Derivative
  ...
  IDEAS.Controls.OBC.CDL.Reals.Derivative der1(y_start=1)
  ...
  IDEAS.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes(y_start=1)
    "Integration of input"
    annotation (Placement(transformation(extent={{0,0},{20,20}})));
  Logical.Sources.Constant booSig(k=false) "Contant boolean signal"
    annotation (Placement(transformation(extent={{-40,-30},{-20,-10}})));
  IDEAS.Controls.OBC.CDL.Reals.Cos cos "Cosine of model time"
    annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
  IDEAS.Controls.OBC.CDL.Reals.Derivative der2(y_start=0)
    "Derivative block with input gains"
  ...
  IDEAS.Controls.OBC.CDL.Reals.Subtract sub
  ...
  IDEAS.Controls.OBC.CDL.Reals.Abs abs "Absolute difference"
    annotation (Placement(transformation(extent={{110,26},{130,46}})));
  IDEAS.Controls.OBC.CDL.Reals.LessThreshold lesThr(t=0.1, h=0.01)
    "Output true if difference is within expected accuracy"
    annotation (Placement(transformation(extent={{140,26},{160,46}})));
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter gai(final k=1)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-07),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Derivative.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.Derivative\">
IDEAS.Controls.OBC.CDL.Reals.Derivative</a>.
