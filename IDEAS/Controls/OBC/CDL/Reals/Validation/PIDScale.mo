...
model PIDScale
  ...
  IDEAS.Controls.OBC.CDL.Reals.PID pidSca(
  ...
  IDEAS.Controls.OBC.CDL.Reals.PID pidNoSca(
    controllerType=IDEAS.Controls.OBC.CDL.Types.SimpleController.PID,
    k=2,
    Ti=1,
    Td=2,
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/PIDScale.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
