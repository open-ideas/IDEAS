...
model GreaterThreshold
  ...
  IDEAS.Controls.OBC.CDL.Reals.GreaterThreshold gre(t=2)
    "Greater block, without hysteresis"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  IDEAS.Controls.OBC.CDL.Reals.GreaterThreshold greHys(t=2, h=1)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/GreaterThreshold.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.GreaterThreshold\">
IDEAS.Controls.OBC.CDL.Reals.GreaterThreshold</a>.
