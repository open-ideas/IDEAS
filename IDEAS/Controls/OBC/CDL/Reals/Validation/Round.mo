...
model Round
  ...
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter gai(k=0.1) "Gain"
    annotation (Placement(transformation(extent={{0,-10},{20,10}})));
  IDEAS.Controls.OBC.CDL.Reals.MultiplyByParameter gai1(k=10) "Gain"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Round.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.Round\">
IDEAS.Controls.OBC.CDL.Reals.Round</a>.
</p>
<p>
