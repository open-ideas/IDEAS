...
model Multiply "Validation model for the Multiply block"
  IDEAS.Controls.OBC.CDL.Reals.Multiply product1
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Multiply.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.Multiply\">
IDEAS.Controls.OBC.CDL.Reals.Multiply</a>.
</p>
<p>
