...
model Divide "Validation model for the Divide block"
  IDEAS.Controls.OBC.CDL.Reals.Divide div1
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Divide.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.Divide\">
IDEAS.Controls.OBC.CDL.Reals.Divide</a>.
</p>
<p>
