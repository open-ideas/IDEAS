...
model Less
  ...
  IDEAS.Controls.OBC.CDL.Reals.Less les
    "Less block, without hysteresis"
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  IDEAS.Controls.OBC.CDL.Reals.Less lesHys(
    h=1)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Less.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.Less\">
IDEAS.Controls.OBC.CDL.Reals.Less</a>.
