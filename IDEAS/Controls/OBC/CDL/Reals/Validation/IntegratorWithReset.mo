...
model IntegratorWithReset
  ...
  IDEAS.Controls.OBC.CDL.Reals.IntegratorWithReset intDef(final
      y_start=-2)
    "Integrator with default values"
    annotation (Placement(transformation(extent={{0,60},{20,80}})));
  IDEAS.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes1(final
      y_start=-2,
    final k=0.5)
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant cons(
    final k=10)
    "Constant as source term"
    annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
  IDEAS.Controls.OBC.CDL.Logical.Sources.Pulse booleanPulse(
    final width=0.5,
    final period=0.2)
    "Boolean pulse"
    annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  IDEAS.Controls.OBC.CDL.Logical.Sources.SampleTrigger sampleTrigger(
    final period=0.2)
    "Sample trigger"
    annotation (Placement(transformation(extent={{-60,0},{-40,20}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp ramp(
    final height=-1,
    final duration=1,
    final offset=-2)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/IntegratorWithReset.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.IntegratorWithReset\">
IDEAS.Controls.OBC.CDL.Reals.IntegratorWithReset</a>
