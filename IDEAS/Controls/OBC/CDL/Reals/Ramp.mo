...
block Ramp "Limit the changing rate of the input"
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.BooleanInput active
...
way as <a href=\"modelica://IDEAS.Controls.OBC.CDL.Reals.LimitSlewRate\">
IDEAS.Controls.OBC.CDL.Reals.LimitSlewRate</a>. However, the
