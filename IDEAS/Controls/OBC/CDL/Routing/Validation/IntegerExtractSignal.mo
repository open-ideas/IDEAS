...
model IntegerExtractSignal
  ...
  IDEAS.Controls.OBC.CDL.Routing.IntegerExtractSignal extIntSig(
    final nin=4,
    final nout=3,
    final extract={3,2,4})
    "Block that extracts signal from an integer input signal vector"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  IDEAS.Controls.OBC.CDL.Routing.IntegerExtractSignal extIntSig1(
    final nin=4,
    final nout=5,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/IntegerExtractSignal.mos" "Simulate and plot"),
  Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Routing.IntegerExtractSignal\">
IDEAS.Controls.OBC.CDL.Routing.IntegerExtractSignal</a>.
</p>
<p>
