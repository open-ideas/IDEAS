...
model FirstOrderHold
  ...
  IDEAS.Controls.OBC.CDL.Discrete.FirstOrderHold firOrdHol(
    samplePeriod=0.2)
  ...
  IDEAS.Controls.OBC.CDL.Reals.Cos cos1
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Discrete/Validation/FirstOrderHold.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Discrete.FirstOrderHold\">
IDEAS.Controls.OBC.CDL.Discrete.FirstOrderHold</a>.
</p>
</html>",
      revisions="<html>
<ul>
