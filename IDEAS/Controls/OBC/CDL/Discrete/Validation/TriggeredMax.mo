...
model TriggeredMax
  ...
  IDEAS.Controls.OBC.CDL.Discrete.TriggeredMax triggeredMax
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Discrete/Validation/TriggeredMax.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Discrete.TriggeredMax\">
IDEAS.Controls.OBC.CDL.Discrete.TriggeredMax</a>.
</p>
</html>",
      revisions="<html>
<ul>
