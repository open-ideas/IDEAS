...
model ZeroOrderHold
  ...
  IDEAS.Controls.OBC.CDL.Discrete.ZeroOrderHold zerOrdHol(
    samplePeriod=0.2)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Discrete/Validation/ZeroOrderHold.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Discrete.ZeroOrderHold\">
IDEAS.Controls.OBC.CDL.Discrete.ZeroOrderHold</a>.
</p>
</html>",
      revisions="<html>
<ul>
