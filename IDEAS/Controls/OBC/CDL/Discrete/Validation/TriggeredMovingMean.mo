within IDEAS.Controls.OBC.CDL.Discrete.Validation;
model TriggeredMovingMean
  "Validation model for the TriggeredMovingMean block"
  IDEAS.Controls.OBC.CDL.Reals.Sources.Sin sin(
    freqHz=1/8,
  ...
  IDEAS.Controls.OBC.CDL.Discrete.TriggeredMovingMean triMovMea(
    n=3)
    "Triggered moving mean with 3 samples to average"
    annotation (Placement(transformation(extent={{0,0},{20,20}})));
  IDEAS.Controls.OBC.CDL.Discrete.TriggeredMovingMean triMovMea1(
    n=1)
    "Triggered moving mean with 1 sample to average"
    annotation (Placement(transformation(extent={{0,60},{20,80}})));
  IDEAS.Controls.OBC.CDL.Discrete.TriggeredMovingMean triMovMea2(
    n=3)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Discrete/Validation/TriggeredMovingMean.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Discrete.TriggeredMovingMean\">
IDEAS.Controls.OBC.CDL.Discrete.TriggeredMovingMean</a>.
</p>
</html>",
      revisions="<html>
<ul>
