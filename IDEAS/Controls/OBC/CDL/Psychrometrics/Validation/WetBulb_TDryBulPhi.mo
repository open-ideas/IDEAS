within IDEAS.Controls.OBC.CDL.Psychrometrics.Validation;
model WetBulb_TDryBulPhi
  "Model to test the wet bulb temperature computation"

  IDEAS.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi wetBulPhi
    "Model for wet bulb temperature"
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  IDEAS.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi wetBulPhi1
    "Model for wet bulb temperature"
    annotation (Placement(transformation(extent={{20,-50},{40,-30}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp phi(
    duration=1,
    height=0.95,
    offset=0.05) "Relative humidity"
    annotation (Placement(transformation(extent={{-40,10},{-20,30}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant TDryBul(
    k=273.15+29.4) "Dry bulb temperature"
    annotation (Placement(transformation(extent={{-40,60},{-20,80}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Ramp TDryBul1(
    duration=1,
    height=40,
    offset=273.15) "Dry bulb temperature"
    annotation (Placement(transformation(extent={{-40,-30},{-20,-10}})));
  IDEAS.Controls.OBC.CDL.Reals.Sources.Constant phi2(k=0.6)
    "Relative humidity"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Psychrometrics/Validation/WetBulb_TDryBulPhi.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This examples is a unit test for the dew point temperature computation
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi\">
IDEAS.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi</a>.
</p>
</html>",
      revisions="<html>
<ul>
...
<a href=\"modelica://IDEAS.Controls.OBC.CDL\">IDEAS.Controls.OBC.CDL</a> package.<br/>
This is for
