...
model SpecificEnthalpy_TDryBulPhi
  ...
  IDEAS.Controls.OBC.CDL.Psychrometrics.SpecificEnthalpy_TDryBulPhi hBulPhi
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Psychrometrics/Validation/SpecificEnthalpy_TDryBulPhi.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This examples is a unit test for the specific enthalpy computation <a href=\"modelica://IDEAS.Controls.OBC.CDL.Psychrometrics.SpecificEnthalpy_TDryBulPhi\">
IDEAS.Controls.OBC.CDL.Psychrometrics.SpecificEnthalpy_TDryBulPhi</a>.
</p>
</html>",
      revisions="<html>
<ul>
