...
model SampleTriggerNegativeStartTime
  ...
  IDEAS.Controls.OBC.CDL.Logical.Sources.SampleTrigger samTri(
    period=0.5)
  ...
  IDEAS.Controls.OBC.CDL.Discrete.TriggeredSampler triggeredSampler
    "Triggered sampler"
    annotation (Placement(transformation(extent={{20,60},{40,80}})));
  IDEAS.Controls.OBC.CDL.Logical.Sources.SampleTrigger samTri1(
    period=0.5,
    shift=3.2)
    "Block that generates sample trigger signal"
    annotation (Placement(transformation(extent={{-30,-80},{-10,-60}})));
  IDEAS.Controls.OBC.CDL.Discrete.TriggeredSampler triggeredSampler1
    "Triggered sampler"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Sources/Validation/SampleTriggerNegativeStartTime.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Logical.Sources.SampleTrigger\">
IDEAS.Controls.OBC.CDL.Logical.Sources.SampleTrigger</a>
