...
block VariablePulse "Generate boolean pulse with the width specified by input"
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.RealInput u(
    final min=0,
    final max=1,
    final unit="1")
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.BooleanOutput y
...
protected
  ...
  IDEAS.Controls.OBC.CDL.Discrete.TriggeredSampler triSam
  ...
  IDEAS.Controls.OBC.CDL.Reals.Abs abs1
    "Output the absolute value change"
    annotation (Placement(transformation(extent={{-20,20},{0,40}})));
  IDEAS.Controls.OBC.CDL.Reals.GreaterThreshold greThr(
    final t=deltaU,
    final h=0)
    "Check if there is a sufficiently large change in input value"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));
  IDEAS.Controls.OBC.CDL.Logical.Edge edg2
    "Rising edge when there is a width change"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  IDEAS.Controls.OBC.CDL.Logical.Pre preBre
    "Break loop"
  ...
  block Cycle
    ...
    IDEAS.Controls.OBC.CDL.Interfaces.BooleanInput go
  ...
  equation
    ...
    t_sta = t0 + IDEAS.Utilities.Math.Functions.round(
...
<p align=\"center\">
<img src=\"modelica://IDEAS/Resources/Images/Controls/OBC/CDL/Logical/VariablePulse.png\"
