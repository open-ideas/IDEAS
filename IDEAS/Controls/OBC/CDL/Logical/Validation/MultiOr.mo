...
model MultiOr
  ...
  IDEAS.Controls.OBC.CDL.Logical.MultiOr mulOr0
    "Logical 'MultiOr': 1 input connection y=u"
    annotation (Placement(transformation(extent={{40,60},{60,80}})));
  IDEAS.Controls.OBC.CDL.Logical.MultiOr mulOr1(
    nin=1)
    "Logical 'MultiOr': 1 input connection y=u"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  IDEAS.Controls.OBC.CDL.Logical.MultiOr mulOr2(
    nin=2)
    "Logical 'MultiOr': 2 input connections y=and(u1, u2)"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  IDEAS.Controls.OBC.CDL.Logical.MultiOr mulOr5(
    nin=5)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/MultiOr.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Logical.MultiOr\">
IDEAS.Controls.OBC.CDL.Logical.MultiOr</a>.
</p>
<p>
