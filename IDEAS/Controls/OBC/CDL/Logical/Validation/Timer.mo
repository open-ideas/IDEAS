...
model Timer
  ...
  IDEAS.Controls.OBC.CDL.Logical.Timer noThr
    "Timer that do not compare threshold"
    annotation (Placement(transformation(extent={{20,10},{40,30}})));
  IDEAS.Controls.OBC.CDL.Logical.Timer thrTim(
    final t=0.3)
    "Timer that compares threshold"
    annotation (Placement(transformation(extent={{20,-30},{40,-10}})));
  IDEAS.Controls.OBC.CDL.Logical.Timer thrTim1(
    final t=0.3)
    "Timer that compares threshold"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/Timer.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Logical.Timer\">
IDEAS.Controls.OBC.CDL.Logical.Timer</a>.
</p>
</html>",
      revisions="<html>
<ul>
