...
model Nand
  ...
  IDEAS.Controls.OBC.CDL.Logical.Nand nand1
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/Nand.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Logical.Nand\">
IDEAS.Controls.OBC.CDL.Logical.Nand</a>.
</p>
</html>",
      revisions="<html>
<ul>
