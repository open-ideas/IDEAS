...
model SunRiseSet
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Utilities/Validation/SunRiseSet.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This example includes four instances of the
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Utilities.SunRiseSet\">
IDEAS.Controls.OBC.CDL.Utilities.SunRiseSet</a> block:
