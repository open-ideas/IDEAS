...
model Less
  ...
  IDEAS.Controls.OBC.CDL.Integers.Less intLes
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Less.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Integers.Less\">
IDEAS.Controls.OBC.CDL.Integers.Less</a>.
</p>
</html>",
      revisions="<html>
<ul>
