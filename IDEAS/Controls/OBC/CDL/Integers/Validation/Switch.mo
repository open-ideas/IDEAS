within IDEAS.Controls.OBC.CDL.Integers.Validation;
model Switch "Validation model for the Switch block"
  IDEAS.Controls.OBC.CDL.Integers.Switch integerSwitch
    "Integer switch"
  ...
  IDEAS.Controls.OBC.CDL.Integers.Sources.Constant conInt1(
    k=2)
    "Integer constant"
...
protected
  ...
  IDEAS.Controls.OBC.CDL.Integers.Multiply proInt "Product"
    annotation (Placement(transformation(extent={{0,40},{20,60}})));
  IDEAS.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt1
    "Type converter"
    annotation (Placement(transformation(extent={{-40,-80},{-20,-60}})));
  IDEAS.Controls.OBC.CDL.Integers.Multiply proInt1 "Product"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Switch.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Integers.Switch\">
IDEAS.Controls.OBC.CDL.Integers.Switch</a>.
</p>
<p>
