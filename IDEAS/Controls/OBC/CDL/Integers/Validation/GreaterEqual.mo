...
model GreaterEqual
  ...
  IDEAS.Controls.OBC.CDL.Integers.GreaterEqual intGreEqu
  ...
  IDEAS.Controls.OBC.CDL.Reals.Sources.TimeTable timTabLin1(
    smoothness=IDEAS.Controls.OBC.CDL.Types.Smoothness.ConstantSegments,
    table=[
      0,0;
      0.35,1;
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/GreaterEqual.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Integers.GreaterEqual\">
IDEAS.Controls.OBC.CDL.Integers.GreaterEqual</a>.
</p>
</html>",
      revisions="<html>
<ul>
