...
model Equal
  ...
  IDEAS.Controls.OBC.CDL.Integers.Equal intEqu
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Equal.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://IDEAS.Controls.OBC.CDL.Integers.Equal\">
IDEAS.Controls.OBC.CDL.Integers.Equal</a>.
</p>
</html>",
      revisions="<html>
<ul>
