...
block Change
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.IntegerInput u
  ...
  IDEAS.Controls.OBC.CDL.Interfaces.BooleanOutput up
    "Output that is true when the input increased its value"
    annotation (Placement(transformation(extent={{100,40},{140,80}})));
  IDEAS.Controls.OBC.CDL.Interfaces.BooleanOutput down
