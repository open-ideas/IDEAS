...
record GridType
  ...
  extends IDEAS.Electrical.Data.Interfaces.GridImp(R=CabTyp.RCha .* LenVec*Pha/
        3, X=CabTyp.XCha .* LenVec*Pha/3);
  ...
  parameter IDEAS.Electrical.Data.Interfaces.Cable CabTyp[nNodes]
