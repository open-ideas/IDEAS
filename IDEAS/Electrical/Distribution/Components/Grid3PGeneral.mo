within IDEAS.Electrical.Distribution.Components;
model Grid3PGeneral

protected
  IDEAS.Electrical.Distribution.Components.GridOnly3P gridOnly3P(grid=grid)
...
protected
  ...
  IDEAS.Electrical.BaseClasses.Con3PlusNTo3 con3PlusNTo3_1[gridOnly3P.grid.nNodes]
