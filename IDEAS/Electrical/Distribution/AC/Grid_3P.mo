within IDEAS.Electrical.Distribution.AC;
model Grid_3P "General model for three-phase grid"

protected
  IDEAS.Electrical.Distribution.AC.Components.Grid_3P gridOnly3P(grid=grid)
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  parameter Real gridFreq=50
    "Grid frequency: should normally not be changed when simulating belgian grids!";

public
  replaceable parameter IDEAS.Electrical.Data.Interfaces.GridType grid(Pha=3)
  ...
  /***Everything related to the transfomer***/
    ...
    annotation (Placement(transformation(extent={{-20,-10},{0,10}})));
     replaceable parameter IDEAS.Electrical.Data.Interfaces.TransformerImp transformer
...
protected
  ...
  IDEAS.Electrical.BaseClasses.AC.Con3PlusNTo3 con3PlusNTo3_1[gridOnly3P.grid.nNodes]
