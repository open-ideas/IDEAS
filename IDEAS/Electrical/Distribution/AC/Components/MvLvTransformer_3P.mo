within IDEAS.Electrical.Distribution.AC.Components;
...
protected
  ...
  IDEAS.Electrical.BaseClasses.AC.Con3PlusNTo3 con3PlusNTo3_HV
    annotation (Placement(transformation(extent={{-60,50},{-40,30}})));
  IDEAS.Electrical.BaseClasses.AC.Con3PlusNTo3 con3PlusNTo3_LV annotation (
