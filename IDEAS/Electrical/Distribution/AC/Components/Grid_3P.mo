...
model Grid_3P "Three-fase grid cable-structure"
  replaceable parameter IDEAS.Electrical.Data.Interfaces.GridType grid
  ...
  IDEAS.Electrical.Distribution.AC.BaseClasses.Branch branch[3,Nodes](R=R3, X=
        X3);
  IDEAS.Electrical.Distribution.AC.BaseClasses.Branch neutral[Nodes](R=
