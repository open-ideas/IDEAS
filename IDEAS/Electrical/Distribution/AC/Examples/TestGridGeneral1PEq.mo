within IDEAS.Electrical.Distribution.AC.Examples;
model TestGridGeneral1PEq
  import IDEAS;

  IDEAS.Electrical.Distribution.AC.Examples.Components.SinePower
    risingflankSingle1(amplitude=12000)
    annotation (Placement(transformation(extent={{40,0},{60,20}})));

  IDEAS.Electrical.Distribution.AC.Grid_1PEq grid1PGeneral(
    redeclare IDEAS.Electrical.Data.Grids.TestGrid2Nodes grid,
    redeclare IDEAS.Electrical.Data.TransformerImp.Transfo_160kVA transformer,
    traTCal=true)
