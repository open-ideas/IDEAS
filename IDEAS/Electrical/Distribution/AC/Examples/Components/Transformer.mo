within IDEAS.Electrical.Distribution.AC.Examples.Components;
model Transformer
  import IDEAS;
  ...
  IDEAS.Electrical.Distribution.AC.Components.MvLvTransformer_3P
    transformer_MvLv(redeclare
      IDEAS.Electrical.Data.TransformerImp.Transfo_100kVA transformer)
    annotation (Placement(transformation(extent={{60,0},{40,20}})));
  IDEAS.Electrical.BaseClasses.AC.WattsLaw wattsLaw(numPha=3)
