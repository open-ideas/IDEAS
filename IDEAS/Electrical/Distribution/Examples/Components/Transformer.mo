within IDEAS.Electrical.Distribution.Examples.Components;
model Transformer
  import IDEAS;
  ...
  IDEAS.Electrical.Distribution.Components.Transformer_MvLv transformer_MvLv(
      redeclare IDEAS.Electrical.Data.TransformerImp.Transfo_100kVA transformer)
    annotation (Placement(transformation(extent={{60,0},{40,20}})));
  IDEAS.Electrical.BaseClasses.WattsLaw wattsLaw(numPha=3)
  ...
  inner IDEAS.SimInfoManager sim(redeclare
      IDEAS.BoundaryConditions.Climate.Meteo.Files.min60 detail, redeclare
