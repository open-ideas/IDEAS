within IDEAS.Electrical.Distribution.DC.Examples;
model TestGridDC
  import IDEAS;
extends Modelica.Icons.Example;
  IDEAS.Electrical.Distribution.Components.GridGeneralDC gridGeneralDC(
      redeclare IDEAS.Electrical.Data.Grids.DirectCurrent.TestGrid2Nodes grid)
