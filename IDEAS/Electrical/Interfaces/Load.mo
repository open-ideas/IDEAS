...
model Load "Partial model for a generic load"
  replaceable package PhaseSystem =
    ...
    IDEAS.Electrical.PhaseSystems.PartialPhaseSystem "Phase system"
  ...
  parameter IDEAS.Electrical.Types.Load mode(
    ...
    max=IDEAS.Electrical.Types.Load.VariableZ_y_input) = IDEAS.Electrical.Types.Load.FixedZ_steady_state
  ...
  parameter Modelica.Units.SI.Power P_nominal=0
    "Nominal power (negative if consumed, positive if generated). Used if mode <> IDEAS.Electrical.Types.Load.VariableZ_P_input"
    annotation (Dialog(group="Nominal conditions", enable=mode <> IDEAS.Electrical.Types.Load.VariableZ_P_input));
  ...
  parameter Modelica.Units.SI.Voltage V_nominal(min=0, start=110)
    "Nominal voltage (V_nominal >= 0)" annotation (Evaluate=true, Dialog(group=
          "Nominal conditions", enable=(mode == IDEAS.Electrical.Types.Load.FixedZ_dynamic
           or linearized)));
  parameter IDEAS.Electrical.Types.InitMode initMode(
  min=IDEAS.Electrical.Types.InitMode.zero_current,
  max=IDEAS.Electrical.Types.InitMode.linearized) = IDEAS.Electrical.Types.InitMode.zero_current
  ...
  Modelica.Blocks.Interfaces.RealInput y(min=0, max=1, unit="1")
    if (mode == IDEAS.Electrical.Types.Load.VariableZ_y_input)
  ...
  Modelica.Blocks.Interfaces.RealInput Pow(unit="W")
    if (mode == IDEAS.Electrical.Types.Load.VariableZ_P_input)
    "Power consumed" annotation (Placement(transformation(
        ...
        rotation=180,
        origin={100,0})));
  replaceable IDEAS.Electrical.Interfaces.Terminal terminal(
...
equation
  ...
  if mode==IDEAS.Electrical.Types.Load.FixedZ_steady_state or
     mode==IDEAS.Electrical.Types.Load.FixedZ_dynamic then
    y_internal   = 1;
    P_internal = 0;
  elseif mode==IDEAS.Electrical.Types.Load.VariableZ_y_input then
    P_internal = 0;
  elseif mode==IDEAS.Electrical.Types.Load.VariableZ_P_input then
    y_internal = 1;
  end if;
...
<a href=\"modelica://IDEAS.Examples.ChillerPlant.DataCenterRenewables\">
IDEAS.Examples.ChillerPlant.DataCenterRenewables</a>.
</li>
<li>
September 4, 2014, by Michael Wetter:<br/>
Changed the parameter from <code>linear</code> to <code>linearized</code>
because <code>IDEAS.Fluid</code> also uses <code>linearized</code>.
...
<a href=\"modelica://IDEAS.Electrical.Interfaces.Terminal\">
IDEAS.Electrical.Interfaces.Terminal</a>
...
<a href=\"modelica://IDEAS.Electrical.Types.Load\">IDEAS.Electrical.Types.Load</a>:
</p>
...
<!-- ************ -->
<tr>
<td>IDEAS.Electrical.Types.Load.FixedZ_steady_state</td>
...
<!-- ************ -->
<tr>
<td>IDEAS.Electrical.Types.Load.FixedZ_dynamic</td>
...
<!-- ************ -->
<tr>
<td>IDEAS.Electrical.Types.Load.VariableZ_P_input</td>
...
<!-- ************ -->
<tr>
<td>IDEAS.Electrical.Types.Load.VariableZ_y_input</td>
