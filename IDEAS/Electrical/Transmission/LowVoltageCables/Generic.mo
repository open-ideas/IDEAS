...
record Generic "Data record for a generic low voltage cable"
  ...
  parameter IDEAS.Electrical.Types.CharacteristicResistance RCha(start=0)
    "Characteristic resistance of the cable";
  parameter IDEAS.Electrical.Types.CharacteristicReactance XCha(start=0)
  ...
  redeclare function extends lineResistance
   ...
   input IDEAS.Electrical.Transmission.LowVoltageCables.Generic cable
