...
function selectCable_low "This function is used to automatically select the
  ...
  output IDEAS.Electrical.Transmission.LowVoltageCables.Generic cable "Cable";
protected
  parameter Real safety_factor = 1.2;
  Modelica.Units.SI.Current I_nominal
    "Nominal current flowing through the line";
  IDEAS.Electrical.Transmission.LowVoltageCables.Cu10 cu10;
  IDEAS.Electrical.Transmission.LowVoltageCables.Cu20 cu20;
  IDEAS.Electrical.Transmission.LowVoltageCables.Cu25 cu25;
  IDEAS.Electrical.Transmission.LowVoltageCables.Cu35 cu35;
  IDEAS.Electrical.Transmission.LowVoltageCables.Cu50 cu50;
  IDEAS.Electrical.Transmission.LowVoltageCables.Cu95 cu95;
  IDEAS.Electrical.Transmission.LowVoltageCables.Cu100 cu100;
algorithm

  assert(Transmission.Functions.selectVoltageLevel(V_nominal) == IDEAS.Electrical.Types.VoltageLevel.Low,
  "In function IDEAS.Electrical.Transmission.Functions.selectCable_low,
...
IDEAS.Electrical.Transmission.LowVoltageCables</a>.
</p>
</html>"));
end selectCable_low;
