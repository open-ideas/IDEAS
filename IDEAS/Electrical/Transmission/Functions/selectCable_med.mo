within IDEAS.Electrical.Transmission.Functions;
function selectCable_med "This function is used to automatically select the
  ...
  output IDEAS.Electrical.Transmission.MediumVoltageCables.Generic cable "Cable";
protected
  parameter Real safety_factor = 1.2;
  Modelica.Units.SI.Current I_nominal
    "Nominal current flowing through the line";
  IDEAS.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10 Al10;
  IDEAS.Electrical.Transmission.MediumVoltageCables.Annealed_Al_30 Al30;
  IDEAS.Electrical.Transmission.MediumVoltageCables.Annealed_Al_40 Al40;
  IDEAS.Electrical.Transmission.MediumVoltageCables.Annealed_Al_350 Al350;
  IDEAS.Electrical.Transmission.MediumVoltageCables.Annealed_Al_500 Al500;
  IDEAS.Electrical.Transmission.MediumVoltageCables.Annealed_Al_1000 Al1000;
  IDEAS.Electrical.Transmission.MediumVoltageCables.Annealed_Al_1500 Al1500;
algorithm

  assert(Transmission.Functions.selectVoltageLevel(V_nominal) == IDEAS.Electrical.Types.VoltageLevel.Medium,
  "In function IDEAS.Electrical.Transmission.Functions.selectCable_med,
...
"Warning: In function IDEAS.Electrical.Transmission.Functions.selectCable_med,
