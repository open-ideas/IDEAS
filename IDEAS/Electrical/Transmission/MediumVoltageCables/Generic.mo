within IDEAS.Electrical.Transmission.MediumVoltageCables;
record Generic "Data record for a generic medium voltage cable"
  extends Modelica.Icons.MaterialProperty;
  extends IDEAS.Electrical.Transmission.BaseClasses.BaseCable;
  parameter String size(start="")
    "AWG or kcmil code representing the conductor size";
  parameter IDEAS.Electrical.Types.CharacteristicResistance Rdc(start=0)
  ...
  redeclare function extends lineResistance
    "Function that computes the resistance of a cable"
      input IDEAS.Electrical.Transmission.MediumVoltageCables.Generic cable
      "Record that contains cable properties";
  algorithm
    R := l*cable.Rdc*IDEAS.Electrical.Transmission.Functions.R_AC_correction(
...
<a href=\"modelica://IDEAS.Electrical.Transmission.Functions.R_AC_correction\">
IDEAS.Electrical.Transmission.Functions.R_AC_correction</a> for more details.
</p>
