...
record PartialGrid "Partial model that represents a generalized grid"
  ...
  parameter Modelica.Units.SI.Length l[nLinks,1](each min=0)
    "Length of the cable";
  replaceable IDEAS.Electrical.Transmission.BaseClasses.BaseCable cables[nLinks]
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IDEAS/Resources/Images/Electrical/Transmission/Grids/partialGrid.png\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
