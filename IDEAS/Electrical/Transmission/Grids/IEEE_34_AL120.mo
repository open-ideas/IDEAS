within IDEAS.Electrical.Transmission.Grids;
record IEEE_34_AL120 "Grid model inspired to the IEEE 34 Node test feeder"
  extends IDEAS.Electrical.Transmission.Grids.PartialGrid(
    nNodes=34,
    nLinks=33,
    ...
    redeclare IDEAS.Electrical.Transmission.LowVoltageCables.Generic cables=
...
<p><img alt=\"alt-image\" src=\"modelica://IDEAS/Resources/Images/Electrical/Transmission/Grids/IEEE_34.png\"/></p>
</html>", revisions="<html>
<ul>
<li>
