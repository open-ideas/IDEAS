...
partial model PartialNetwork "Partial model that represent an electric network"
  ...
  replaceable parameter IDEAS.Electrical.Transmission.Grids.PartialGrid grid
  ...
  replaceable IDEAS.Electrical.Interfaces.BaseTerminal terminal[grid.nNodes]
    "Electric terminals for each node of the network"
    annotation (Placement(transformation(extent={{90,-10},{110,10}})));
  replaceable IDEAS.Electrical.Transmission.BaseClasses.PartialBaseLine lines[grid.nLinks](
    each mode=IDEAS.Electrical.Types.CableMode.commercial,
...
<a href=\"modelica://IDEAS.Electrical.Transmission.Grids.PartialGrid\">
...
<a href=\"modelica://IDEAS.Electrical.Transmission.BaseClasses.PartialBaseLine\">
IDEAS.Electrical.Transmission.BaseClasses.PartialBaseLine</a> that represent the cables
in the grid.
</p>
<h4>Note:</h4>
<p>
