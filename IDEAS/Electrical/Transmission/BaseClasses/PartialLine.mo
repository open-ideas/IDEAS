...
partial model PartialLine "Partial cable line dispersion model"
  extends IDEAS.Electrical.Interfaces.PartialTwoPort;
  extends IDEAS.Electrical.Transmission.BaseClasses.PartialBaseLine;
...
<p>
This partial model extends the model <a href=\"modelica://IDEAS.Electrical.Transmission.BaseClasses.PartialBaseLine\">
IDEAS.Electrical.Transmission.BaseClasses.PartialBaseLine</a>.
It adds two generalized electric connectors.
</p>
<h4>Note:</h4>
<p>
See <a href=\"modelica://IDEAS.Electrical.Transmission.BaseClasses.PartialBaseLine\">
IDEAS.Electrical.Transmission.BaseClasses.PartialBaseLine</a> for more information.
</p>
</html>"));
end PartialLine;
