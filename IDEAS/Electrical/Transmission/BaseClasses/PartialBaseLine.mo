within IDEAS.Electrical.Transmission.BaseClasses;
partial model PartialBaseLine "Partial cable line dispersion model"
  ...
  parameter IDEAS.Electrical.Types.Load modelMode=IDEAS.Electrical.Types.Load.FixedZ_steady_state
    "Select between steady state and dynamic model"
    annotation(Evaluate=true, Dialog(tab="Model", group="Assumptions", enable = use_C), choices(choice=IDEAS.Electrical.Types.Load.FixedZ_steady_state
        "Steady state", choice=IDEAS.Electrical.Types.Load.FixedZ_dynamic "Dynamic"));
  ...
  parameter IDEAS.Electrical.Types.CableMode mode=IDEAS.Electrical.Types.CableMode.automatic
  ...
  replaceable parameter
    IDEAS.Electrical.Transmission.LowVoltageCables.Generic
     commercialCable constrainedby
    IDEAS.Electrical.Transmission.BaseClasses.BaseCable
    "Commercial cables options"
    annotation(Evaluate=true, Dialog(tab="Tech. specification", group="Manual mode",
    enable = mode == IDEAS.Electrical.Types.CableMode.commercial),
...
<a href=\"modelica://IDEAS.Electrical.Transmission.BaseClasses.BaseCable\">
IDEAS.Electrical.Transmission.BaseClasses.BaseCable</a> such as (
<a href=\"modelica://IDEAS.Electrical.Transmission.LowVoltageCables.Generic\">
IDEAS.Electrical.Transmission.LowVoltageCables.Generic</a> or
<a href=\"modelica://IDEAS.Electrical.Transmission.MediumVoltageCables.Generic\">
IDEAS.Electrical.Transmission.MediumVoltageCables.Generic</a>).
...
<a href=\"modelica://IDEAS.Electrical.Transmission.LowVoltageCables\">
IDEAS.Electrical.Transmission.LowVoltageCables</a> and
<a href=\"modelica://IDEAS.Electrical.Transmission.MediumVoltageCables\">
IDEAS.Electrical.Transmission.MediumVoltageCables</a>.
</p>
...
properties can be found in <a href=\"modelica://IDEAS.Electrical.Transmission.Functions\">
IDEAS.Electrical.Transmission.Functions</a>.
</p>
<p>
The parameter <code>commercialCable</code> is assumed to be
<a href=\"modelica://IDEAS.Electrical.Transmission.LowVoltageCables.Generic\">
IDEAS.Electrical.Transmission.LowVoltageCables.Generic</a>.
The parameter is replaceable so it can be redeclared using a different type, for example
<a href=\"modelica://IDEAS.Electrical.Transmission.MediumVoltageCables.Generic\">
IDEAS.Electrical.Transmission.MediumVoltageCables.Generic</a>.<br/>
The example models
<a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACLineMedium\">
IDEAS.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACLineMedium</a> and
<a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACSimpleGridMedium\">
IDEAS.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACSimpleGridMedium</a>
