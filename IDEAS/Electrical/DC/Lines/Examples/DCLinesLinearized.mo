within IDEAS.Electrical.DC.Lines.Examples;
model DCLinesLinearized
  "Example model to test the possible combinations between line and load models"
  extends IDEAS.Electrical.DC.Lines.Examples.DCLines(linearLoads = true);

  annotation (Documentation(info="<html>
<p>
This model is the linearized version of the model
<a href=\"modelica://IDEAS.Electrical.DC.Lines.Examples.DCLines\">
IDEAS.Electrical.DC.Lines.Examples.DCLines</a> and
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Electrical/DC/Lines/Examples/DCLinesLinearized.mos"
        "Simulate and plot"));
