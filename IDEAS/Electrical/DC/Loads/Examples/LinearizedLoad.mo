within IDEAS.Electrical.DC.Loads.Examples;
model LinearizedLoad "Example model to check the linearized load model"
  ...
  IDEAS.Electrical.DC.Loads.Conductor NonlinearLoad(
    linearized=false,
  ...
  IDEAS.Electrical.DC.Loads.Conductor LinearLoad(
    mode=IDEAS.Electrical.Types.Load.VariableZ_P_input,
    V_nominal=100,
    linearized=true,
...
equation
  ...
  annotation (            experiment(StopTime=1.0, Tolerance=1e-06),
          ...
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/DC/Loads/Examples/LinearizedLoad.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>This example demonstrates the use of a linealized load model <a href=\"modelica://IDEAS.Electrical.DC.Loads.Conductor\">IDEAS.Electrical.DC.Loads.Conductor</a>. </p>
...
<p align=\"center\"><img src=\"modelica://IDEAS/Resources/Images/Electrical/DC/Loads/Examples/DCload_approx.png\" alt=\"image\"/> </p>
