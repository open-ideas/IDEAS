within IDEAS.Electrical.DC.Sources.Examples;
model VoltageSource "Example for the variable voltage source model"
  extends Modelica.Icons.Example;
  Modelica.Electrical.Analog.Basic.Ground ground
    annotation (Placement(transformation(extent={{-92,-40},{-72,-20}})));
  IDEAS.Electrical.DC.Loads.Resistor res(R=0.5, V_nominal=12)
    "Resistance"
    annotation (Placement(transformation(extent={{26,-10},{46,10}})));
  IDEAS.Electrical.DC.Sources.VoltageSource sou "Voltage source"
    annotation (Placement(transformation(extent={{-82,-10},{-62,10}})));
  IDEAS.Electrical.DC.Lines.TwoPortResistance lin(R=0.5)
    "Transmission line"
    annotation (Placement(transformation(extent={{-52,-10},{-32,10}})));
  IDEAS.Electrical.DC.Sensors.GeneralizedSensor sen "Sensor"
...
Added model and documentation.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/DC/Sources/Examples/VoltageSource.mos"
        "Simulate and plot"),
