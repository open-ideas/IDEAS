within IDEAS.Electrical.DC.Conversion.Examples;
model DCDCConverter "Test model DC to DC converter"
  extends Modelica.Icons.Example;
  IDEAS.Electrical.DC.Loads.Conductor resistor(
  ...
  IDEAS.Electrical.DC.Sources.ConstantVoltage sou(V=120)
    "Voltage source"
    annotation (Placement(transformation(extent={{-90,-10},{-70,10}})));
  IDEAS.Electrical.DC.Conversion.DCDCConverter conDCDC(
    VHigh=120,
    VLow=60,
    eta=0.9,
    i_n(start=0)) "DC/DC transformer"
    annotation (Placement(transformation(extent={{-20,-10},{0,10}})));
  IDEAS.Electrical.DC.Loads.Conductor conductor(mode=IDEAS.Electrical.Types.Load.VariableZ_P_input,
      V_nominal=60,
  ...
  IDEAS.Electrical.DC.Sensors.GeneralizedSensor sen "Power sensor"
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/DC/Conversion/Examples/DCDCConverter.mos"
        "Simulate and plot"),
