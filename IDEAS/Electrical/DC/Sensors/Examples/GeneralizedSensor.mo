within IDEAS.Electrical.DC.Sensors.Examples;
model GeneralizedSensor "Example model for generalized sensor"
  ...
  IDEAS.Electrical.DC.Loads.Conductor loa(V_nominal=120, P_nominal=120)
    "Constant load"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  IDEAS.Electrical.DC.Sources.ConstantVoltage sou(V=120) "Voltage source"
...
__Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/DC/Sensors/Examples/GeneralizedSensor.mos"
        "Simulate and plot"));
