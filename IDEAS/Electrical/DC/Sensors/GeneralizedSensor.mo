within IDEAS.Electrical.DC.Sensors;
...
equation
  ...
  V = IDEAS.Electrical.PhaseSystems.TwoConductor.systemVoltage(terminal_n.v);
  I = IDEAS.Electrical.PhaseSystems.TwoConductor.systemCurrent(terminal_n.i);
  P = IDEAS.Electrical.PhaseSystems.TwoConductor.activePower(v=terminal_n.v, i=terminal_n.i);
