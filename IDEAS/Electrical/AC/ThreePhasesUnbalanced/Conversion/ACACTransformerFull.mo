within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Conversion;
model ACACTransformerFull "AC AC transformer detailed equivalent circuit (YY)"
  extends
    IDEAS.Electrical.AC.ThreePhasesUnbalanced.Conversion.BaseClasses.PartialConverterYY(
    redeclare IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformerFull conv1(
      VHigh=VHigh/sqrt(3),
      VLow=VLow/sqrt(3),
      f = f,
      VABase=VABase,
      ...
      ground_1=ground_1,
      ground_2=ground_2),
    redeclare IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformerFull conv2(
      VHigh=VHigh/sqrt(3),
      VLow=VLow/sqrt(3),
      f = f,
      VABase=VABase,
      ...
      ground_1=ground_1,
      ground_2=ground_2),
    redeclare IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformerFull conv3(
      VHigh=VHigh/sqrt(3),
      VLow=VLow/sqrt(3),
      f = f,
      VABase=VABase,
  ...
  parameter IDEAS.Electrical.Types.PerUnit R1(min=0)
    "Resistance on side 1 of the transformer (pu)";
  parameter IDEAS.Electrical.Types.PerUnit L1(min=0)
    "Inductance on side 1 of the transformer (pu)";
  parameter IDEAS.Electrical.Types.PerUnit R2(min=0)
    "Resistance on side 2 of the transformer (pu)";
  parameter IDEAS.Electrical.Types.PerUnit L2(min=0)
  ...
  parameter IDEAS.Electrical.Types.PerUnit Rm(min=0,start=0)
    "Magnetization resistance (pu)" annotation(Dialog(group="Magnetization", enable = magEffects));
  parameter IDEAS.Electrical.Types.PerUnit Lm(min=0,start=0)
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IDEAS/Resources/Images/Electrical/AC/ThreePhasesUnbalanced/Conversion/BaseClasses/YY.png\"/>
</p>
<h4>Note:</h4>
<p>
This model reuses models from
<a href=\"modelica://IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformerFull\">
IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformerFull</a>.
</p>
<p>
See
<a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesUnbalanced.Conversion.BaseClasses.PartialConverterYY\">
IDEAS.Electrical.AC.ThreePhasesUnbalanced.Conversion.BaseClasses.PartialConverterYY</a> for
