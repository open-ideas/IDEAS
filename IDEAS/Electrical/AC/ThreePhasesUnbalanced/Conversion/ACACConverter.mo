...
model ACACConverter "AC AC converter single phase systems (YY)"
  extends
    ...
    redeclare IDEAS.Electrical.AC.OnePhase.Conversion.ACACConverter conv1(
      conversionFactor=conversionFactor,
      eta=eta,
      ground_1=ground_1,
      ground_2=ground_2),
    redeclare IDEAS.Electrical.AC.OnePhase.Conversion.ACACConverter conv2(
      conversionFactor=conversionFactor,
      eta=eta,
      ground_1=ground_1,
      ground_2=ground_2),
    redeclare IDEAS.Electrical.AC.OnePhase.Conversion.ACACConverter conv3(
      conversionFactor=conversionFactor,
      eta=eta,
      ground_1=ground_1,
      ground_2=ground_2));
...
<a href=\"modelica://IDEAS.Electrical.AC.OnePhase.Conversion.ACACConverter\">
IDEAS.Electrical.AC.OnePhase.Conversion.ACACConverter</a>.
</p>
<p>
See
