...
model TransformerStepUpYD
  ...
  V_primary = 4160,
  V_secondary = 12470,
  redeclare IDEAS.Electrical.AC.ThreePhasesUnbalanced.Sensors.ProbeDelta probe_2,
  redeclare
      IDEAS.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformerStepUpYD
  tra(VHigh=V_primary,
      VLow=V_secondary,
      XoverR=6,
...
<a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformerStepUpYD\">
IDEAS.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformerStepUpYD</a> model.
</p>
<h4>Note:</h4>
<p>
...
__Dymola_Commands(file=
 "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Conversion/Examples/TransformerStepUpYD.mos"
        "Simulate and plot"));
