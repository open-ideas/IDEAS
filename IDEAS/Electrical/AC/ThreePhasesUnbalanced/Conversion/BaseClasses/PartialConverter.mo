...
partial model PartialConverter "Partial model of a transformer"
  ...
  replaceable IDEAS.Electrical.Interfaces.PartialConversion
    conv1 constrainedby IDEAS.Electrical.Interfaces.PartialConversion(
    redeclare package PhaseSystem_p =
        IDEAS.Electrical.PhaseSystems.OnePhase,
  ...
  replaceable IDEAS.Electrical.Interfaces.PartialConversion
    conv2 constrainedby IDEAS.Electrical.Interfaces.PartialConversion(
    redeclare package PhaseSystem_p =
        IDEAS.Electrical.PhaseSystems.OnePhase,
    redeclare package PhaseSystem_n =
        IDEAS.Electrical.PhaseSystems.OnePhase,
  ...
  replaceable IDEAS.Electrical.Interfaces.PartialConversion
    conv3 constrainedby IDEAS.Electrical.Interfaces.PartialConversion(
    redeclare package PhaseSystem_p =
        IDEAS.Electrical.PhaseSystems.OnePhase,
    redeclare package PhaseSystem_n =
        IDEAS.Electrical.PhaseSystems.OnePhase,
