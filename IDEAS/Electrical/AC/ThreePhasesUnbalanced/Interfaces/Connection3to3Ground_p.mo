within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Interfaces;
model Connection3to3Ground_p
  ...
  IDEAS.Electrical.AC.OnePhase.Interfaces.Terminal_p ground4
...
<code>IDEAS.Electrical.AC.ThreePhasesUnbalanced.InterfacesConnection3to4_p</code>
