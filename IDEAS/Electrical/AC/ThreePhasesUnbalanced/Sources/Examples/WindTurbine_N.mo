within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Sources.Examples;
model WindTurbine_N "Example for the WindTurbine AC model with neutral cable"
  extends Modelica.Icons.Example;
  IDEAS.Electrical.AC.ThreePhasesUnbalanced.Sources.WindTurbine_N tur(
    table=[3.5, 0;
           5.5,   100;
           12, 900;
           14, 1000;
  ...
  IDEAS.Electrical.AC.ThreePhasesUnbalanced.Lines.Line_N line(
    l=200,
    P_nominal=5000,
    V_nominal=480)
...
Created model and documentation
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Sources/Examples/WindTurbine_N.mos"
        "Simulate and plot"));
end WindTurbine_N;
