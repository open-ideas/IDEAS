...
model WindTurbine "Example for the WindTurbine AC model"
  ...
  IDEAS.Electrical.AC.ThreePhasesUnbalanced.Sources.WindTurbine tur(
    table=[3.5, 0;
           5.5,   100;
           12, 900;
           14, 1000;
  ...
  IDEAS.Electrical.AC.ThreePhasesUnbalanced.Lines.Line line(
    l=200,
    P_nominal=5000,
    V_nominal=480)
...
Created model and documentation
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Sources/Examples/WindTurbine.mos"
        "Simulate and plot"));
end WindTurbine;
