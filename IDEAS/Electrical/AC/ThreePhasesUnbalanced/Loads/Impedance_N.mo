...
model Impedance_N
  ...
  extends BaseClasses.Impedance_N(
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Impedance load1,
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Impedance load2,
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Impedance load3);
equation
...
<a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.Impedance_N\">
IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.Impedance_N</a>
and uses the load model from the package
<a href=\"modelica://IDEAS.Electrical.AC.OnePhase.Loads.Impedance\">
IDEAS.Electrical.AC.OnePhase.Loads.Impedance</a>.
