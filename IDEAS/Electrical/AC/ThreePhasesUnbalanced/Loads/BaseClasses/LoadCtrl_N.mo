...
partial model LoadCtrl_N
  ...
  extends
    IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.BaseLoadCtrl;
  IDEAS.Electrical.AC.ThreePhasesUnbalanced.Interfaces.Terminal4_n terminal
    "Connector for three-phase unbalanced systems with neutral cable"
    annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
  IDEAS.Electrical.AC.ThreePhasesUnbalanced.Interfaces.Connection3to4_n
...
<a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.PartialLoadCtrl\">
IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.PartialLoadCtrl</a>.
</li>
<li>
