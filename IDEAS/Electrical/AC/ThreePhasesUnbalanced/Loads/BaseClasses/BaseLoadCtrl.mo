within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses;
partial model BaseLoadCtrl
  "Partial model of a three-phase unbalanced load with voltage controllers"
  extends IDEAS.Electrical.Interfaces.PartialPluggableUnbalanced;
  parameter IDEAS.Electrical.Types.LoadConnection loadConn=
    IDEAS.Electrical.Types.LoadConnection.wye_to_wyeg
  ...
  parameter IDEAS.Electrical.Types.Load mode(
    min=IDEAS.Electrical.Types.Load.FixedZ_steady_state,
    max=IDEAS.Electrical.Types.Load.VariableZ_y_input)=
    IDEAS.Electrical.Types.Load.FixedZ_steady_state "Parameters that specifies the mode of the load (e.g., steady state,
  ...
  parameter Modelica.Units.SI.Power P_nominal=0
    "Nominal power (negative if consumed, positive if generated)" annotation (
      Dialog(group="Nominal conditions", enable=mode <> IDEAS.Electrical.Types.Load.VariableZ_P_input));
  ...
  parameter Types.InitMode initMode=IDEAS.Electrical.Types.InitMode.zero_current
    "Initialization mode for homotopy operator"
    annotation (Dialog(tab="Initialization"));
  replaceable IDEAS.Electrical.Interfaces.Load load1(
    redeclare package PhaseSystem = IDEAS.Electrical.PhaseSystems.OnePhase,
    redeclare IDEAS.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
  ...
  replaceable IDEAS.Electrical.Interfaces.Load load2(
    redeclare package PhaseSystem = IDEAS.Electrical.PhaseSystems.OnePhase,
    redeclare IDEAS.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
    final linearized=linearized,
    final mode=mode,
  ...
  replaceable IDEAS.Electrical.Interfaces.Load load3(
    redeclare package PhaseSystem = IDEAS.Electrical.PhaseSystems.OnePhase,
    redeclare IDEAS.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
    final linearized=linearized,
    final mode=mode,
  ...
  Modelica.Blocks.Interfaces.RealInput y1  if plugPhase1 and
    mode == IDEAS.Electrical.Types.Load.VariableZ_y_input
  ...
  Modelica.Blocks.Interfaces.RealInput Pow1(unit="W") if plugPhase1 and
    mode == IDEAS.Electrical.Types.Load.VariableZ_P_input "Power consumed"
  ...
  Modelica.Blocks.Interfaces.RealInput Pow3(unit="W") if plugPhase3 and
    mode == IDEAS.Electrical.Types.Load.VariableZ_P_input "Power consumed"
        ...
        rotation=180,
        origin={120,-80})));
  IDEAS.Electrical.Utilities.VoltageControl vCTRL_1(
    redeclare package PhaseSystem = IDEAS.Electrical.PhaseSystems.OnePhase,
    redeclare IDEAS.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
    vThresh=vThresh,
    tDelay=tDelay,
  ...
  IDEAS.Electrical.Utilities.VoltageControl vCTRL_2(
    redeclare package PhaseSystem = IDEAS.Electrical.PhaseSystems.OnePhase,
    redeclare IDEAS.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
    vThresh=vThresh,
    tDelay=tDelay,
  ...
  IDEAS.Electrical.Utilities.VoltageControl vCTRL_3(
    redeclare package PhaseSystem = IDEAS.Electrical.PhaseSystems.OnePhase,
    redeclare IDEAS.Electrical.AC.OnePhase.Interfaces.Terminal_n terminal,
    vThresh=vThresh,
    tDelay=tDelay,
...
equation
  ...
  if mode==IDEAS.Electrical.Types.Load.VariableZ_P_input then
    if plugPhase1 and voltageCtrl then
...
<a href=\"modelica://IDEAS.Electrical.Utilities.VoltageControl\">here</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
...
<code>mode &lt;&gt; IDEAS.Electrical.Types.Load.VariableZ_P_input</code>.
This avoids a warning during translation of
<a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.Inductive\">
IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.Inductive</a>.
</li>
<li>
