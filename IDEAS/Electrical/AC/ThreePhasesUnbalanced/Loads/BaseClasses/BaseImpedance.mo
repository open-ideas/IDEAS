...
partial model BaseImpedance
  ...
  replaceable IDEAS.Electrical.AC.OnePhase.Loads.Impedance
    load1(
    inductive=inductive,
    R=R,
    L=L,
  ...
  IDEAS.Electrical.AC.ThreePhasesUnbalanced.Interfaces.WyeToDelta
  ...
  IDEAS.Electrical.AC.ThreePhasesUnbalanced.Interfaces.WyeToWyeGround
