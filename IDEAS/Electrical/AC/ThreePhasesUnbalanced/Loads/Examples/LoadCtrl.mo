...
model LoadCtrl
  ...
  Lines.Line_N line1(
    mode=IDEAS.Electrical.Types.CableMode.commercial,
    redeclare IDEAS.Electrical.Transmission.LowVoltageCables.Cu10
      commercialCable,
    l=400,
    P_nominal=10000,
...
equation
  ...
  annotation (    experiment(Tolerance=1e-6, StopTime=10.0),
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Loads/Examples/LoadCtrl.mos"
        "Simulate and plot"),
