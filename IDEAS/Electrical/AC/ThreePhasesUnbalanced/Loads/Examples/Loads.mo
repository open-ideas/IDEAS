...
model Loads "This model tests the load models without neutral cable connection"
  ...
  Inductive loaRL(mode=IDEAS.Electrical.Types.Load.VariableZ_P_input,
    V_nominal=480) "Inductive load"
    annotation (Placement(transformation(extent={{-8,-40},{12,-20}})));
  Capacitive loaRC(mode=IDEAS.Electrical.Types.Load.VariableZ_P_input,
...
Created model from previus version and added documentation.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Loads/Examples/Loads.mos"
        "Simulate and plot"));
end Loads;
