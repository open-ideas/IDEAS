within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.Examples;
model Loads_N
  ...
  Resistive_N loaR_N(mode=IDEAS.Electrical.Types.Load.VariableZ_P_input,
    V_nominal=480) "Resistive load with neutral cable"
    annotation (Placement(transformation(extent={{-8,-10},{12,10}})));
  Inductive_N loaRL_N(mode=IDEAS.Electrical.Types.Load.VariableZ_P_input,
      pf=0.9,
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IDEAS/Resources/Images/Electrical/AC/ThreePhasesUnbalanced/Loads/Examples/unbalancedLoads.png\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
...
Created model from previus version and added documentation.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Loads/Examples/Loads_N.mos"
        "Simulate and plot"));
end Loads_N;
