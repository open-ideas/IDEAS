...
model Resistive_N
  ...
  extends BaseClasses.LoadCtrl_N(
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Resistive load1,
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Resistive load2,
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Resistive load3);
equation
