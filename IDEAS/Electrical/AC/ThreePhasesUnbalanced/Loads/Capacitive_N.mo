within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads;
model Capacitive_N
  "Model of a three-phase unbalanced capacitive load with neutral cable"
  extends BaseClasses.LoadCtrl_N(
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Capacitive load1(pf=pf,
        use_pf_in=use_pf_in),
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Capacitive load2(pf=pf,
        use_pf_in=use_pf_in),
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Capacitive load3(pf=pf,
        use_pf_in=use_pf_in));
...
<a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.LoadCtrl_N\">
IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.LoadCtrl_N</a>
and uses the load model from the package
<a href=\"modelica://IDEAS.Electrical.AC.OnePhase.Loads\">
IDEAS.Electrical.AC.OnePhase.Loads</a>.
...
<p>
For more information, see <a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.LoadCtrl_N\">
IDEAS.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses.LoadCtrl_N</a> and
<a href=\"modelica://IDEAS.Electrical.AC.OnePhase.Loads.Capacitive\">
IDEAS.Electrical.AC.OnePhase.Loads.Capacitive</a>.
</p>
</html>"));
end Capacitive_N;
