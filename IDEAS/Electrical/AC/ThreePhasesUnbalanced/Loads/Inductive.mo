...
model Inductive
  ...
  extends BaseClasses.LoadCtrl(
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Inductive load1(
      pf=pf,
      use_pf_in=use_pf_in),
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Inductive load2(
      pf=pf,
      use_pf_in=use_pf_in),
    redeclare IDEAS.Electrical.AC.OnePhase.Loads.Inductive load3(
      pf=pf,
      use_pf_in=use_pf_in));
