within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Lines.Examples;
model ACSimpleGrid_N
  "Test model for a network model for three-phase unbalanced systems with neutral cable"
  extends Modelica.Icons.Example;
  Network_N network(
    redeclare IDEAS.Electrical.Transmission.Grids.TestGrid2Nodes grid,
    V_nominal=480)
...
__Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Lines/Examples/ACSimpleGrid_N.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IDEAS/Resources/Images/Electrical/Transmission/Grids/testGrid2Nodes.png\"/>
</p>
</html>"));
end ACSimpleGrid_N;
