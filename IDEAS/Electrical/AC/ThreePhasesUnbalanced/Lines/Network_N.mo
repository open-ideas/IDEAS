...
model Network_N "Three phases unbalanced AC network with neutral cable"
  extends Transmission.BaseClasses.PartialNetwork(
    redeclare
      IDEAS.Electrical.AC.ThreePhasesUnbalanced.Interfaces.Terminal4_p terminal,
    redeclare replaceable Transmission.Grids.TestGrid2Nodes grid,
    redeclare IDEAS.Electrical.AC.ThreePhasesUnbalanced.Lines.Line_N lines(
...
equation
  ...
  for i in 1:grid.nNodes loop
    VAbs[1,i] = IDEAS.Electrical.PhaseSystems.OnePhase.systemVoltage(terminal[i].phase[1].v - terminal[i].phase[4].v);
    VAbs[2,i] = IDEAS.Electrical.PhaseSystems.OnePhase.systemVoltage(terminal[i].phase[2].v - terminal[i].phase[4].v);
    VAbs[3,i] = IDEAS.Electrical.PhaseSystems.OnePhase.systemVoltage(terminal[i].phase[3].v - terminal[i].phase[4].v);
  end for;
  annotation (
...
<p>
See <a href=\"modelica://IDEAS.Electrical.Transmission.BaseClasses.PartialNetwork\">
IDEAS.Electrical.Transmission.BaseClasses.PartialNetwork</a>
for information about the network model.
</p>
<p>
See <a href=\"modelica://IDEAS.Electrical.Transmission.Grids.PartialGrid\">
IDEAS.Electrical.Transmission.Grids.PartialGrid</a>
