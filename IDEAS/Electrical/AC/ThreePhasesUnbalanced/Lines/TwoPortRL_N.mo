...
model TwoPortRL_N
  ...
  parameter IDEAS.Electrical.Types.Load mode(
    ...
    max=IDEAS.Electrical.Types.Load.FixedZ_dynamic) = IDEAS.Electrical.Types.Load.FixedZ_steady_state
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IDEAS/Resources/Images/Electrical/AC/ThreePhasesUnbalanced/Lines/twoPortRL_N.png\"/>
</p>
