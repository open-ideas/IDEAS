within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Lines;
model TwoPortMatrixRLC_N
  "PI model of a line parameterized with impedance and admittance matrices and neutral line"
  extends IDEAS.Electrical.AC.ThreePhasesUnbalanced.Interfaces.TwoPort_N(
  ...
  Modelica.Units.SI.Voltage v1_n[2](
    start=IDEAS.Electrical.PhaseSystems.OnePhase.phaseVoltages(V_nominal/
        sqrt(3), phi=0),
  ...
  Modelica.Units.SI.Voltage v4_n[2](
    start=IDEAS.Electrical.PhaseSystems.OnePhase.phaseVoltages(0),
...
protected
  function productAC1p = IDEAS.Electrical.PhaseSystems.OnePhase.product
...
for
<a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesUnbalanced.Validation.IEEETests.Test4NodesFeeder.BalancedStepDown.YD\">
IDEAS.Electrical.AC.ThreePhasesUnbalanced.Validation.IEEETests.Test4NodesFeeder.BalancedStepDown.YD</a>.
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IDEAS/Resources/Images/Electrical/AC/ThreePhasesUnbalanced/Lines/twoPortRLCMatrix_N.png\"/>
</p>
...
<p>
This model is a more detailed version of the model <a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesUnbalanced.Lines.TwoPortMatrixRL_N\">
IDEAS.Electrical.AC.ThreePhasesUnbalanced.Lines.TwoPortMatrixRL_N</a> that includes
