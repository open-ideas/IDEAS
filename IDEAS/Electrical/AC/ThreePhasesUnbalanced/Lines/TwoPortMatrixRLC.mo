...
model TwoPortMatrixRLC
  ...
  extends IDEAS.Electrical.AC.ThreePhasesUnbalanced.Interfaces.TwoPort(
...
protected
  ...
  Modelica.Units.SI.Current Isr[3,2](start=zeros(3, IDEAS.Electrical.PhaseSystems.OnePhase.n),
      each stateSelect=StateSelect.prefer)
    "Currents that pass through the lines";
  Modelica.Units.SI.Current Ish_p[3,2](start=zeros(3, IDEAS.Electrical.PhaseSystems.OnePhase.n),
      each stateSelect=StateSelect.prefer) "Shunt current on side p";
  Modelica.Units.SI.Current Ish_n[3,2](start=zeros(3, IDEAS.Electrical.PhaseSystems.OnePhase.n),
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IDEAS/Resources/Images/Electrical/AC/ThreePhasesUnbalanced/Lines/twoPortRLCMatrix.png\"/>
</p>
...
<p>
This model is a more detailed version of the model <a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesUnbalanced.Lines.TwoPortMatrixRL\">
IDEAS.Electrical.AC.ThreePhasesUnbalanced.Lines.TwoPortMatrixRL</a> that includes
