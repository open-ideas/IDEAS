within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Sensors.Examples;
...
__Dymola_Commands(file=
 "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Sensors/Examples/Sensors.mos"
        "Simulate and plot"));
end Sensors;
