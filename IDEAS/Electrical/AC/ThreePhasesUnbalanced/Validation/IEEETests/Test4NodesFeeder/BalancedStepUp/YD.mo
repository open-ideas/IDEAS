...
model YD
  ...
  extends
    ...
    loadRL(use_pf_in=false,
           loadConn=IDEAS.Electrical.Types.LoadConnection.wye_to_delta,
...
equation
  ...
  __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Validation/IEEETests/Test4NodesFeeder/BalancedStepUp/YD.mos"
        "Simulate and plot"),
