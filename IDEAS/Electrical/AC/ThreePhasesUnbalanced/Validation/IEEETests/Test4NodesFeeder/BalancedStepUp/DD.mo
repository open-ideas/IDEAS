within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Validation.IEEETests.Test4NodesFeeder.BalancedStepUp;
model DD
  ...
  extends
    ...
    redeclare IDEAS.Electrical.AC.ThreePhasesUnbalanced.Sensors.ProbeDelta
      node1,
    redeclare IDEAS.Electrical.AC.ThreePhasesUnbalanced.Sensors.ProbeDelta
      node2,
    redeclare IDEAS.Electrical.AC.ThreePhasesUnbalanced.Sensors.ProbeDelta
    ...
    loadRL(use_pf_in=false, loadConn=IDEAS.Electrical.Types.LoadConnection.wye_to_delta));
...
equation
  ...
  __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Validation/IEEETests/Test4NodesFeeder/BalancedStepUp/DD.mos"
        "Simulate and plot"),
