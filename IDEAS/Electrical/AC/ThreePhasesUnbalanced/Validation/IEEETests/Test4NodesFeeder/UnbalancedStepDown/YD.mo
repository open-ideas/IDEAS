within IDEAS.Electrical.AC.ThreePhasesUnbalanced.Validation.IEEETests.Test4NodesFeeder.UnbalancedStepDown;
model YD
  ...
  extends
    ...
    loadRL(loadConn=IDEAS.Electrical.Types.LoadConnection.wye_to_delta,
           use_pf_in=true,
           load1(v(each start = 3000))),
    line1(i1(each start=200)));
  IDEAS.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformerStepDownYD
    transformer(
    VHigh=VLL_side1,
    VLow=VLL_side2,
    XoverR=6,
...
equation
  ...
  __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Validation/IEEETests/Test4NodesFeeder/UnbalancedStepDown/YD.mos"
        "Simulate and plot"),
