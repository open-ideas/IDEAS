...
model ACDCConverter
  ...
  IDEAS.Electrical.DC.Loads.Resistor res(R=1, V_nominal=60)
    "Resistive load" annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=180,
        origin={50,10})));
  IDEAS.Electrical.AC.OnePhase.Conversion.ACDCConverter conversion(
    eta=0.9,
    ground_AC=false,
    ground_DC=true,
  ...
  IDEAS.Electrical.AC.OnePhase.Sources.FixedVoltage sou(
    ...
    V=120) "Voltage source"                  annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        origin={-62,10})));
  IDEAS.Electrical.DC.Loads.Conductor load(mode=IDEAS.Electrical.Types.Load.VariableZ_P_input,
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Conversion/Examples/ACDCConverter.mos"
        "Simulate and plot"));
end ACDCConverter;
