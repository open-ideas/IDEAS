...
model ACACTransformer
  ...
  IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformer tra_load(
    Zperc=0.03,
    VABase=4000,
    XoverR=8,
    VHigh=120,
  ...
  IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformer tra_cc(
    XoverR=8,
    Zperc=0.03,
    VABase=4000,
    VHigh=120,
  ...
  IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformer tra_void(
    XoverR=8,
    Zperc=0.03,
    VABase=4000,
    VHigh=120,
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Conversion/Examples/ACACTransformer.mos"
        "Simulate and plot"));
end ACACTransformer;
