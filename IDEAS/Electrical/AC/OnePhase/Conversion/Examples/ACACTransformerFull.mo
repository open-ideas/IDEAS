within IDEAS.Electrical.AC.OnePhase.Conversion.Examples;
model ACACTransformerFull
  "This example illustrates how to use the AC/AC transformer model"
  extends Modelica.Icons.Example;
  IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformerFull tra_load(
    R1=0.0001,
    L1=0.0001,
    R2=0.0001,
    L2=0.0001,
  ...
  IDEAS.Electrical.AC.OnePhase.Sources.FixedVoltage sou(
    ...
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        origin={-70,50})));
  IDEAS.Electrical.AC.OnePhase.Loads.Inductive load(
  ...
  IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformerFull
                                                              tra_cc(
    VABase=4000,
    R1=0.01,
    L1=0.01,
  ...
  IDEAS.Electrical.AC.OnePhase.Loads.Impedance shortCircuit(R=1e-8)
    "Short circuit"
    annotation (Placement(transformation(extent={{10,0},{30,20}})));
  IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformerFull tra_void(
    VABase=4000,
    R1=0.01,
    L1=0.01,
    R2=0.01,
  ...
  IDEAS.Electrical.AC.OnePhase.Sources.FixedVoltage sou1(
    definiteReference=true,
    f=60,
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Conversion/Examples/ACACTransformerFull.mos"
        "Simulate and plot"));
