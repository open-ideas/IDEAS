...
model GeneralizedSensor
  ...
  IDEAS.Electrical.AC.OnePhase.Sensors.GeneralizedSensor sen
    "Sensor that measures V, I, and S"
    annotation (Placement(transformation(extent={{0,0},{20,20}})));
  IDEAS.Electrical.AC.OnePhase.Loads.Capacitive loa(
    mode=IDEAS.Electrical.Types.Load.FixedZ_dynamic,
    P_nominal=-100,
  ...
  IDEAS.Electrical.AC.OnePhase.Lines.TwoPortResistance res(R=0.05)
    "Line resistance"
...
__Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Sensors/Examples/GeneralizedSensor.mos"
        "Simulate and plot"));
