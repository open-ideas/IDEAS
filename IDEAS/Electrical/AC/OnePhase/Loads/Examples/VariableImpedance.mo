...
model VariableImpedance
  ...
  IDEAS.Electrical.AC.OnePhase.Loads.Impedance Z_L(
    R=0,
    inductive=true,
  ...
  IDEAS.Electrical.AC.OnePhase.Loads.Impedance Z_C(
    R=0,
    inductive=false,
  ...
  IDEAS.Electrical.AC.OnePhase.Loads.Impedance Z_R(
    R=1,
    RMin=1,
    RMax=2,
    use_R_in=true,
...
equation
  ...
  annotation (experiment(StopTime=1.0, Tolerance=1e-06),
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Loads/Examples/VariableImpedance.mos"
        "Simulate and plot"),
