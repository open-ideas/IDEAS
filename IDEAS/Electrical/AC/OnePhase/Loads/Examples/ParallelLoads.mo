within IDEAS.Electrical.AC.OnePhase.Loads.Examples;
model ParallelLoads
  "Example that illustrates the use of the load models at constant voltage"
  extends Modelica.Icons.Example;
  IDEAS.Electrical.AC.OnePhase.Loads.Inductive varRL(
    ...
    annotation (Placement(
        ...
        extent={{-10,-10},{10,10}},
        origin={10,50})));
  IDEAS.Electrical.AC.OnePhase.Sources.FixedVoltage source(f=60, V=120)
    "Voltage source"
  ...
  IDEAS.Electrical.AC.OnePhase.Loads.Inductive RL(
    P_nominal=-1e3,
    linearized=false,
    V_nominal=120) "Constant inductor and resistor"
        ...
        extent={{-10,-10},{10,10}},
        origin={10,30})));
  IDEAS.Electrical.AC.OnePhase.Loads.Capacitive varRC(mode=IDEAS.Electrical.Types.Load.VariableZ_y_input,
      P_nominal=-1e3,
    linearized=false,
    V_nominal=120) "Variable conductor and resistor"        annotation (Placement(
        ...
        extent={{-10,-10},{10,10}},
        origin={10,10})));
  IDEAS.Electrical.AC.OnePhase.Loads.Capacitive RC(mode=IDEAS.Electrical.Types.Load.FixedZ_steady_state,
      P_nominal=-1e3,
    linearized=false,
    V_nominal=120) "Constant conductor and resistor"        annotation (Placement(
        ...
        extent={{-10,-10},{10,10}},
        origin={10,-10})));
  IDEAS.Electrical.AC.OnePhase.Loads.Resistive R(
    P_nominal=-1e3,
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Loads/Examples/ParallelLoads.mos"
        "Simulate and plot"));
end ParallelLoads;
