within IDEAS.Electrical.AC.OnePhase.Examples;
model GridDCLoad "Model of a DC load connected to the grid"
  extends Modelica.Icons.Example;
  IDEAS.Electrical.AC.OnePhase.Sources.Grid
               grid(
    f=60,
    phiSou=0,
    V=120)
    annotation (Placement(transformation(extent={{-80,-20},{-60,0}})));
  IDEAS.Electrical.AC.OnePhase.Conversion.ACDCConverter
                                                   idealACDCConverter1(
                               eta=0.9,
    ground_AC=false,
    conversionFactor=12/120)
    annotation (Placement(transformation(extent={{-50,-40},{-30,-20}})));
  IDEAS.Electrical.DC.Loads.Resistor    resistor(R=1, V_nominal=12)
...
equation
  ...
  annotation (experiment(
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Examples/GridDCLoad.mos"
        "Simulate and plot"),
