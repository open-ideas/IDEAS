...
model Line "Model of an electrical line"
  extends IDEAS.Electrical.Transmission.BaseClasses.PartialLine(
    V_nominal(start = 110),
    ...
    commercialCable = IDEAS.Electrical.Transmission.Functions.selectCable_low(P_nominal, V_nominal));
protected
  replaceable TwoPortRL line(
    R=R/3,
    L=L/3,
    mode=modelMode) constrainedby
    IDEAS.Electrical.Transmission.BaseClasses.PartialTwoPortRLC(
      useHeatPort=true,
      M=M,
...
<a href=\"modelica://IDEAS.Electrical.AC.OnePhase.Lines.TwoPortRLC\">
IDEAS.Electrical.AC.OnePhase.Lines.TwoPortRLC</a>
...
<a href=\"modelica://IDEAS.Electrical.AC.ThreePhasesBalanced.Lines.Line\">
IDEAS.Electrical.AC.ThreePhasesBalanced.Lines.Line</a>.
</li>
<li>
November 8, 2016, by Michael Wetter:<br/>
...
<span style=\" font-family:'Courier New,courier'; color:#ff0000;\"> IDEAS.Electrical.Transmission.Functions.selectCable_low</span>
