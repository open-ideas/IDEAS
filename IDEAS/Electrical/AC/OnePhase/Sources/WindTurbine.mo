...
model WindTurbine "Simple wind turbine model"
  extends IDEAS.Electrical.BaseClasses.WindTurbine.PartialWindTurbine(
  ...
  parameter Real eta_DCAC(min=0, max=1) = 0.9 "Efficiency of DC/AC conversion"
    annotation (Dialog(group="AC-Conversion"));
  replaceable IDEAS.Electrical.AC.OnePhase.Loads.Capacitive load(
    final mode=IDEAS.Electrical.Types.Load.VariableZ_P_input,
    final pf=pf,
    final P_nominal=0,
