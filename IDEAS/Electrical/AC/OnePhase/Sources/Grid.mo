...
model Grid "Electrical grid"
  ...
  replaceable IDEAS.Electrical.AC.OnePhase.Interfaces.Terminal_p terminal
  ...
  IDEAS.Electrical.AC.Interfaces.PowerOutput P
    "Power consumed from grid if positive, or fed to grid if negative"
    annotation (Placement(transformation(extent={{100,-10},{120,10}})));
  replaceable IDEAS.Electrical.AC.OnePhase.Sources.FixedVoltage sou(
