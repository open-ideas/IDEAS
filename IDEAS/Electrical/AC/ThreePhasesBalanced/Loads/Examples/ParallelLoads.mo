within IDEAS.Electrical.AC.ThreePhasesBalanced.Loads.Examples;
...
This model illustrates the use of the three-phase unbalanced load models.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Loads/Examples/ParallelLoads.mos"
        "Simulate and plot"));
end ParallelLoads;
