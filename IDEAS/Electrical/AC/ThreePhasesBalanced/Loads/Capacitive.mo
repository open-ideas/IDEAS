within IDEAS.Electrical.AC.ThreePhasesBalanced.Loads;
model Capacitive "Model of a capacitive and resistive load"
  extends IDEAS.Electrical.AC.OnePhase.Loads.Capacitive(
...
IDEAS.Electrical.AC.OnePhase.Loads.Capacitive</a> for more information.
</p>
</html>",
      revisions="<html>
<ul>
