...
model ACACConverter
  ...
  IDEAS.Electrical.AC.ThreePhasesBalanced.Conversion.ACACConverter
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Conversion/Examples/ACACConverter.mos"
        "Simulate and plot"));
end ACACConverter;
