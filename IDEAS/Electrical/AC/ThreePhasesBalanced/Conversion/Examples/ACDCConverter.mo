...
model ACDCConverter
  ...
  IDEAS.Electrical.DC.Loads.Resistor res(
    R=1,
    V_nominal=120,
    i(each start=0))
    "Resistive load" annotation (Placement(
        ...
        rotation=180,
        origin={50,10})));
  IDEAS.Electrical.AC.ThreePhasesBalanced.Conversion.ACDCConverter conversion(
    eta=0.9,
    ground_AC=false,
    ground_DC=true,
  ...
  IDEAS.Electrical.AC.ThreePhasesBalanced.Sources.FixedVoltage sou(
    ...
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        origin={-62,10})));
  IDEAS.Electrical.DC.Loads.Conductor load(
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Conversion/Examples/ACDCConverter.mos"
        "Simulate and plot"));
end ACDCConverter;
