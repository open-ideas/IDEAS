within IDEAS.Electrical.AC.ThreePhasesBalanced.Conversion;
model ACACTransformerFull
  "AC AC transformer full model for three phase balanced systems"
  extends IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformerFull(
...
IDEAS.Electrical.AC.OnePhase.Conversion.ACACTransformerFull</a> for more
information.
</p>
</html>", revisions="<html>
<ul>
