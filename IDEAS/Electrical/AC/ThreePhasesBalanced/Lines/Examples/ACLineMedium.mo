within IDEAS.Electrical.AC.ThreePhasesBalanced.Lines.Examples;
model ACLineMedium
  ...
  ThreePhasesBalanced.Lines.Line line_1(
    P_nominal=5000,
    l=2000,
    redeclare IDEAS.Electrical.Transmission.MediumVoltageCables.Generic
          commercialCable = IDEAS.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10(),
...
equation
  ...
  __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Lines/Examples/ACLineMedium.mos"
        "Simulate and plot"),
...
<span style=\" font-family:'Courier New,courier'; color:#ff0000;\">IDEAS.Electrical.Transmission.MediumVoltageCables.Generic</span>
</p>
<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; -qt-user-state:8;\">
<span style=\" font-family:'Courier New,courier';\">          commercialCable =</span>
<span style=\" font-family:'Courier New,courier'; color:#ff0000;\"> IDEAS.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10</span>
...
record type in order to be <code>IDEAS.Electrical.Transmission.MediumVoltageCables.Generic</code>.
</p>
