within IDEAS.Electrical.AC.ThreePhasesBalanced.Sources.Examples;
model VariablePowerSource
  "This example illustrates how using a variable power source"
  extends Modelica.Icons.Example;
  IDEAS.Electrical.AC.ThreePhasesBalanced.Sources.Generator generator(f=60,
  ...
  IDEAS.Electrical.AC.ThreePhasesBalanced.Loads.Inductive RL(mode=Types.Load.VariableZ_y_input,
      P_nominal=-300,
    V_nominal=480) "Load model"
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  IDEAS.Electrical.AC.ThreePhasesBalanced.Sources.Grid grid(f=60, V=480)
...
equation
  ...
  annotation (    experiment(StopTime=1.0, Tolerance=1e-6),
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Sources/Examples/VariablePowerSource.mos"
        "Simulate and plot"),
