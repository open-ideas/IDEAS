...
model FixedVoltageSource
  ...
  IDEAS.Electrical.AC.ThreePhasesBalanced.Loads.Inductive RL(
      P_nominal=-300, mode=IDEAS.Electrical.Types.Load.FixedZ_steady_state,
...
equation
  ...
  annotation (experiment(StopTime=1.0, Tolerance=1e-6),
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Sources/Examples/FixedVoltageSource.mos"
        "Simulate and plot"),
