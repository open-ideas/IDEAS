within IDEAS.Electrical.AC.ThreePhasesBalanced.Sensors;
model GeneralizedSensor "Sensor for power, voltage and current"
  extends IDEAS.Electrical.Icons.GeneralizedSensor;
  ...
  Modelica.Blocks.Interfaces.RealOutput V(
    ...
    final unit="V")=
      IDEAS.Electrical.PhaseSystems.OnePhase.systemVoltage(terminal_n.v)
    "Voltage"
  ...
  Modelica.Blocks.Interfaces.RealOutput I(
    ...
    final unit="A")=
      IDEAS.Electrical.PhaseSystems.OnePhase.systemCurrent(terminal_n.i)
    "Current"
      annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
  ...
  Modelica.Blocks.Interfaces.RealOutput S[PhaseSystems.OnePhase.n](
    ...
    each final unit="W")=
      IDEAS.Electrical.PhaseSystems.OnePhase.phasePowers_vi(v=terminal_n.v, i=terminal_n.i)
    "Phase powers"
      annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
