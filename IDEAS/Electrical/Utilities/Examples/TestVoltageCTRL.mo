within IDEAS.Electrical.Utilities.Examples;
model TestVoltageCTRL
  "This test check the correctness of the voltage controller model"
  extends Modelica.Icons.Example;
  VoltageControl voltageControl(
  redeclare IDEAS.Electrical.DC.Interfaces.Terminal_p terminal,
    redeclare package PhaseSystem =
        IDEAS.Electrical.PhaseSystems.TwoConductor,
    V_nominal=120,
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IDEAS/Resources/Images/Electrical/Utilities/Examples/VoltCTRL.png\"/>
</p>
<p>
...
<i>t = 5</i> s to change the signal to one.
          ...
          "modelica://IDEAS/Resources/Scripts/Dymola/Electrical/Utilities/Examples/TestVoltageCTRL.mos"
        "Simulate and plot"),
    experiment(
      StopTime=10,
      Tolerance=1e-6));
