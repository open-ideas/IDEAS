within IDEAS.Electrical.Photovoltaics.Examples;
model UsePVGeneral
  ...
  inner IDEAS.SimInfoManager sim(redeclare
      IDEAS.BoundaryConditions.Climate.Meteo.Locations.Uccle city, redeclare
      IDEAS.BoundaryConditions.Climate.Meteo.Files.min15 detail)
    annotation (Placement(transformation(extent={{-100,80},{-80,100}})));
  inner IDEAS.Electrical.Photovoltaics.Components.ForInputFiles.PVProfileReader
