within IDEAS.Electrical.Photovoltaics.Components;
class PvArray

  parameter Real amount=2;
  parameter Real inc=34 "inclination";
  parameter Real azi=0 "azimuth";
  replaceable parameter IDEAS.Electrical.Data.Interfaces.PvPanel pvPanel
    "Choose a Photovoltaic panel to be used"
    annotation (choicesAllMatching=true);
  extends IDEAS.Electrical.Photovoltaics.Components.DCgen;

  IDEAS.Climate.Meteo.Solar.RadSol radSol(
    azi=azi,
    inc=inc,
    A=1) annotation (Placement(transformation(extent={{-100,44},{-80,64}})));
  IDEAS.Electrical.Photovoltaics.Components.Elements.refraction refDir
    annotation (Placement(transformation(extent={{-8,20},{12,40}})));
  IDEAS.Electrical.Photovoltaics.Components.Elements.refraction refDif
    annotation (Placement(transformation(extent={{-8,-4},{12,16}})));
  IDEAS.Electrical.Photovoltaics.Components.Elements.refraction refRef
    annotation (Placement(transformation(extent={{-8,-26},{12,-6}})));
  IDEAS.Electrical.Photovoltaics.Components.Elements.incidenceAngles incidenceAngles(azi=azi,
      inc=inc)
    annotation (Placement(transformation(extent={{-38,20},{-18,40}})));
  outer IDEAS.SimInfoManager sim
    annotation (Placement(transformation(extent={{-100,80},{-80,100}})));
  IDEAS.Electrical.Photovoltaics.Components.Elements.absorption absorption
    annotation (Placement(transformation(extent={{22,20},{42,40}})));
  IDEAS.Electrical.Photovoltaics.Components.Elements.PV5 PV5(pvPanel=pvPanel)
    annotation (Placement(transformation(extent={{48,20},{68,40}})));
  IDEAS.Electrical.Photovoltaics.Components.Elements.PvSerie pvSerie(amount=
