within IDEAS.Electrical.Photovoltaics;
model PVSystemGeneral "PV system with separate shut-down controller"
  ...
  IDEAS.Electrical.Photovoltaics.Components.PvArray pvArray(
    ...
    pvPanel=pvPanel) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-70,32})));
  IDEAS.Electrical.Photovoltaics.Components.SimpleInverter invertor
    annotation (Placement(transformation(extent={{-40,20},{-20,40}})));
  Modelica.Electrical.Analog.Basic.Ground ground1
    annotation (Placement(transformation(extent={{-26,-14},{-6,6}})));
  IDEAS.Electrical.BaseClasses.AC.WattsLaw wattsLaw(numPha=numPha)
    annotation (Placement(transformation(extent={{60,20},{80,40}})));
  IDEAS.Electrical.Photovoltaics.Components.PvVoltageToPower vi2PQ
    annotation (Placement(transformation(extent={{-6,20},{14,40}})));

  IDEAS.Electrical.Photovoltaics.Components.PvVoltageCtrlGeneral pvVoltageCtrl(
    VMax=VMax,
    timeOff=timeOff,
    numPha=numPha)
