within IDEAS.Electrical.Photovoltaics.Extern;
model PvSystem
  ...
  IDEAS.Electrical.Photovoltaics.Components.ForInputFiles.SimpleDCAC_effP invertor(PNom=-
        PNom, P_dc_max=-PNom)
  ...
  outer IDEAS.BoundaryConditions.Occupants.Extern.StrobeInfoManager strobe(
      final PPv=true)
