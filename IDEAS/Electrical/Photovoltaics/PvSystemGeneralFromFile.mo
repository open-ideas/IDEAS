...
model PvSystemGeneralFromFile "PV system with separate shut-down controller"
  ...
  IDEAS.Electrical.Photovoltaics.Components.ForInputFiles.SimpleDCAC_effP inverter(PNom=PNom)
  ...
  outer IDEAS.Electrical.Photovoltaics.Components.ForInputFiles.PVProfileReader
