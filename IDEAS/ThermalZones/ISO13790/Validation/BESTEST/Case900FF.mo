...
model Case900FF "Test with heavy-weight construction and free floating temperature"
  extends IDEAS.ThermalZones.ISO13790.Validation.BESTEST.Case600FF(
    zon5R1C(
      redeclare replaceable IDEAS.ThermalZones.ISO13790.Validation.BESTEST.Data.Case900Mass buiMas),
 ...
 annotation(experiment(Tolerance=1e-6, StopTime=3.1536e+007),
  ...
  "modelica://IDEAS/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Case900FF.mos"
