within IDEAS.ThermalZones.ISO13790.Validation.BESTEST.Cases9xx;
model Case950FF
  extends IDEAS.ThermalZones.ISO13790.Validation.BESTEST.Cases9xx.Case900FF(
      zonHVAC(nPorts=3));
  IDEAS.Fluid.Sources.MassFlowSource_T sinInf(
    redeclare package Medium = IDEAS.Media.Air,
    use_m_flow_in=true,
    nPorts=1) "Sink model for air infiltration"
    annotation (Placement(transformation(extent={{8,-80},{-12,-60}})));
  IDEAS.Fluid.Sources.Outside out(redeclare package Medium = IDEAS.Media.Air, nPorts=1)
  ...
  IDEAS.Fluid.Sensors.Density senDen(redeclare package Medium = IDEAS.Media.Air,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Cases9xx/Case950FF.mos"
