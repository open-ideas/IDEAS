...
model Case900FF
  ...
  extends IDEAS.ThermalZones.ISO13790.Validation.BESTEST.Cases6xx.Case600FF(
      zonHVAC(redeclare replaceable
        IDEAS.ThermalZones.ISO13790.Validation.BESTEST.Data.Case900Mass buiMas));

 annotation(experiment(Tolerance=1e-6, Interval=3600, StopTime=3.1536e+007),
  __Dymola_Commands(file=
  "modelica://IDEAS/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Cases9xx/Case900FF.mos"
