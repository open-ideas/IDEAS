...
model Case685
  extends IDEAS.ThermalZones.ISO13790.Validation.BESTEST.Cases6xx.Case600(TSetCoo(
        table=[0.0,273.15 + 20.1]), TSetHea(table=[0.0,273.15 + 19.9]));
 annotation (
  __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Cases6xx/Case685.mos"
        "Simulate and plot"),
        experiment(
      StopTime=3.1536e+07,
      Interval=3600,
