...
model Case600FF
  ...
  IDEAS.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    filNam=Modelica.Utilities.Files.loadResource("modelica://IDEAS/Resources/weatherdata/USA_CO_Denver.Intl.AP.725650_TMY3.mos"))
    "Weather data"
    annotation (Placement(transformation(extent={{-80,10},{-60,30}})));
  Modelica.Blocks.Sources.Constant intGai(k=200) "Internal heat gains"
    annotation (Placement(transformation(extent={{-80,-20},{-60,0}})));
  IDEAS.Controls.OBC.CDL.Reals.MovingAverage TRooHou(delta=3600)
    "Continuous mean of room air temperature"
    annotation (Placement(transformation(extent={{60,-2},{80,18}})));
  IDEAS.Controls.OBC.CDL.Reals.MovingAverage TRooAnn(delta=86400*365)
    "Continuous mean of room air temperature"
...
equation
 ...
 annotation(experiment(
  ...
  "modelica://IDEAS/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Cases6xx/Case600FF.mos"
