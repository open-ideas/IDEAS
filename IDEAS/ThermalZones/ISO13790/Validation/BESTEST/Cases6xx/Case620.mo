...
model Case620 "Case 600, but with windows on east and west side walls"
  extends IDEAS.ThermalZones.ISO13790.Validation.BESTEST.Cases6xx.Case600(zonHVAC(AWin=
         {0,6,0,6}));
 annotation(experiment(
  ...
  "modelica://IDEAS/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Cases6xx/Case620.mos"
