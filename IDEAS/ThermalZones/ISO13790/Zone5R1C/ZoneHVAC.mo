within IDEAS.ThermalZones.ISO13790.Zone5R1C;
model ZoneHVAC "Thermal zone for HVAC based on 5R1C network"
  ...
  replaceable package Medium = Modelica.Media.Interfaces.PartialMedium annotation (
        choices(choice(redeclare package Medium = IDEAS.Media.Air "Moist air")));
  ...
  Fluid.MixingVolumes.MixingVolumeMoistAir vol(
    ...
    m_flow_nominal=VRoo*IDEAS.Media.Air.dStp*3/3600,
    V=VRoo,
...
protected
  constant Modelica.Units.SI.SpecificEnergy h_fg=
      IDEAS.Media.Air.enthalpyOfCondensingGas(273.15 + 37) "Latent heat of water vapor";
...
<p>
This models is identical to <a href=\"modelica://IDEAS.ThermalZones.ISO13790.Zone5R1C.Zone\">
IDEAS.ThermalZones.ISO13790.Zone5R1C.Zone</a>, except that a mixing volume is added
