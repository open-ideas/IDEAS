within IDEAS.ThermalZones.ISO13790.Examples;
model FreeFloatingHVAC "Illustrates the use of the 5R1C HVAC thermal zone in free-floating conditions"
  ...
  IDEAS.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(filNam=
        Modelica.Utilities.Files.loadResource("modelica://IDEAS/Resources/weatherdata/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos")) "weather data"
  ...
  Zone5R1C.ZoneHVAC zonHVAC(
    ...
    redeclare IDEAS.ThermalZones.ISO13790.Data.Light buiMas) "Thermal zone"
...
equation
  ...
  "modelica://IDEAS/Resources/Scripts/Dymola/ThermalZones/ISO13790/Examples/FreeFloatingHVAC.mos"
        "Simulate and plot"),
  Documentation(info="<html>
<p>
This model illustrates the use of <a href=\"modelica://IDEAS.ThermalZones.ISO13790.Zone5R1C.ZoneHVAC\">
IDEAS.ThermalZones.ISO13790.Zone5R1C.ZoneHVAC</a> in a free-floating case (i.e. no heating or cooling).
</p>
</html>",
revisions="<html>
<ul>
