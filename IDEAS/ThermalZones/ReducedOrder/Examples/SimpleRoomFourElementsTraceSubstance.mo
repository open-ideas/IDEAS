...
model SimpleRoomFourElementsTraceSubstance
  ...
  extends IDEAS.ThermalZones.ReducedOrder.Examples.SimpleRoomFourElements(thermalZoneFourElements(
  ...
  IDEAS.Fluid.Sources.MassFlowSource_T souAir(
    ...
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-30,-70})));
  IDEAS.Fluid.Sources.Boundary_pT sinAir(
    redeclare package Medium = Medium,
    C={400},
...
First implementation.
  ...
  "modelica://IDEAS/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Examples/SimpleRoomFourElementsTraceSubstance.mos"
        "Simulate and plot"),
