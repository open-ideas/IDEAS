within IDEAS.ThermalZones.ReducedOrder.Validation;
model RoomSteadyState
  ...
  extends ThermalZones.ReducedOrder.Examples.SimpleRoomOneElement(
    weaDat(
      ...
      TBlaSky=293.15,
      relHumSou=IDEAS.BoundaryConditions.Types.DataSource.Parameter,
      winSpeSou=IDEAS.BoundaryConditions.Types.DataSource.Parameter,
      winDirSou=IDEAS.BoundaryConditions.Types.DataSource.Parameter,
...
equation
  ...
  annotation (
    experiment(
      StopTime=604800,
      Tolerance=1e-06),
      __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Validation/RoomSteadyState.mos"
        "Simulate and plot"),
