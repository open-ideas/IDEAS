within IDEAS.Examples.Tutorial.SimpleHouse;
model SimpleHouse6 "Free cooling model"
  ...
  IDEAS.Fluid.Actuators.Dampers.Exponential vavDam(
    ...
    "Damper" annotation (Placement(transformation(extent={{-10,10},{10,
            -10}}, origin={110,130})));
  IDEAS.Fluid.Movers.Preconfigured.FlowControlled_dp fan(
    redeclare package Medium = MediumAir,
    show_T=true,
  ...
  IDEAS.Fluid.HeatExchangers.ConstantEffectiveness hexRec(
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort TFanIn(
    redeclare final package Medium = MediumAir,
    final m_flow_nominal=mAir_flow_nominal,
    tau=0) "Temperature at fan inlet"
    annotation (Placement(transformation(extent={{-40,120},{-20,140}})));
  IDEAS.Fluid.Sensors.TemperatureTwoPort TFanOut(
    redeclare final package Medium = MediumAir,
    final m_flow_nominal=mAir_flow_nominal,
...
<li>
<a href=\"modelica://IDEAS.Fluid.Movers.Preconfigured.FlowControlled_dp\">
IDEAS.Fluid.Movers.Preconfigured.FlowControlled_dp</a>
</li>
<li>
...
src=\"modelica://IDEAS/Resources/Images/Examples/Tutorial/SimpleHouse/result6.png\" width=\"1000\"/>
</p>
<p align=\"center\">
<img alt=\"Ventilation control signal as function of time.\"
src=\"modelica://IDEAS/Resources/Images/Examples/Tutorial/SimpleHouse/result7.png\" width=\"1000\"/>
</p>
</html>"),
    __Dymola_Commands(file=
          "modelica://IDEAS/Resources/Scripts/Dymola/Examples/Tutorial/SimpleHouse/SimpleHouse6.mos"
        "Simulate and plot"));
end SimpleHouse6;
