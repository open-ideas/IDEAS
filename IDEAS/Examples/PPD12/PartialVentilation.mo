...
partial model PartialVentilation "Ppd 12 example model"
...
equation
  ...
  connect(bedRoom1.port_a, spl8.port_3)
    annotation (Line(points={{128,60},{110,60},{110,130}}, color={0,127,255}));
  connect(spl5.port_3, bedRoom2.port_a) annotation (Line(points={{262,130},{262,
          110},{294,110},{294,54},{264,54},{264,62}}, color={0,127,255}));
