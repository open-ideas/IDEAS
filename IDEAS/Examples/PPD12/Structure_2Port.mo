...
model Structure_2Port "Ppd 12 example model"
  ...
  IDEAS.Buildings.Components.OuterWall out1(
    ...
    A=hFloor0*wKitchen,
    azi=east,
    redeclare IDEAS.Templates.OuterWall constructionType)
  ...
  IDEAS.Buildings.Components.OuterWall out2(
    ...
    redeclare IDEAS.Templates.OuterWall constructionType,
    azi=east,
    A=0.5*wBedroom) "Outer wall of top floor on east facade" annotation (
  ...
  IDEAS.Buildings.Components.RectangularZoneTemplate living(
    ...
    A_winC=2.55*1.74,
    fracC=0.1,
    redeclare IDEAS.Templates.OuterWall conTypC,
  ...
  IDEAS.Buildings.Components.RectangularZoneTemplate bathRoom(
    ...
    hasWinA=true,
    A_winA=1.21*1.99,
    redeclare IDEAS.Templates.OuterWall conTypA,
  ...
  IDEAS.Buildings.Components.RectangularZoneTemplate stairWay(
    ...
    redeclare IDEAS.Examples.PPD12.Data.TripleGlazing glazingA,
    redeclare IDEAS.Examples.PPD12.Data.CommonWall conTypB,
    redeclare IDEAS.Buildings.Validation.Data.Constructions.LightWall conTypFlo,
