within IDEAS.Circuits.HeatingSystems.Examples;
model IdealEmbeddedHeating
  ...
  IDEAS.Circuits.HeatingSystems.IdealEmbeddedHeating heating(
    nZones=nZones,
  ...
  IDEAS.Circuits.HeatingSystems.Examples.DummyBuilding building(nZones=nZones,
      nEmb=nZones)
  ...
  IDEAS.Circuits.VentilationSystems.None none(nZones=nZones, VZones=building.VZones)
