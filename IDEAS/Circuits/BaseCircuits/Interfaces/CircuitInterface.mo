...
protected
  Fluid.FixedResistances.InsulatedPipe pipeSupply(
    UA=UA,
    m=m/2,
    dp_nominal=dp,
  ...
  Fluid.FixedResistances.InsulatedPipe pipeReturn(
    UA=UA,
    dp_nominal=dp,
    m=m/2,
    energyDynamics=energyDynamics,
    ...
    dynamicBalance=dynamicBalance,
    m_flow_nominal=m_flow_nominal,
    redeclare package Medium = Medium) if includePipes annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
