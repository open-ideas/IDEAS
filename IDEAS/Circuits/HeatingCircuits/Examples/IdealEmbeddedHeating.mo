within IDEAS.Circuits.HeatingCircuits.Examples;
model IdealEmbeddedHeating
  ...
  IDEAS.Circuits.HeatingCircuits.IdealEmbeddedHeating heating(
    nZones=nZones,
  ...
  IDEAS.Circuits.HeatingCircuits.Examples.DummyBuilding building(nZones=nZones,
      nEmb=nZones)
  ...
  IDEAS.Circuits.VentilationCircuits.None none(nZones=nZones, VZones=building.VZones)
