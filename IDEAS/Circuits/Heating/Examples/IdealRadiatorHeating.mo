within IDEAS.Circuits.Heating.Examples;
model IdealRadiatorHeating "Example and test for ideal heating with radiators"
  ...
  IDEAS.Circuits.Heating.IdealRadiatorHeating heating(
    final nZones=nZones,
  ...
  IDEAS.Circuits.Heating.Examples.DummyBuilding building(nZones=nZones, nEmb=0)
