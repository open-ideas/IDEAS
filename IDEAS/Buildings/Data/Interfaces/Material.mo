...
record Material "Template record for properties of building materials"
  ...
  parameter Modelica.SIunits.Emissivity epsLw=
    IDEAS.Buildings.Data.Constants.epsLw_default "Longwave emisivity";
  parameter Modelica.SIunits.Emissivity epsSw=
    IDEAS.Buildings.Data.Constants.epsSw_default "Shortwave emissivity";
