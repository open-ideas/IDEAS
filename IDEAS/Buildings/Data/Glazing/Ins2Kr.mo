...
record Ins2Kr = IDEAS.Buildings.Data.Interfaces.OldGlazing (
    final nLay=3,
    final mats={Materials.Glass(d=0.004, epsLw_a=0.04),
                Materials.Krypton(d=0.015),
    ...
    final SwAbs=[0, 0.118, 0.0, 0.190;
                 ...
                 80, 0.149, 0.0, 0.117;
                 90, 0.000, 0.0, 0.000],
    final SwTransDif=0.142,
    final SwAbsDif={0.142,0.0,0.199},
    final U_value=1.0,
    final g_value=0.598)
  "Deprecated: Saint Gobain Climaplus Futur KR 1.0 4/15/4 (U = 1.0 W/m2K, g = 0.598)"
