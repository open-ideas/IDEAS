...
record GroundFloor  "Construction data of GroundFloor"
  extends IDEAS.Buildings.Data.Interfaces.Construction(locGain={3}, final mats=
        {IDEAS.Buildings.Data.Materials.DenseCastConcreteAlsoForFinishing(d=0.2),
        IDEAS.Buildings.Data.Insulation.ExpandedPolystrenemOrEPS(
        d=0.13413005339301134),
        IDEAS.Buildings.Data.Materials.ScreedOrLightCastConcrete(
        d=0.06),
