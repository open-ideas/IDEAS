...
partial model PartialShadingDevice
  ...
  A = A_frame, 
  epsSw = epsSw_frame) if haveBoundaryPorts annotation(
  ...
  Modelica.Blocks.Math.Add solDif(k1 = 1, k2 = 1) if haveBoundaryPorts annotation(
...
equation
  ...
  connect(eConFra.Te, Te) annotation(
    Line(points = {{-12, 176}, {-60, 176}, {-60, 130}}, color = {0, 0, 127}));
  ...
  connect(solDif.y, solAbs.solDif) annotation(
    Line(points = {{102, 30}, {108, 30}, {108, 142}, {-10, 142}, {-10, 162}}, color = {0, 0, 127}));
  ...
  connect(eCon.Te, Te) annotation(
    Line(points = {{-10, 114}, {-60, 114}, {-60, 130}}, color = {0, 0, 127}));
