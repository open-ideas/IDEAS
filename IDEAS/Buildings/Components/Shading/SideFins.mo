...
model SideFins "Vertical side fins next to windows"
  ...
  // Sidefin properties
  parameter Modelica.Units.SI.Length hFin "Height of side fin above window"
  ...
  parameter Modelica.Units.SI.Length dep
    ...
    annotation (Dialog(group="Side fin properties"));
  parameter Modelica.Units.SI.Length gap
...
protected
  final parameter Modelica.Units.SI.Angle vieAngFin=atan(dep/(gap + wWin/2))
    "Viewing angle of overhang";
  final parameter Modelica.Units.SI.Area AWin=hWin*wWin "Window area";
  final parameter Modelica.Units.SI.Length tmpH[4]={hFin + hWin,hFin,hFin +
      hWin,hFin} "Height rectangular sections used for superposition";
  final parameter Modelica.Units.SI.Length tmpW[4]={gap + wWin,gap + wWin,gap,
      gap} "Width rectangular sections used for superposition";
