...
model Window "Multipane window"
  replaceable IDEAS.Buildings.Data.Interfaces.Glazing glazing
    ...
    annotation (choices(
        choice(redeclare IDEAS.Buildings.Data.Glazing.Ins2Ar2020 glazing "Insulating double glazing (6/16/6 AR Planitherm one, U=1.0) with clear glass"),
        choice(redeclare IDEAS.Buildings.Data.Glazing.Ins3Ar2020 glazing "Insulating triple glazing (6/16/6/16/6 AR Planitherm one, U=0.6) with clear glass"),
        choice(redeclare IDEAS.Buildings.Data.Glazing.EpcDouble glazing "Uncoated double glazing (4/12/4, U=2.9)"),
        choice(redeclare IDEAS.Buildings.Data.Glazing.EpcSingle glazing "Single glazing (U=5.8)")),
        Dialog(group=
