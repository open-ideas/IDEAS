...
protected
  ...
  BaseClasses.LeakageModel                            leakageModel(
    ...
    AFac=A,
    azi=azi) if
               sim.computeInterzonalAirFlow annotation (Placement(transformation(extent={{40,80},{60,100}})));
initial equation
...
equation
  ...
  connect(leakageModel.port_lea, propsBusInt.inf) annotation (Line(points={{60,90},
