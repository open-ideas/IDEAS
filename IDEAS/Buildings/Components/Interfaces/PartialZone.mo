...
equation
  ...
  connect(airModel.A[1:nSurf], propsBusInt[1:nSurf].area) annotation (Line(
        points={{-40.6,24},{-80,24},{-80,40},{-80.1,40},{-80.1,39.9}}, color={0,
          0,127}));
  connect(airModel.ports_air[1], gainCon) annotation (Line(points={{-20,30},{2,
          30},{2,-40},{100,-40}},
                              color={191,0,0}));
  ...
  connect(nOcc, occNum.nOccIn)
    annotation (Line(points={{110,60},{90,60},{90,32},{82,32}},
                                                color={0,0,127}));
  connect(uLig, ligCtr.ligCtr) annotation (Line(points={{110,80},{88,80},{88,60},
          {82,60}},color={0,0,127}));
  ...
  connect(intGaiLig.portCon, gainCon) annotation (Line(points={{20,64},{2,64},{
          2,-40},{100,-40}},
                           color={191,0,0}));
