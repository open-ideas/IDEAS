...
equation
  connect(sim.weaBus, weaBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(buildingShade.solDir, weaBus.solBus[2].iSolDir) annotation (Line(points={
          {-22,-4},{-53.95,-4},{-53.95,34.05}}, color={0,0,127}));
  connect(buildingShade.solDif, weaBus.solBus[2].iSolDif) annotation (Line(points={
          {-22,-8},{-53.95,-8},{-53.95,34.05}}, color={0,0,127}));
  connect(buildingShade.angInc, weaBus.solBus[2].angInc) annotation (Line(points={{
          -22,-14},{-53.95,-14},{-53.95,34.05}}, color={0,0,127}));
  connect(buildingShade.angAzi, weaBus.solBus[2].angAzi) annotation (Line(points={{
          -22,-18},{-53.95,-18},{-53.95,34.05}}, color={0,0,127}));
  connect(buildingShade.angZen, weaBus.solBus[2].angZen) annotation (Line(points={{
          -22,-16},{-34,-16},{-53.95,-16},{-53.95,34.05}}, color={0,0,127}));
