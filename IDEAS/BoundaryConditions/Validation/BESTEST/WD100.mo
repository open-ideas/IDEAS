...
model WD100
  ...
  WeatherData.ReaderTMY3 weaDatHHorIR(
    pAtmSou=IDEAS.BoundaryConditions.Types.DataSource.File,
    ceiHeiSou=IDEAS.BoundaryConditions.Types.DataSource.Parameter,
    ceiHei=alt,
    filNam=Modelica.Utilities.Files.loadResource(
      "modelica://IDEAS/Resources/Data/BoundaryConditions/Validation/BESTEST/725650.mos"),
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/BoundaryConditions/Validation/BESTEST/WD100.mos" "Simulate and plot"),
    Documentation(
      info="<html>
...
The model
<a href=\"modelica://IDEAS.BoundaryConditions.Validation.IsotropicAndPerezDiffuseRadiation\">IDEAS.BoundaryConditions.Validation.IsotropicAndPerezDiffuseRadiation</a>
