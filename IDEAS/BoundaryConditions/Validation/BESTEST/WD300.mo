...
model WD300
  ...
  extends WD100(
    ...
    weaDatHHorIR(
      filNam=Modelica.Utilities.Files.loadResource(
        "modelica://IDEAS/Resources/Data/BoundaryConditions/Validation/BESTEST/855740.mos")),
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://IDEAS/Resources/Scripts/Dymola/BoundaryConditions/Validation/BESTEST/WD300.mos" "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
<li>
