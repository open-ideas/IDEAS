within IDEAS.BoundaryConditions.Validation;
package UsersGuide
  "User's Guide"
  ...
  annotation (
    ...
    Documentation(
      info="<html>
<p>
The package <a href=\"modelica://IDEAS.BoundaryConditions.Validation.BESTEST\">IDEAS.BoundaryConditions.Validation.BESTEST</a>
...
<li>
<a href=\"modelica://IDEAS.BoundaryConditions.SkyTemperature.BlackBody\">Sky black body temperature</a>
calculated using Horizontal radiation or dew point temperature and sky cover.
</li>
<li>Diffused radiation calculated using <a href=\"modelica://IDEAS.BoundaryConditions.SolarIrradiation.DiffusePerez\">Perez</a> and
<a href=\"modelica://IDEAS.BoundaryConditions.SolarIrradiation.DiffuseIsotropic\">Isotropic</a> sky models</li>
</ul>
...
<ul>
<li>Clone the last master branch of the IDEAS repository into a temporary directory</li>
