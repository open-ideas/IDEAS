  ...
  IDEAS.BoundaryConditions.WeatherData.Bus weaBus
    ...
    annotation (Placement(
        transformation(extent={{1,-1},{21,21}}), iconTransformation(extent={{20,
            20},{21,21}})));
  IDEAS.BoundaryConditions.SolarIrradiation.DiffusePerez HDifRoo(
    til=IDEAS.Types.Tilt.Ceiling,
    azi=0.78539816339745)
    "Diffuse irradiation on roof"
    annotation (Placement(transformation(extent={{40,0},{60,20}})));
  IDEAS.BoundaryConditions.SolarIrradiation.DiffusePerez HDifFlo(
    til=IDEAS.Types.Tilt.Floor,
    azi=0.78539816339745)
    "Diffuse irradiation on floor"
    annotation (Placement(transformation(extent={{40,-80},{60,-60}})));
  IDEAS.BoundaryConditions.SolarIrradiation.DiffusePerez HDifWal(
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/Examples/DiffusePerez.mos"
        "Simulate and plot"),
