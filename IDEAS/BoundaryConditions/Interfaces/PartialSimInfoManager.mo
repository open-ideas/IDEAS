...
partial model PartialSimInfoManager
  ...
  parameter Boolean linIntCon=if linearise then true else true
...
equation
  ...
  annotation (
    ...
    missingInnerMessage="Your model is using an outer \"sim\" component. An inner \"sim\" component is not defined. For simulation drag IDEAS.SimInfoManager into your model.",
    Icon(graphics={
