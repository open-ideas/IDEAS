...
block SourceSelectorRadiation
  ...
  Modelica.Blocks.Interfaces.RealInput HDirNorFil(
    ...
    final unit="W/m2") if
      datSou == IDEAS.BoundaryConditions.Types.RadiationDataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput HDirNorIn(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2") if
      datSou == IDEAS.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor or
  ...
  Modelica.Blocks.Interfaces.RealInput HDifHorIn(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2") if
     datSou == IDEAS.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or
