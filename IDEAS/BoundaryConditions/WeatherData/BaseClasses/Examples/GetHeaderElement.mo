...
initial equation
  longitude = IDEAS.BoundaryConditions.WeatherData.BaseClasses.getLongitudeTMY3(
    filNam=absFilNam);
  latitude = IDEAS.BoundaryConditions.WeatherData.BaseClasses.getLatitudeTMY3(
    filNam=absFilNam);
  timeZone = IDEAS.BoundaryConditions.WeatherData.BaseClasses.getTimeZoneTMY3(
    filNam=absFilNam);
...
<a href=\"modelica://IDEAS.BoundaryConditions.WeatherData.BaseClasses.getHeaderElementTMY3\">
IDEAS.BoundaryConditions.WeatherData.BaseClasses.getHeaderElementTMY3</a>.
This is for
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/GetHeaderElement.mos"
        "Simulate and plot"));
