...
model CheckWindDirection "Test model for wind direction check"
  ...
  IDEAS.BoundaryConditions.WeatherData.BaseClasses.CheckWindDirection
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckWindDirection.mos"
        "Simulate and plot"));
