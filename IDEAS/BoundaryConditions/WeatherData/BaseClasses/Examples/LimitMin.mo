...
model LimitMin "Test model for ceiling height check"
  ...
  IDEAS.BoundaryConditions.WeatherData.BaseClasses.LimiterCeilingHeight limCeiHei
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/LimitMin.mos"
        "Simulate and plot"));
end LimitMin;
