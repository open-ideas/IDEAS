within IDEAS.BoundaryConditions.WeatherData.Validation;
model ThreeYears_usingTwoYearData
  ...
  IDEAS.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    TDewPoiSou=IDEAS.BoundaryConditions.Types.DataSource.Parameter,
    ...
    filNam=Modelica.Utilities.Files.loadResource(
        "modelica://IDEAS/Resources/Data/BoundaryConditions/WeatherData/Validation/TwoYears_DataOnceAMonth_TMY3.mos"))
  ...
  annotation (experiment(
      StopTime=94608000,
      Tolerance=1e-006),
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/Validation/ThreeYears_usingTwoYearData.mos"
        "Simulate and plot"),
