...
model ThreeYears_usingTwoYearDataPositiveStart
  ...
  extends
    IDEAS.BoundaryConditions.WeatherData.Validation.ThreeYears_usingTwoYearData;

  annotation (experiment(
      StartTime=15638400,
      StopTime=110246400,
      Tolerance=1e-006),
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/Validation/ThreeYears_usingTwoYearDataPositiveStart.mos"
        "Simulate and plot"),
