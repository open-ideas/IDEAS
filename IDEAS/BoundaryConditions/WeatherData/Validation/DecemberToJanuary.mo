...
model DecemberToJanuary
  ...
  IDEAS.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    filNam=Modelica.Utilities.Files.loadResource(
        "modelica://IDEAS/Resources/Data/BoundaryConditions/WeatherData/Validation/DecemberToJanuary.mos"))
  ...
  annotation (experiment(
      ...
      Interval=3600,
      Tolerance=1e-006),
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/Validation/DecemberToJanuary.mos"
        "Simulate and plot"),
