...
protected
  ...
  IDEAS.Utilities.IO.Files.BaseClasses.FileWriterObject filWri=
      IDEAS.Utilities.IO.Files.BaseClasses.FileWriterObject(
        insNam,
        fileName,
        nin+1,
        isCombiTimeTable)
  ...
  function writeLine
    ...
    input IDEAS.Utilities.IO.Files.BaseClasses.FileWriterObject id "ID of the file writer";
