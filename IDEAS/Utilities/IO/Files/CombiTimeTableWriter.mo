...
model CombiTimeTableWriter
  ...
  extends IDEAS.Utilities.IO.Files.BaseClasses.FileWriter(
    final delimiter="\t",
...
<a href=\"modelica://IDEAS.Utilities.IO.Files.Examples.CSVReader\">
IDEAS.Utilities.IO.Files.Examples.CSVReader</a>.
</p>
