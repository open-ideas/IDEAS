within IDEAS.Utilities.IO.SignalExchange.Examples;
model WeatherStation "Example use of WeatherStation"
  extends Modelica.Icons.Example;
  IDEAS.Utilities.IO.SignalExchange.WeatherStation weaSta "Weather station"
...
equation
  ...
  __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/IO/SignalExchange/Examples/WeatherStation.mos"
        "Simulate and plot"),
Documentation(info="<html>
<p>
This example uses the weather station signal exchange block,
<a href=\"modelica://IDEAS.Utilities.IO.SignalExchange.WeatherStation\">
IDEAS.Utilities.IO.SignalExchange.WeatherStation</a>
