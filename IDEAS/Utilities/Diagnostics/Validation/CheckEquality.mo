within IDEAS.Utilities.Diagnostics.Validation;
...
equation
  ...
  connect(add.y, cheEqu.u2) annotation (Line(points={{1,10},{10,10},{10,14},{18,
          14}}, color={0,0,127}));
  annotation (
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Diagnostics/Validation/CheckEquality.mos"
        "Simulate and plot"),
  Documentation(
    info="<html>
<p>
This model validates the use of the
<a href=\"modelica://IDEAS.Utilities.Diagnostics.CheckEquality\">
IDEAS.Utilities.Diagnostics.CheckEquality</a>.
</p>
</html>",
revisions="<html>
<ul>
