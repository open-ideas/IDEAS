...
model Polynomial "Test model for ploynominal function "
  ...
  IDEAS.Utilities.Math.Polynomial polynominal(a={1,2})
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Math/Examples/Polynomial.mos"
        "Simulate and plot"), Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://IDEAS.Utilities.Math.Polynomial\">
