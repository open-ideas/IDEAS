...
model Interpolate "Example model of the Interpolate block"
  ...
  IDEAS.Utilities.Math.Interpolate int(
    xd=xd,
    yd=yd,
...
experiment(
      StopTime=500,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Math/Examples/Interpolate.mos"
        "Simulate and plot"), Documentation(info="<html>
<p>
This example is the same as
<a href=\"modelica://IDEAS.Utilities.Math.Functions.Examples.Interpolate\">
IDEAS.Utilities.Math.Functions.Examples.Interpolate</a>
