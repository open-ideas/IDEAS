...
model SmoothBlocks "Test model for smooth min and smooth max functions"
  ...
  IDEAS.Utilities.Math.SmoothMin smoMin(deltaX=0.5)
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Math/Examples/SmoothBlocks.mos"
        "Simulate and plot"),
