...
model SmoothHeavisideDerivatives
  ...
  Real y = IDEAS.Utilities.Math.Functions.smoothHeaviside(x=time, delta=0.2) "Function value";
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/SmoothHeavisideDerivatives.mos"
...
IDEAS.Utilities.Math.Functions.smoothHeaviside</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
