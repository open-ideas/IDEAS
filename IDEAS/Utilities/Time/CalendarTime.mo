...
initial algorithm
  ...
  if zerTim == IDEAS.Utilities.Time.Types.ZeroTime.UnixTimeStamp then
    timOff :=0;
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.UnixTimeStampGMT then
    timOff :=timZon;
  ...
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2021 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2021 then
      timOff :=timeStampsNewYear[12];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2022 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2022 then
      timOff :=timeStampsNewYear[13];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2023 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2023 then
      timOff :=timeStampsNewYear[14];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2024 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2024 then
      timOff := timeStampsNewYear[14];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2025 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2025 then
      timOff := timeStampsNewYear[15];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2026 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2026 then
      timOff := timeStampsNewYear[16];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2027 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2027 then
      timOff := timeStampsNewYear[17];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2028 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2028 then
      timOff := timeStampsNewYear[18];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2029 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2029 then
      timOff := timeStampsNewYear[19];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2030 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2030 then
      timOff := timeStampsNewYear[20];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2031 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2031 then
      timOff := timeStampsNewYear[21];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2032 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2032 then
      timOff := timeStampsNewYear[22];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2033 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2033 then
      timOff := timeStampsNewYear[23];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2034 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2034 then
      timOff := timeStampsNewYear[24];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2035 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2035 then
      timOff := timeStampsNewYear[25];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2036 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2036 then
      timOff := timeStampsNewYear[26];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2037 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2037 then
      timOff := timeStampsNewYear[27];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2038 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2038 then
      timOff := timeStampsNewYear[28];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2039 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2039 then
      timOff := timeStampsNewYear[29];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2040 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2040 then
      timOff := timeStampsNewYear[30];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2041 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2041 then
      timOff := timeStampsNewYear[31];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2042 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2042 then
      timOff := timeStampsNewYear[32];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2043 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2043 then
      timOff := timeStampsNewYear[33];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2044 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2044 then
      timOff := timeStampsNewYear[34];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2045 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2045 then
      timOff := timeStampsNewYear[35];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2046 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2046 then
      timOff := timeStampsNewYear[36];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2047 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2047 then
      timOff := timeStampsNewYear[37];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2048 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2048 then
      timOff := timeStampsNewYear[38];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2049 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2049 then
      timOff := timeStampsNewYear[39];
  elseif zerTim == IDEAS.Utilities.Time.Types.ZeroTime.NY2050 or
    zerTim == IDEAS.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2050 then
...
When <code>zerTim==IDEAS.Utilities.Time.Types.ZeroTime.UnixTimeStampGMT</code>,
<code>time</code> is defined with respect to GMT. This is different from the use
of <code>time</code> in the weather data reader
<a href=\"modelica://IDEAS.BoundaryConditions.WeatherData.ReaderTMY3\">
IDEAS.BoundaryConditions.WeatherData.ReaderTMY3</a>, as the weather data files
used with this reader are generally defined with <code>time</code> being local time.
If  <code>zerTim==IDEAS.Utilities.Time.Types.ZeroTime.UnixTimeStampGMT</code> is used,
...
(see <a href=\"modelica://IDEAS.BoundaryConditions.WeatherData.ReaderTMY3\">
IDEAS.BoundaryConditions.WeatherData.ReaderTMY3</a>)
