...
model LimPidAdsolair
  ...
  Modelica.Blocks.Sources.RealExpression revActGai(y=(if revActIn_internal
         then -1 else 1)*k_internal) "Gain, taking into account reverse action"
...
equation
  ...
  connect(revActGai.y, revActM.u1) annotation (Line(points={{-58,-16},{-50,-16},
...
<ul>
<li>
May 22, 2017, by Filip Jorissen:<br/>
Fixed bug in implementation of reverse action.
</li>
</ul>
</html>"));
end LimPidAdsolair;
