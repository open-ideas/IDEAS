...
model NaturalVentilation
  ...
  IDEAS.Airflow.Multizone.MediumColumn colOut(
    redeclare package Medium = Medium,
    h=3,
  ...
  IDEAS.Airflow.Multizone.MediumColumn colRooTop(
    redeclare package Medium = Medium,
    h=3,
    densitySelection=IDEAS.Airflow.Multizone.Types.densitySelection.fromBottom)
    "Medium column to compute static pressure of air"
...
experiment(Tolerance=1e-06, StopTime=7200),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Airflow/Multizone/Examples/NaturalVentilation.mos"
        "Simulate and plot"),
