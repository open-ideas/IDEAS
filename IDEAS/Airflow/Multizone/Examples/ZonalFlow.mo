...
model ZonalFlow "Model with prescribed air exchange between two volumes"
  ...
  IDEAS.Fluid.MixingVolumes.MixingVolume rooA(
    V=volA,
  ...
  IDEAS.Fluid.MixingVolumes.MixingVolume rooB(
    V=volB,
    redeclare package Medium = Medium,
    X_start={0.01,0.99},
    T_start=293.15,
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ZonalFlow.mos"
        "Simulate and plot"),
