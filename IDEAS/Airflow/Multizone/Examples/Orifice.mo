...
model Orifice "Model with an orifice"
  ...
  IDEAS.Airflow.Multizone.Orifice ori(redeclare package Medium = Medium, A=
        0.2) "Orifice"
  ...
  IDEAS.Fluid.Sensors.DensityTwoPort den1(
    redeclare package Medium = Medium,
    m_flow_nominal=0.1,
    initType=Modelica.Blocks.Types.Init.InitialState) "Density sensor"
    annotation (Placement(transformation(extent={{-30,20},{-10,40}})));
  IDEAS.Fluid.Sensors.DensityTwoPort den2(
    redeclare package Medium = Medium,
    m_flow_nominal=0.1,
    initType=Modelica.Blocks.Types.Init.InitialState) "Density sensor"
...
experiment(Tolerance=1e-06, StopTime=1),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Airflow/Multizone/Examples/Orifice.mos"
        "Simulate and plot"),
