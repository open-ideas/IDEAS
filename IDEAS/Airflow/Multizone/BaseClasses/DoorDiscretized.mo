...
partial model DoorDiscretized
  ...
  extends IDEAS.Airflow.Multizone.BaseClasses.TwoWayFlowElementBuoyancy;
  ...
  parameter Modelica.Units.SI.Length dh=hOpe/nCom "Height of each compartment" annotation(Dialog(tab = "Advanced", group="Override"),HideResult=true);
protected
...
equation
  ...
  for i in 1:nCom loop
    ...
    gaiFlo[i] = IDEAS.Utilities.Math.Functions.smoothHeaviside(x=dV_flow[i], delta=VZerCom_flow);
...
IDEAS.Airflow.Multizone.BaseClasses.DoorDiscretized</a>
to
<a href=\"modelica://IDEAS.Airflow.Multizone.DoorDiscretizedOpen\">
IDEAS.Airflow.Multizone.DoorDiscretizedOpen</a>.<br/>
This is for
