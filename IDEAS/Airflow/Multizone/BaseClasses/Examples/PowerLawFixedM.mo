...
equation
  ...
  VFixed_flow = IDEAS.Airflow.Multizone.BaseClasses.powerLawFixedM(
    C=C,
    dp=dp,
    m=m,
    a=a,
...
experiment(Tolerance=1e-6, StopTime=1.0),
  __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Airflow/Multizone/BaseClasses/Examples/PowerLawFixedM.mos"
