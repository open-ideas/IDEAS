...
algorithm
  ...
  if aR < aRDel then
    Cp :=Cp0*IDEAS.Utilities.Math.Functions.regStep(
...
<p align=\"center\">
<img src=\"modelica://IDEAS/Resources/Images/Airflow/Multizone/BaseClasses/windPressureLowRise.png\" border=\"1\" alt=\"Definition of the aspect ratio.\"/>
</p>
<p>
