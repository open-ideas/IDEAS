...
model OpenDoorBuoyancyPressureDynamic
  ...
  IDEAS.Airflow.Multizone.DoorOpen doo(redeclare package Medium = Medium)
  ...
  IDEAS.Fluid.MixingVolumes.MixingVolume bouB(
    redeclare package Medium = Medium,
    T_start=294.15,
    p_start=101320,
    V=2.5*5*5,
...
equation
  ...
  annotation (
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Airflow/Multizone/Validation/OpenDoorBuoyancyPressureDynamic.mos"
        "Simulate and plot"),
    experiment(
      StopTime=14400,
      Tolerance=1e-08),
