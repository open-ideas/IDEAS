...
model ThreeRoomsContamDiscretizedDoor
  ...
  extends IDEAS.Airflow.Multizone.Validation.ThreeRoomsContam(
    redeclare IDEAS.Airflow.Multizone.DoorDiscretizedOperable dooOpeClo(
...
experiment(Tolerance=1e-06, StopTime=3600),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Airflow/Multizone/Validation/ThreeRoomsContamDiscretizedDoor.mos"
        "Simulate and plot"),
