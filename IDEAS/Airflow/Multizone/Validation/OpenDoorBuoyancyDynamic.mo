...
model OpenDoorBuoyancyDynamic
  ...
  IDEAS.Airflow.Multizone.DoorOpen doo(
...
equation
  ...
  annotation (
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Airflow/Multizone/Validation/OpenDoorBuoyancyDynamic.mos"
        "Simulate and plot"),
    experiment(
      StopTime=14400,
      Tolerance=1e-08),
