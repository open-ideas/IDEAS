...
model ThreeRoomsContam
  ...
  IDEAS.Fluid.MixingVolumes.MixingVolume volEas(
  ...
  IDEAS.Airflow.Multizone.MediumColumn colWesBot(
    redeclare package Medium = Medium,
    h=1.5,
    densitySelection=IDEAS.Airflow.Multizone.Types.densitySelection.fromBottom)
    "Medium column for bottom floor"
  ...
  IDEAS.Fluid.MixingVolumes.MixingVolume volWes(
    redeclare package Medium = Medium,
    T_start=273.15 + 25,
    nPorts=3,
    V=2.5*5*5,
  ...
  IDEAS.Fluid.MixingVolumes.MixingVolume volTop(
    redeclare package Medium = Medium,
    T_start=273.15 + 20,
    V=2.5*5*10*1,
    nPorts=2,
...
experiment(Tolerance=1e-06, StopTime=3600),
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Airflow/Multizone/Validation/ThreeRoomsContam.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img src=\"modelica://IDEAS/Resources/Images/Airflow/Multizone/Examples/3roomValidation.png\" border=\"1\" alt=\"Configuration of the three rooms.\"/>
</p>
<p>
...
<a href=\"modelica://IDEAS.Airflow.Multizone.Validation.ThreeRoomsContamDiscretizedDoor\">
IDEAS.Airflow.Multizone.Validation.ThreeRoomsContamDiscretizedDoor</a>.
</p>
<h4>References</h4>
<p>
Michael Wetter.
<a href=\"modelica://IDEAS/Resources/Images/Airflow/Multizone/Wetter-airflow-2006.pdf\">
