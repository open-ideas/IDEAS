...
model DoorOperable
  ...
  extends IDEAS.Airflow.Multizone.BaseClasses.Door(
...
equation
  ...
  VABpOpeClo_flow[1] = if Modelica.Math.isEqual(mOpe, 0.5, 1E-10)
    then
      IDEAS.Airflow.Multizone.BaseClasses.powerLaw05(
        C=CVal[1],
      ...
      IDEAS.Airflow.Multizone.BaseClasses.powerLawFixedM(
        C=CVal[1],
        dp=port_a1.p-port_a2.p,
        m=mOpe,
        a=a[1],
  ...
  VABpOpeClo_flow[2] = IDEAS.Airflow.Multizone.BaseClasses.powerLawFixedM(
    C=CVal[2],
    dp=port_a1.p-port_a2.p,
    m=mClo,
    a=a[2],
  ...
  mABt_flow = y*IDEAS.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
      k=kT,
...
<a href=\"modelica://IDEAS.Airflow.Multizone.DoorOpen\">
IDEAS.Airflow.Multizone.DoorOpen</a>, and for
...
<a href=\"modelica://IDEAS.Airflow.Multizone.DoorOpen\">
IDEAS.Airflow.Multizone.DoorOpen</a>
