...
<li>Setting up new Construction records has been simplified. Parameter values nLay and nGain are now inferred from other parameters.</li>
<li>Added optional parameter incLastLay to Construction records. Users may use this to double-check if InternalWalls are connected as intended.</li>
<li>Changed possible connections of internal gains to surfaces.</li>
<li>Improved convection and thermal radiation equations for accuracy and computational speed.</li>
...
<li>Added a zone template that allows adding a rectangular zone, including four walls, four optional windows, a floor, and a ceiling.</li>
<li>Renamed some variables. A conversion script is provided to update user models.<br>
...
<li>Removed insulationType and insulationThickness parameters. These should now be defined in the Construction records.</li>
...
<li>Improved accuracy of the model that computes internal longwave radiation.</li>
<li>Improved accuracy of the model that computes exterior sky temperature.</li>
<li>Moved the Electrical package into the Experimental package since this package contains broken models.</li>
