...
<li>A zone template has been added that allows adding a rectangular zone, including 4 walls, 4 optional windows, a floor and a ceiling.</li>
<li>Some variables have been renamed. A conversion script is provided for converting the user's models to accommodate these changes.<br/>
