...
<li>The PPD12 example now includes a model that compares a rule-based controller with a model predictive controller.</li>
</ul>
<p>Detailed release notes:</p>
<ul>
<li>Deprecated IDEAS.Fluid.Actuators.Valves.Simplified.ThreeWayValve.</li>
<li>Extended IDEAS.Buildings.Components.Shading.BuildingShade with a parameter for configuring partial shading.</li>
<li>Added a two-way and three-way valve with a mixed linear-equal percentage opening characteristic.</li>
...
<li>Fixed a compatibility bug with OpenModelica.</li>
<li>Removed reference to non-existent parameter in RectangularZoneTemplate.</li>
</ul>
</html>"));
end Version_2_1_0;
