...
<li>Improved overall efficiency and reduced warnings.</li>
...
<li>Improved implementation of Koschenz's model for TABS and added an option to discretize TABS sections.</li>
<li>Added new building shade components.</li>
<li>Removed inefficient code that would lead to numerical Jacobians in the grid.</li>
